...
@Data
public class ImmBienGeranceLigneVO implements Serializable {
    private static final long serialVersionUID = 1L;

    @NotNull(message = "biegerligId can not null")
    ...
    @NotNull(message = "bieId can not null")
    private Long bieId;

    @NotNull(message = "biegerentId can not null")
