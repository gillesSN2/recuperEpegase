...
public class FormCertificationDocument implements Serializable {
   ...
   private CertificationDocumentDao certificationDocumentDao;
   private List lesCertificationDocument = new ArrayList();
   private transient DataModel dataModelCertificationDocument = new ListDataModel();
   ...
   public void InstancesDaoUtilses() {
      ...
      this.certificationDocumentDao = new CertificationDocumentDao(this.baseLog, this.utilInitHibernate);
   }

   public void initPage(Session var1) throws ParseException, HibernateException, NamingException {
      this.var_action = 0;
      this.lesCertificationDocument.clear();
      ...
      this.nbRestant = this.certificationDocumentDao.calculeNbCertificationDocument(var1);
   ...
   public void executerRequete() throws IOException, HibernateException, NamingException, ParseException {
      this.chargerLesCertificationDocument((Session)null);
   }

   public void chargerLesCertificationDocument(Session var1) throws HibernateException, NamingException, ParseException {
      this.lesCertificationDocument.clear();
      ...
      Object var2 = null;
      Object var3 = null;
      this.lesCertificationDocument = this.certificationDocumentDao.recherche(var1, this.inpEtat, this.periode, (String)var2, (String)var3);
      this.dataModelCertificationDocument.setWrappedData(this.lesCertificationDocument);
   }
   ...
   public void selectionLigne() throws HibernateException, NamingException {
      if (this.extDTable != null) {
         ...
         if (var1.size() != 0) {
            this.certificationDocument = (CertificationDocument)var1.get(0);
   ...
   public void achatCertificationDocument() {
      this.var_pack = 1;
   ...
   public void valideAchat() throws Exception {
      ...
      var1.envoieMailCertificationDocument(this.structureLog, this.usersLog, this.var_pack);
      this.showModalPanelAchat = false;
   }

   public void recupererModeleDocument() {
      String var1 = StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "impression" + File.separator + "fr" + File.separator + "office" + File.separator + "document" + File.separator + "certification" + File.separator;
   ...
   public void recupererModeleListe() {
      String var1 = StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "impression" + File.separator + "fr" + File.separator + "office" + File.separator + "liste" + File.separator + "certification" + File.separator;
      File var2 = new File(var1);
      if (!var2.exists()) {
         var2.mkdir();
      }
   ...
   public String calculeCheminCertificationDocument(String var1) {
      String var2 = StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + var1 + File.separator + "impression" + File.separator + "fr" + File.separator + "office" + File.separator + "document" + File.separator + "certification" + File.separator;
      return var2;
   }
   ...
   public String calculeImageFond(String var1) throws HibernateException, NamingException {
      String var2 = "";
      File var3 = new File(this.calculeCheminSousRapport(var1) + "formatCertificationDocument.jpg");
      if (var3.exists()) {
         var2 = "formatCertificationDocument.jpg";
      }
   ...
   public JRBeanCollectionDataSource calculeImpressionCommun() throws IOException {
      ArrayList var1 = new ArrayList();
      if (this.certificationDocument != null) {
         var1.add(this.certificationDocument);
      }
   ...
   public void impression(UtilPrint var1, int var2, String var3, String var4, String var5, String var6, String var7, String var8, String var9) throws HibernateException, NamingException, SQLException, JRException, IOException, ClassNotFoundException, MalformedURLException, Exception {
      if (var2 == 0) {
         if (var3 != null && !var3.isEmpty()) {
            ...
            var1.setEntete("Impression certificationDocument");
            var1.setCheminRapport(this.calculeCheminCertificationDocument("structure" + this.structureLog.getStrid()));
            ...
            var1.setId_doc(this.certificationDocument.getCerId());
         ...
         var1.setEntete("Impression de la liste des certificationDocument");
         var1.setCheminRapport(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "impression" + File.separator + "fr" + File.separator + "reunion" + File.separator + "liste" + File.separator + "certification" + File.separator);
         ...
         var1.setNature(this.nature);
         var1.setId_doc(0L);
         JRBeanCollectionDataSource var10 = new JRBeanCollectionDataSource(this.lesCertificationDocument);
   ...
   public List grapher() throws HibernateException, NamingException, ParseException {
      ...
      if (this.lesCertificationDocument.size() != 0) {
         if (this.valQteGraph == 2) {
            this.uniteGraph = "Certification : Quantites";
            this.deviseGraph = "";
            this.nbDecGraph = 0;
         }

         this.titreGraph = "Analyse des Certifications : ";
         ...
         if (this.inpEtat == 0) {
            this.sousTitreGraph = this.sousTitreGraph + " Certifications Envoyés";
         } else if (this.inpEtat == 1) {
            this.sousTitreGraph = this.sousTitreGraph + " Certifications Initiaux";
         } else if (this.inpEtat == 2) {
            this.sousTitreGraph = this.sousTitreGraph + " Certifications Achetés";
         }
         ...
         if (this.lesCertificationDocument.size() != 0) {
            ...
            for(int var7 = 0; var7 < this.lesCertificationDocument.size(); ++var7) {
               this.certificationDocument = (CertificationDocument)this.lesCertificationDocument.get(var7);
               var3 = "";
               var4 = 0L;
               int var9 = 0;
               if (this.modeGraph == 0) {
                  int var8 = this.certificationDocument.getCerDateCreat().getYear() + 1900;
                  var3 = "" + var8;
               } else if (this.modeGraph == 1) {
                  if (this.certificationDocument.getUsers() != null) {
                     var3 = this.certificationDocument.getUsers().getUsrPatronyme();
                  } else {
                     var3 = "Sans Emetteur";
                  }
               } else if (this.modeGraph == 2) {
               ...
               if (this.timeDecoupage == 0) {
                  var9 = this.certificationDocument.getCerDateCreat().getDate();
               } else if (this.timeDecoupage == 1) {
                  var9 = this.certificationDocument.getCerDateCreat().getMonth() + 1;
               } else if (this.timeDecoupage == 2) {
                  if (this.certificationDocument.getCerDateCreat().getMonth() + 1 >= 1 && this.certificationDocument.getCerDateCreat().getMonth() + 1 <= 3) {
                     var9 = 1;
                  } else if (this.certificationDocument.getCerDateCreat().getMonth() + 1 >= 4 && this.certificationDocument.getCerDateCreat().getMonth() + 1 <= 6) {
                     var9 = 2;
                  } else if (this.certificationDocument.getCerDateCreat().getMonth() + 1 >= 7 && this.certificationDocument.getCerDateCreat().getMonth() + 1 <= 9) {
                     var9 = 3;
                  } else if (this.certificationDocument.getCerDateCreat().getMonth() + 1 >= 10 && this.certificationDocument.getCerDateCreat().getMonth() + 1 <= 12) {
                     var9 = 4;
                  }
               } else if (this.timeDecoupage == 3) {
                  if (this.certificationDocument.getCerDateCreat().getMonth() + 1 >= 1 && this.certificationDocument.getCerDateCreat().getMonth() + 1 <= 6) {
                     var9 = 1;
                  } else if (this.certificationDocument.getCerDateCreat().getMonth() + 1 >= 7 && this.certificationDocument.getCerDateCreat().getMonth() + 1 <= 12) {
                     var9 = 2;
                  }
   ...
   public void setCertificationDocument(CertificationDocument var1) {
      this.certificationDocument = var1;
   }
   ...
   public DataModel getDataModelCertificationDocument() {
      return this.dataModelCertificationDocument;
   }

   public void setDataModelCertificationDocument(DataModel var1) {
      this.dataModelCertificationDocument = var1;
   }
