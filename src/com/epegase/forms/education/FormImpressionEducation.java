...
public class FormImpressionEducation implements Serializable {
   ...
   public FormImpressionEducation() {
   ...
   public void chargerLesRepImpEducation(Session var1) {
      this.lesRepImpression.clear();
      String var2 = StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "impression" + File.separator + "fr" + File.separator + "education" + File.separator + "education";
   ...
   public boolean calculeVisible(String var1, Session var2) {
      ...
      if (var1 != null && !var1.isEmpty()) {
         ...
         } else if (var1.contains("INVENTAIRES")) {
            var5 = var2.createQuery("SELECT COUNT(*) FROM ParcInventaire").uniqueResult();
            var4 = Integer.parseInt(var5.toString());
         } else if (var1.contains("CONSOMMATONS")) {
            var5 = var2.createQuery("SELECT COUNT(*) FROM ParcConsommation").uniqueResult();
            var4 = Integer.parseInt(var5.toString());
         } else if (var1.contains("O.R.")) {
            var5 = var2.createQuery("SELECT COUNT(*) FROM ParcOr").uniqueResult();
            var4 = Integer.parseInt(var5.toString());
   ...
   public void recupererNomrep() throws HibernateException, NamingException {
      ...
      if (this.dataModelImpgen.isRowAvailable()) {
         ...
         if (this.nomRepertoire.contains("parc")) {
            ...
            this.nature = 165;
         } else if (this.nomRepertoire.contains("o.r.")) {
            this.nature = 161;
         } else {
            this.nature = 0;
         }
   ...
   public void calculeRequete() throws HibernateException, NamingException, ParseException {
      ...
      } else if (this.nomRepertoire.equalsIgnoreCase("o.r.")) {
   ...
   public void rechercheDecaissementSql(String var1, String var2, String var3, String var4) throws HibernateException, NamingException {
      ...
      if (this.codeParc != null && !this.codeParc.isEmpty()) {
         this.var_requete = this.var_requete + " and sort_parc like '" + this.codeParc + "%'";
      }
