...
public class FormBonEncaissementMedical implements Serializable {
   ...
   public void chargerFind(Session var1) throws HibernateException, NamingException {
      ...
      if (this.inpEtat == 0) {
         this.lesBonEncaissementVente = this.bonEncaissementVenteDao.selectNonPayerMedic(this.nature, var1);
