...
public class FormRetourAchats implements Serializable {
   ...
   private RetourEnteteAchats retourEnteteAchats = new RetourEnteteAchats();
   ...
   private RetourLigneAchats retourLigneAchats = new RetourLigneAchats();
   ...
   private ReceptionLotAchats receptionLotAchats = new ReceptionLotAchats();
   ...
   public FormRetourAchats() throws IOException, SAXException, JDOMException {
   }
   ...
   public void configAchats() {
      ...
      this.periode = this.optionAchats.getAffichInGlobViewRETOUR();
   ...
   public void recupererBudgetItem() throws HibernateException, NamingException {
      ...
      if (this.retourEnteteAchats.getBrfActivite() != null && !this.retourEnteteAchats.getBrfActivite().isEmpty() && this.retourEnteteAchats.getBrfActivite().contains(":")) {
         String[] var3 = this.retourEnteteAchats.getBrfActivite().split(":");
   ...
   public void rechercheDOCUMENT(long var1) throws HibernateException, NamingException {
      ...
      this.retourEnteteAchats = this.retourEnteteAchatsDao.pourParapheur(var1, (Session)null);
      if (this.retourEnteteAchats != null) {
         this.lesLignesList = this.retourLigneAchatsDao.chargerLesLignes(this.retourEnteteAchats, (Session)null);
      }
   ...
   public void chargeListeDetail(Session var1) throws HibernateException, NamingException, ParseException {
      ...
      if (this.inpEtat != 50) {
         this.lesEntetesList = this.retourEnteteAchatsDao.recherche(var1, this.exercicesAchats.getExeachId(), this.inpNum, this.inpIdTiersEnCours, this.inpFournisseur, this.inpEtat, this.inpSerie, this.inpCat, this.periode, this.inpService, this.usersLog.getUsrid(), this.usersLog.getUsrAchats(), this.inpBudget, this.inpResponsable, this.inpActivite, this.inpDossier, this.inpAnal, var10, var11);
      }
      ...
      if (this.lesEntetesList.size() > 0) {
         ...
         for(int var13 = 0; var13 < this.lesEntetesList.size(); ++var13) {
            RetourEnteteAchats var12 = (RetourEnteteAchats)this.lesEntetesList.get(var13);
            var2 += var12.getBrfTotTtc();
            var4 += var12.getBrfTotReglement();
            var6 += var12.getBrfTotHt();
            var8 += var12.getBrfTotTva();
         }
   ...
   public void selectionLigne() throws JDOMException, IOException, HibernateException, NamingException {
      if (this.extDTable != null) {
         ...
         if (var1.size() != 0) {
            this.retourEnteteAchats = (RetourEnteteAchats)var1.get(0);
            this.inpNomTiersEnCours = this.retourEnteteAchats.getBrfNomTiers();
            this.inpIdTiersEnCours = this.retourEnteteAchats.getTiers().getTieid();
            this.var_date = this.retourEnteteAchats.getBrfDate();
            if (this.retourEnteteAchats.getBrfDate().getHours() <= 9) {
               this.var_heure = "0" + this.retourEnteteAchats.getBrfDate().getHours();
            } else {
               this.var_heure = "" + this.retourEnteteAchats.getBrfDate().getHours();
            }

            if (this.retourEnteteAchats.getBrfDate().getMinutes() <= 9) {
               this.var_minute = "0" + this.retourEnteteAchats.getBrfDate().getMinutes();
            } else {
               this.var_minute = "" + this.retourEnteteAchats.getBrfDate().getMinutes();
            }

            if (this.retourEnteteAchats.getBrfDate().getSeconds() <= 9) {
               this.var_seconde = "0" + this.retourEnteteAchats.getBrfDate().getSeconds();
            } else {
               this.var_seconde = "" + this.retourEnteteAchats.getBrfDate().getSeconds();
            }

            this.tiers = this.retourEnteteAchats.getTiers();
            this.formRecherche.setTiers(this.tiers);
            if (!this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("010") && !this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("020") && !this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("030") && !this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("037")) {
            ...
            this.var_nom_contact = this.retourEnteteAchats.getBrfIdContact();
            this.var_nom_responsable = this.retourEnteteAchats.getBrfIdResponsable();
            this.calculDevise();
            Session var4 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourEnteteLight");
            ...
            this.setMontantTtcElmt(this.retourEnteteAchats.getBrfTotTtc());
            this.setMontantReglementElmt(this.retourEnteteAchats.getBrfTotReglement());
            this.setMontantSoldeElmt(this.retourEnteteAchats.getBrfTotTtc() - this.retourEnteteAchats.getBrfTotReglement());
            this.cumulPrix();
            this.verrouNum = true;
   ...
   public void visualisationLigne() throws HibernateException, NamingException, JDOMException, IOException, ParseException {
      if (this.retourEnteteAchats != null) {
         if (this.retourEnteteAchats.getBrfEtat() == 0) {
            this.modifDocument();
         } else {
   ...
   public void calculDevise() {
      if (this.retourEnteteAchats.getBrfDevise() != null) {
         this.var_format_devise = this.utilNombre.formatDevise(this.retourEnteteAchats.getBrfDevise());
      }
   ...
   public void chargerDocumentLigne(Session var1) throws HibernateException, NamingException {
      this.lesLignesList.clear();
      if (this.retourEnteteAchats.getBrfId() > 0L) {
         this.lesLignesList = this.retourLigneAchatsDao.chargerLesLignes(this.retourEnteteAchats, var1);
      }
   ...
   public void chargerDossierAffaire(Session var1) throws HibernateException, NamingException {
      ...
      if (this.retourEnteteAchats != null && this.retourEnteteAchats.getBrfAnal4() != null && !this.retourEnteteAchats.getBrfAnal4().isEmpty()) {
         this.dossier = this.plansAnalytiquesDao.rechercheAffaire(this.retourEnteteAchats.getBrfAnal4(), var1);
   ...
   public void chargerDocumentTrace() throws HibernateException, NamingException {
      Session var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourEnteteLight");
      this.datamodelDocumentTrace = new ListDataModel();
      Object var2 = new ArrayList();
      if (this.retourEnteteAchats.getBrfId() > 0L) {
         var2 = this.documentTraceAchatsDao.chargerLesDocumentsTrace(this.retourEnteteAchats.getBrfId(), this.nature, var1);
      }
   ...
   public void chargerUserChrono(Session var1) throws HibernateException, NamingException {
      if (this.retourEnteteAchats != null && this.retourEnteteAchats.getBrfSerie() != null && !this.retourEnteteAchats.getBrfSerie().isEmpty()) {
         this.usersChrono = this.usersChronoDao.selectUnique(this.retourEnteteAchats.getBrfSerie(), this.nature, this.usersLog, var1);
      }
   ...
   public void chargerParapheur(Session var1) throws HibernateException, NamingException {
      if (this.habilitation != null) {
         ...
         this.parapheur = this.parapheurDao.existenceParapheur(this.retourEnteteAchats.getBrfId(), this.nature, var1);
   ...
   public void chargerDetailanalytique() {
      ...
      this.lesDecoupagesActivites.clear();
      if (this.decoupageActivite && this.retourEnteteAchats.getBrfActivite() != null && !this.retourEnteteAchats.getBrfActivite().isEmpty() && this.retourEnteteAchats.getBrfActivite().contains(":")) {
         String[] var1 = null;
         if (!this.retourEnteteAchats.getBrfActivite().contains("#")) {
            var1 = this.retourEnteteAchats.getBrfActivite().split(":");
            if (var1.length == 8) {
            ...
            String[] var2 = this.retourEnteteAchats.getBrfActivite().split("#");
   ...
   public void calculPourcentage() {
      if (this.ecrituresAnalytiqueCtrl != null && this.ecrituresAnalytiqueCtrl.getEcranaPourcentage() != 0.0F) {
         double var1 = this.utilNombre.myRoundDevise(this.retourEnteteAchats.getBrfTotHt() * (double)this.ecrituresAnalytiqueCtrl.getEcranaPourcentage() / 100.0D, this.structureLog.getStrdevise());
   ...
   public void controleEcartAnalytique() {
      ...
      this.soldeImputation = this.retourEnteteAchats.getBrfTotHt() - this.totalImputation;
   ...
   public void ajoutDocument() throws IOException, JDOMException {
      this.retourEnteteAchats = new RetourEnteteAchats();
      this.retourLigneAchats = new RetourLigneAchats();
      this.retourEnteteAchats.setUsers(this.usersLog);
      this.retourEnteteAchats.setBrfIdCreateur(this.usersLog.getUsrid());
      this.retourEnteteAchats.setBrfNomCreateur(this.usersLog.getUsrNom() + " " + this.usersLog.getUsrPrenom());
      this.retourEnteteAchats.setBrfIdResponsable(this.usersLog.getUsrid());
      this.retourEnteteAchats.setBrfNomResponsable(this.usersLog.getUsrNom() + " " + this.usersLog.getUsrPrenom());
      this.retourEnteteAchats.setBrfDate(new Date());
      this.retourEnteteAchats.setBrfCat("Local");
      ...
      this.retourEnteteAchats.setBrfDateLivraison((Date)null);
      this.var_nom_responsable = 0L;
      this.lesLignesList.clear();
   ...
   public void calculDateValidite() {
      ...
      if (this.optionAchats.getNbrJrRelanceRETOUR() != null && !this.optionAchats.getNbrJrRelanceRETOUR().isEmpty()) {
         var3 = Integer.parseInt(this.optionAchats.getNbrJrRelanceRETOUR());
      } else {
         var3 = 0;
      }
      ...
      if (this.optionAchats.getNbrJrValidRETOUR() != null && !this.optionAchats.getNbrJrValidRETOUR().isEmpty()) {
         var4 = Integer.parseInt(this.optionAchats.getNbrJrValidRETOUR());
      } else {
         var4 = 0;
      }

      this.retourEnteteAchats.setBrfDateRelance(this.utilDate.datedevaleurTheo(this.var_date, var3));
      this.retourEnteteAchats.setBrfDateValidite(this.utilDate.datedevaleurTheo(this.var_date, var4));
   }
   ...
   public void modifDocument() throws JDOMException, IOException, HibernateException, NamingException, ParseException {
      if (this.retourEnteteAchats != null) {
         ...
         if (this.usersLog.getUsrSignatureAchats() == 1) {
            ...
            this.mesUsersItem.clear();
            this.mesUsersItem.add(new SelectItem(this.retourEnteteAchats.getBrfIdResponsable(), this.retourEnteteAchats.getBrfNomResponsable()));
         }
   ...
   public void valideDocument() throws HibernateException, NamingException {
      if (this.retourEnteteAchats != null) {
         Session var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourLigne");
         Transaction var2 = null;

         try {
            var2 = var1.beginTransaction();
            if (this.retourEnteteAchats.getBrfEtat() == 0 && this.habilitation == null && this.usersChrono.getUsrchrValidation() == 2) {
               this.retourEnteteAchats.setBrfEtat(1);
               this.retourEnteteAchats.setBrfDateValide(new Date());
               if (this.retourEnteteAchats.getBrfAnal4() != null && !this.retourEnteteAchats.getBrfAnal4().isEmpty()) {
                  ...
                  ValorisationEnteteAchats var3 = var4.rechercheByDossier(this.retourEnteteAchats.getBrfAnal4(), var1);
                  if (var3 != null) {
                     this.retourEnteteAchats.setBrfValo(var3.getValNum());
                  }
               }

               this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var1);
               Espion var10 = new Espion();
               var10.setUsers(this.usersLog);
               var10.setEsptype(0);
               var10.setEspdtecreat(new Date());
               var10.setEspaction("Validation manuelle retour (F.) N° " + this.retourEnteteAchats.getBrfNum() + " du " + this.utilDate.dateToStringSQLLight(this.retourEnteteAchats.getBrfDate()));
               this.espionDao.mAJEspion(var10, var1);
               this.calculStock.majRetourAchatsVAL(this.lesLignesList, 1, this.baseLog, var1);
            }

            if (this.tiers.getTieDteDocument4() == null || this.retourEnteteAchats.getBrfDate().after(this.tiers.getTieDteDocument4())) {
               this.tiers.setTieDteDocument4(this.retourEnteteAchats.getBrfDate());
   ...
   public void deValideDocument() throws HibernateException, NamingException {
      if (this.retourEnteteAchats != null) {
         ...
         try {
            var2 = var1.beginTransaction();
            if (this.retourEnteteAchats.getBrfEtat() == 1) {
               this.retourEnteteAchats.setBrfEtat(0);
               this.retourEnteteAchats.setBrfDateValide((Date)null);
               this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var1);
               Espion var3 = new Espion();
               var3.setUsers(this.usersLog);
               var3.setEsptype(0);
               var3.setEspdtecreat(new Date());
               var3.setEspaction("Dévalidation manuelle retour (F.) N° " + this.retourEnteteAchats.getBrfNum() + " du " + this.utilDate.dateToStringSQLLight(this.retourEnteteAchats.getBrfDate()));
               this.espionDao.mAJEspion(var3, var1);
               this.calculStock.majRetourAchatsVAL(this.lesLignesList, 2, this.baseLog, var1);
            }
   ...
   public void reactiverDocument() throws HibernateException, NamingException {
      if (this.retourEnteteAchats != null) {
         this.retourEnteteAchats.setBrfEtat(0);
         this.retourEnteteAchats.setBrfDateAnnule((Date)null);
         this.retourEnteteAchats.setBrfMotifAnnule("");
         this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats);
      }
   ...
   public void supprimerDocument() throws HibernateException, NamingException {
      if (this.retourEnteteAchats != null) {
         ...
         try {
            var2 = var1.beginTransaction();
            this.lesEntetesList.remove(this.retourEnteteAchats);
            this.datamodelEntete.setWrappedData(this.lesEntetesList);
            long var3 = this.retourEnteteAchats.getBrfId();
            String var5 = this.retourEnteteAchats.getBrfNum();
            Date var6 = this.retourEnteteAchats.getBrfDate();
            if (this.lesLignesList.size() != 0) {
               for(int var7 = 0; var7 < this.lesLignesList.size(); ++var7) {
                  this.retourLigneAchats = (RetourLigneAchats)this.lesLignesList.get(var7);
                  if (this.retourLigneAchats.getBrfligCode() != null && !this.retourLigneAchats.getBrfligCode().isEmpty()) {
                     this.produits = this.produitsDao.chargeProduit(this.retourLigneAchats.getBrfligCode(), var1);
                  } else {
                     this.produits = null;
                  }

                  this.calculStock.majRetourAchatsATT(this.retourLigneAchats, this.produits, 0.0F, 2, this.baseLog, var1);
               }
            }

            this.retourLigneAchatsDao.deleteAllLigne(this.retourEnteteAchats, var1);
            this.utilParapheur.supprimerParapheur(this.retourEnteteAchats.getBrfId(), this.nature, var1);
            this.retourEnteteAchatsDao.delete(this.retourEnteteAchats.getBrfId(), var1);
            ...
            if (this.documentTraceAchats != null) {
               ...
               if (var9 == 13) {
                  ...
                  ReceptionEnteteAchats var11 = var12.pourParapheur(var18, var1);
                  if (var11 != null) {
                     var11.setRecEtat(var20);
                     if (var20 == 1) {
            ...
            var19.setEspaction("Suppression retour achat N° " + var5 + " du " + var6);
   ...
   public void duppliquerDocument() throws HibernateException, NamingException, Exception {
      if (this.retourEnteteAchats.getBrfId() >= 0L) {
         ...
         try {
            var2 = var1.beginTransaction();
            this.retourEnteteAchats.setExercicesAchats(this.exercicesAchats);
            this.retourEnteteAchats.setUsers(this.usersLog);
            this.retourEnteteAchats.setBrfIdCreateur(this.usersLog.getUsrid());
            this.retourEnteteAchats.setBrfNomCreateur(this.usersLog.getUsrNom() + " " + this.usersLog.getUsrPrenom());
            this.retourEnteteAchats.setBrfDate(new Date());
            this.retourEnteteAchats.setBrfDateCreat(new Date());
            this.retourEnteteAchats.setBrfDateModif((Date)null);
            this.retourEnteteAchats.setBrfIdModif(0L);
            this.retourEnteteAchats.setBrfNomModif("");
            this.retourEnteteAchats.setBrfNum("");
            this.retourEnteteAchats.setBrfIdResponsable(this.usersLog.getUsrid());
            this.retourEnteteAchats.setBrfNomResponsable(this.usersLog.getUsrPatronyme());
            this.calculDateValidite();
            this.retourEnteteAchats.setBrfDateLivraison((Date)null);
            if (!this.retourEnteteAchats.getBrfSerie().equalsIgnoreCase("X") && !this.retourEnteteAchats.getBrfSerie().isEmpty()) {
               this.retourEnteteAchats.setBrfNum(this.calculChrono.numCompose(this.retourEnteteAchats.getBrfDate(), this.nature, this.retourEnteteAchats.getBrfSerie(), var1));
            } else {
               long var3 = this.retourEnteteAchatsDao.selectLastNum(var1);
               this.retourEnteteAchats.setBrfNum("" + var3);
            }

            this.verifieExistenceHabilitation(var1);
            this.retourEnteteAchats.setBrfDateAnnule((Date)null);
            this.retourEnteteAchats.setBrfMotifAnnule("");
            this.retourEnteteAchats.setBrfDateImp((Date)null);
            this.retourEnteteAchats.setBrfDateTransforme((Date)null);
            this.retourEnteteAchats.setBrfEtat(0);
            this.retourEnteteAchats = this.retourEnteteAchatsDao.duppliquer(this.retourEnteteAchats, var1);
            if (this.habilitation != null) {
               this.utilParapheur.majParapheur(this.nature, this.habilitation, this.retourEnteteAchats.getBrfId(), this.retourEnteteAchats.getBrfNum(), this.retourEnteteAchats.getBrfNomTiers(), this.retourEnteteAchats.getBrfDate(), this.retourEnteteAchats.getBrfDevise(), this.retourEnteteAchats.getBrfTotTtc() + this.retourEnteteAchats.getBrfTotTc(), this.retourEnteteAchats.getBrfModeleImp(), this.tiers, this.calculeCheminRapport(this.baseLog, this.nature), this.calculeCheminSousRapport(this.baseLog), this.calculeImpressionCommun(var1), this.calculeParc(var1), this.retourEnteteAchats.getVar_format_devise(), 0, var1);
            }

            if (this.lesLignesList.size() != 0) {
               this.retourLigneAchatsDao.duppliquerLigne(this.lesLignesList, this.retourEnteteAchats, var1);
            }
   ...
   public void transformerDocument() throws HibernateException, NamingException {
      ...
      if (this.lesEntetesList.size() != 0) {
         ...
         boolean var2 = false;
         boolean var3 = false;
         if (this.retourEnteteAchats.getBrfNumAvoir() == null || this.retourEnteteAchats.getBrfNumAvoir().isEmpty()) {
            if (this.retourEnteteAchats.getBrfTypeTransforme() != 0) {
               var3 = this.usersChronoDao.existByUserNat(this.usersLog, this.retourEnteteAchats.getBrfTypeTransforme(), var1);
               if (var3) {
                  String var4 = "";
                  if (this.retourEnteteAchats.getBrfTypeTransforme() == 16) {
                     var4 = "Avoir";
                  }

                  this.documentTrfItems.add(new SelectItem(this.retourEnteteAchats.getBrfTypeTransforme(), var4));
               }
            } else {
         ...
         for(int var8 = 0; var8 < this.lesEntetesList.size(); ++var8) {
            new RetourEnteteAchats();
            RetourEnteteAchats var5 = (RetourEnteteAchats)this.lesEntetesList.get(var8);
            if (var5.getBrfId() > 0L && var5.isVar_select_ligne()) {
               this.showModalPanelTrf = true;
               this.lesLignesList = this.retourLigneAchatsDao.chargerLesLignes(var5, var1);
               if (this.lesLignesList.size() != 0) {
                  for(int var6 = 0; var6 < this.lesLignesList.size(); ++var6) {
                     new RetourLigneAchats();
                     RetourLigneAchats var7 = (RetourLigneAchats)this.lesLignesList.get(var6);
   ...
   public void chargerModeEcheanceAffichage() {
      ...
      this.visibiliteencaissemt = false;
      this.visibilitefactor = false;
      if (this.retourEnteteAchats.getBrfTypeReg() != 0 && this.retourEnteteAchats.getBrfTypeReg() != 3) {
         if (this.retourEnteteAchats.getBrfTypeReg() != 1 && this.retourEnteteAchats.getBrfTypeReg() != 2 && this.retourEnteteAchats.getBrfTypeReg() != 10) {
            if (this.retourEnteteAchats.getBrfTypeReg() == 4) {
      ...
      if ("Factor".equalsIgnoreCase(this.retourEnteteAchats.getBrfModeReg())) {
   ...
   public void chargerModeEcheance() throws ParseException {
      ...
      this.visibilitefactor = false;
      String var1 = "0";
      if (this.retourEnteteAchats.getBrfModeReg() != null && !this.retourEnteteAchats.getBrfModeReg().isEmpty() && this.retourEnteteAchats.getBrfModeReg().contains(":")) {
         String[] var2 = this.retourEnteteAchats.getBrfModeReg().split(":");
         var1 = var2[0];
      }
      ...
      for(var6 = 0; var6 < this.lesModeReglementFournisseurListe.size(); ++var6) {
         ...
         if (var3.getCategories().equals(var1)) {
            ...
            this.retourEnteteAchats.setBrfTypeReg(Integer.parseInt(var3.getEcheances()));
            this.retourEnteteAchats.setBrfModeReg(var3.getCategories() + ":" + var3.getLibelles());
            this.retourEnteteAchats.setBrfNbJourReg(0);
            this.retourEnteteAchats.setBrfArrondiReg(0);
            break;
         }
      }
         ...
         if (this.retourEnteteAchats.getBrfTypeReg() != 1 && this.retourEnteteAchats.getBrfTypeReg() != 2 && this.retourEnteteAchats.getBrfTypeReg() != 10) {
            ...
            for(var6 = 0; var6 < this.lesModeReglementFournisseurListe.size(); ++var6) {
               ...
               if (var3.getCategories().equals(var1)) {
                  ...
                  this.retourEnteteAchats.setBrfNbJourReg(var4);
                  int var5 = 0;
                  if (var3.getArrondis() != null && !var3.getArrondis().isEmpty()) {
                     var5 = Integer.parseInt(var3.getArrondis());
                  }

                  this.retourEnteteAchats.setBrfArrondiReg(var5);
                  break;
               }
            }
   ...
   public void CalculDateEcheance() throws ParseException {
      Date var1 = this.utilDate.CalculDateEcheance(this.retourEnteteAchats.getBrfDate(), this.retourEnteteAchats.getBrfTypeReg(), this.retourEnteteAchats.getBrfNbJourReg(), this.retourEnteteAchats.getBrfArrondiReg());
      this.retourEnteteAchats.setBrfDateEcheReg(var1);
   }
   ...
   public void save() throws IOException, HibernateException, NamingException, Exception {
      ...
      try {
         var2 = var1.beginTransaction();
         this.retourEnteteAchats.setBrfDate(this.utilDate.dateToSQL(this.var_date, this.var_heure, this.var_minute, this.var_seconde));
         this.calculDateValidite();
         if (this.retourEnteteAchats.getUsers() == null) {
            this.retourEnteteAchats.setUsers(this.usersLog);
         }

         this.retourEnteteAchats.setTiers(this.tiers);
         if ((this.retourEnteteAchats.getBrfCat() == null || this.retourEnteteAchats.getBrfCat().isEmpty()) && this.retourEnteteAchats.getTiers().getTienomfamille() != null && !this.retourEnteteAchats.getTiers().getTienomfamille().isEmpty()) {
            this.retourEnteteAchats.setBrfCat(this.retourEnteteAchats.getTiers().getTienomfamille());
         }

         if (!this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("010") && !this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("020") && !this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("030") && !this.retourEnteteAchats.getTiers().getTiegenre().equalsIgnoreCase("037")) {
            this.retourEnteteAchats.setBrfCivilTiers("");
         } else {
            this.retourEnteteAchats.setBrfCivilTiers(this.retourEnteteAchats.getTiers().getTiecivilite());
         }

         if (this.retourEnteteAchats.getBrfDiversTiers() == 99) {
            this.retourEnteteAchats.setBrfIdContact(0L);
            this.retourEnteteAchats.setBrfNomContact("");
            this.retourEnteteAchats.setBrfCivilContact("");
         } else {
            new Contacts();
            Contacts var3 = this.contactDao.recupererContacts(this.var_nom_contact, var1);
            if (var3 != null) {
               this.retourEnteteAchats.setBrfIdContact(var3.getConid());
               this.retourEnteteAchats.setBrfNomContact(var3.getConpatronyme());
               this.retourEnteteAchats.setBrfCivilContact(var3.getConcivilite());
            } else {
               this.retourEnteteAchats.setBrfIdContact(0L);
               this.retourEnteteAchats.setBrfNomContact("");
               this.retourEnteteAchats.setBrfCivilContact("");
         ...
         if (var15 != null) {
            this.retourEnteteAchats.setBrfIdResponsable(var15.getUsrid());
            this.retourEnteteAchats.setBrfNomResponsable(var15.getUsrPatronyme());
         } else {
            this.retourEnteteAchats.setBrfIdResponsable(0L);
            this.retourEnteteAchats.setBrfNomResponsable("");
         }

         if (this.retourEnteteAchats.getBrfId() != 0L) {
            if (this.retourEnteteAchats.getBrfEtat() == 6) {
               if (this.retourEnteteAchats.getBrfEtatVal() == 1) {
                  this.retourEnteteAchats.setBrfEtat(0);
               } else {
                  this.retourEnteteAchats.setBrfEtat(0);
               }
            ...
            this.retourEnteteAchats.setBrfDateModif(new Date());
            this.retourEnteteAchats.setBrfIdModif(this.usersLog.getUsrid());
            this.retourEnteteAchats.setBrfNomModif(this.usersLog.getUsrNom() + " " + this.usersLog.getUsrPrenom());
            this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var1);
            this.var_action = 0;
            this.visibleOnglet = false;
         } else {
            ...
            this.retourEnteteAchats.setBrfIdCreateur(this.usersLog.getUsrid());
            this.retourEnteteAchats.setBrfNomCreateur(this.usersLog.getUsrNom() + " " + this.usersLog.getUsrPrenom());
            if (this.retourEnteteAchats.getBrfSerie() != null && !this.retourEnteteAchats.getBrfSerie().equalsIgnoreCase("X") && !this.retourEnteteAchats.getBrfSerie().isEmpty()) {
               this.retourEnteteAchats.setBrfNum(this.calculChrono.numCompose(this.retourEnteteAchats.getBrfDate(), this.nature, this.retourEnteteAchats.getBrfSerie(), var1));
               boolean var16 = false;
               ...
               while(true) {
                  while(true) {
                     ...
                     new RetourEnteteAchats();
                     RetourEnteteAchats var5 = this.retourEnteteAchatsDao.pourParapheur(this.retourEnteteAchats.getBrfNum(), this.retourEnteteAchats.getBrfSerie(), var1);
                     if (var5 != null) {
               ...
               long var4 = this.retourEnteteAchatsDao.selectLastNum(var1);
               this.retourEnteteAchats.setBrfNum("" + var4);
            }

            this.retourEnteteAchats.setBrfEtat(0);
            this.retourEnteteAchats.setBrfEtatVal(0);
            this.retourEnteteAchats.setBrfDateValide((Date)null);
            this.retourEnteteAchats = this.retourEnteteAchatsDao.insert(this.retourEnteteAchats, var1);
            this.visibleOnglet = true;
            this.var_action = 1;
            this.lesEntetesList.add(this.retourEnteteAchats);
            this.datamodelEntete.setWrappedData(this.lesEntetesList);
            this.simpleSelectionEntete.clear();
            this.extDTable = new HtmlExtendedDataTable();
         }
   ...
   public void majAnalytique() throws HibernateException, NamingException {
      this.retourEnteteAchats.setBrfSite(this.usersLog.getUsrSite());
      this.retourEnteteAchats.setBrfDepartement(this.usersLog.getUsrDepartement());
      this.retourEnteteAchats.setBrfService(this.usersLog.getUsrService());
      this.retourEnteteAchats.setBrfRegion(this.tiers.getTieregion());
      this.retourEnteteAchats.setBrfSecteur(this.tiers.getTiesecteur());
      this.retourEnteteAchats.setBrfPdv(this.tiers.getTiepdv());
      if (!this.var_anal_activite) {
         this.retourEnteteAchats.setBrfActivite("");
         ...
         if (this.decoupageActivite) {
            ...
            this.retourEnteteAchats.setBrfActivite(var1);
         }
      } else {
         Session var13 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourLigne");
         String var14 = "";
         boolean var15 = true;
         new RetourLigneAchats();
         new Produits();
         if ((this.decoupageActivite || !this.decoupageActivite) && this.lesLignesList.size() != 0) {
            ...
            while(true) {
               ...
               RetourLigneAchats var4 = (RetourLigneAchats)this.lesLignesList.get(var8);
               if (var4.getBrfligCode() != null && !var4.getBrfligCode().isEmpty()) {
                  Produits var5 = this.produitsDao.chargeProduit(var4.getBrfligCode(), var13);
                  if (var5 != null && var5.getProActivite() != null && !var5.getProActivite().isEmpty()) {
                     if (var6.size() == 0) {
                        var7 = new ObjetTarif();
                        var7.setNomLibelle(var5.getProActivite());
                        var7.setPrix(var4.getBrfligPt());
                        var6.add(var7);
                     } else {
                        boolean var9 = false;
                        double var10 = 0.0D;
                        ...
                        if (!var9) {
                           ...
                           var7.setPrix(var10 + var4.getBrfligPt());
                           var6.remove(var7);
                           var6.add(var7);
                        }
                     }
         ...
         this.retourEnteteAchats.setBrfActivite(var14);
         this.utilInitHibernate.closeSession();
      }

      if (this.retourEnteteAchats.getBrfAnal4() != null && !this.retourEnteteAchats.getBrfAnal4().isEmpty()) {
         this.retourEnteteAchats.setBrfAnal4(this.retourEnteteAchats.getBrfAnal4().toString());
      }

      if (!this.var_anal_parc) {
         this.retourEnteteAchats.setBrfAnal2("");
      } else if (this.retourEnteteAchats.getBrfAnal2() != null && this.retourEnteteAchats.getBrfAnal2().length() <= 2) {
         this.retourEnteteAchats.setBrfAnal2("");
      }

      if (this.retourEnteteAchats.getBrfAnal1() != null && this.retourEnteteAchats.getBrfAnal1().length() <= 2) {
         this.retourEnteteAchats.setBrfAnal1("");
      }
   ...
   public boolean verifieExistenceHabilitation(Session var1) throws HibernateException, NamingException {
      if (this.habilitation != null) {
         this.retourEnteteAchats.setBrfEtatVal(1);
         this.retourEnteteAchats.setBrfEtat(0);
         this.retourEnteteAchats.setBrfDateValide((Date)null);
         return true;
      } else {
   ...
   public void annulerDocument() {
      if (this.retourEnteteAchats != null) {
         this.retourEnteteAchats.setBrfDateAnnule(new Date());
   ...
   public void miseajourAnnuler() throws HibernateException, NamingException {
      if (this.retourEnteteAchats != null) {
         if (this.retourEnteteAchats.getBrfDateAnnule() == null) {
            this.retourEnteteAchats.setBrfDateAnnule(new Date());
         }

         this.retourEnteteAchats.setBrfEtat(3);
         this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats);
         Espion var1 = new Espion();
         var1.setUsers(this.usersLog);
         var1.setEsptype(0);
         var1.setEspdtecreat(new Date());
         var1.setEspaction("Annulation retour achat N° " + this.retourEnteteAchats.getBrfNum() + " le " + this.retourEnteteAchats.getBrfDateAnnule());
   ...
   public void calculDisponibilite() throws HibernateException, NamingException {
      this.retourEnteteAchats.setBrfBudgetDispo(0.0D);
      this.retourEnteteAchats.setBrfBudgetDispoMois(0.0D);
      this.retourEnteteAchats.setBrfBudgetTreso(0.0D);
      this.retourEnteteAchats.setBrfBudgetTresoMois(0.0D);
      if (this.retourEnteteAchats.getBrfBudget() != null && this.retourEnteteAchats.getBrfBudget().contains(":")) {
         String var1 = "" + this.lastExoCompta.getExecpt_id();
         String[] var2 = this.retourEnteteAchats.getBrfBudget().split(":");
         String var3 = null;
         if (this.retourEnteteAchats.getBrfActivite() != null && !this.retourEnteteAchats.getBrfActivite().isEmpty()) {
            String[] var4 = this.retourEnteteAchats.getBrfActivite().split(":");
            var3 = var4[0];
         }

         int var27 = this.retourEnteteAchats.getBrfDate().getMonth() + 1;
         double var5 = 0.0D;
         double var7 = 0.0D;
         ...
         new ArrayList();
         List var24 = var23.selectLesDisponibilites(this.lastExoCompta.getExecpt_id(), this.retourEnteteAchats.getBrfDate(), (Session)null);
         if (var24.size() != 0) {
         ...
         this.retourEnteteAchats.setBrfBudgetDispo(var5 - var28);
         this.retourEnteteAchats.setBrfBudgetDispoMois(var7 - var13);
         this.retourEnteteAchats.setBrfBudgetTreso(var15 - var19);
         this.retourEnteteAchats.setBrfBudgetTresoMois(var17 - var21);
      }
   ...
   public void calculHt(String var1, float var2, Session var3) throws HibernateException, NamingException {
      boolean var4 = false;
      if (var3 == null) {
         var3 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourLigne");
         var4 = true;
      }
      ...
      String var6 = "";
      int var7 = 0;
      if (this.retourEnteteAchats.getBrfExoTva() == 0 || this.retourEnteteAchats.getBrfExoTva() == 2 || this.retourEnteteAchats.getBrfExoTva() == 3) {
         TaxesAchats var8;
      ...
      this.retourLigneAchats.setBrfligTaxe(var6);
      this.retourLigneAchats.setBrfligTauxTaxe(var5);
      double var26 = this.retourLigneAchats.getBrfligPu();
      if (this.retourLigneAchats.getBrfligQte() != 0.0F) {
         this.retourLigneAchats.setBrfligQteUtil(this.calculStock.calculQteUtil(this.produits, this.produitsDepot, this.retourLigneAchats.getBrfligCondition(), this.retourLigneAchats.getBrfligQte(), this.retourLigneAchats.getBrfligLong(), this.retourLigneAchats.getBrfligLarg(), this.retourLigneAchats.getBrfligHaut(), this.retourLigneAchats.getBrfligDiam(), this.retourLigneAchats.getBrfligNb(), this.baseLog, this.utilInitHibernate, var3));
      } else {
         this.retourLigneAchats.setBrfligQteUtil(0.0F);
      }

      double var10 = 0.0D;
      if (this.retourLigneAchats.getBrfligCondition() != null && !this.retourLigneAchats.getBrfligCondition().isEmpty() && this.retourLigneAchats.getBrfligCondition().contains(":")) {
         var10 = var26 * (double)this.retourLigneAchats.getBrfligQte();
      } else {
         var10 = var26 * (double)this.retourLigneAchats.getBrfligQte();
      }
      ...
      if (this.optionAchats.getDecrmtRabais().equals("1")) {
         var14 = this.retourLigneAchats.getBrfligRabais();
      } else if (this.optionAchats.getDecrmtRabais().equals("2")) {
         var14 = this.retourLigneAchats.getBrfligRabais() * (double)this.retourLigneAchats.getBrfligQte();
      }

      if (this.retourLigneAchats.getBrfligTauxRemise() != 0.0F) {
         var12 = var10 - var10 * (double)this.retourLigneAchats.getBrfligTauxRemise() / 100.0D - var14;
      } else {
         var12 = var10 - var14;
      }

      double var16 = this.utilNombre.myRoundFormat(var12, this.var_format_devise);
      double var18 = var16 * (double)this.retourLigneAchats.getBrfligTauxTaxe() / 100.0D;
      double var20 = this.utilNombre.myRoundFormat(var18, this.var_format_devise);
      if (var7 == 2 || var7 == 3) {
         var18 = var16 * (double)(this.retourLigneAchats.getBrfligTauxTaxe() / 100.0F);
         var18 *= -1.0D;
      }
      ...
      double var24 = 0.0D;
      if (this.retourLigneAchats.getBrfligCondition() != null && !this.retourLigneAchats.getBrfligCondition().isEmpty() && this.retourLigneAchats.getBrfligCondition().contains(":")) {
         var24 = this.utilNombre.myRound(var16 / (double)this.retourLigneAchats.getBrfligQteUtil(), 2);
      } else {
         var24 = this.utilNombre.myRound(var16 / (double)this.retourLigneAchats.getBrfligQteUtil(), 2);
      }

      this.retourLigneAchats.setBrfligPuRem(var24);
      this.retourLigneAchats.setBrfligPt(var16);
      this.retourLigneAchats.setBrfligTva(var20);
      this.retourLigneAchats.setBrfligTc(0.0D);
      this.retourLigneAchats.setBrfligTtc(var22);
      if (var4) {
         this.utilInitHibernate.closeSession();
      }
   ...
   public void calculPrix() throws HibernateException, NamingException {
      if (this.retourLigneAchats.getBrfligCondition() != null && !this.retourLigneAchats.getBrfligCondition().isEmpty()) {
         this.prixUnitaireCorrespond((Session)null);
      }

      this.calculPrix(this.retourLigneAchats.getBrfligTaxe(), this.retourLigneAchats.getBrfligTauxTaxe(), (Session)null);
   }
   ...
   public void cumulPrix() {
      ...
      for(int var12 = 0; var12 < this.lesLignesList.size(); ++var12) {
         RetourLigneAchats var11 = (RetourLigneAchats)this.lesLignesList.get(var12);
         var1 += var11.getBrfligPt();
         var5 += var11.getBrfligTtc();
         var7 += var11.getBrfligTc();
         var3 += var11.getBrfligTva();
         if (var11.getBrfligRabais() != 0.0D || var11.getBrfligTauxRemise() != 0.0F) {
            var9 += var11.getBrfligPu() * (double)var11.getBrfligQte() - var11.getBrfligPt();
         }
      }

      this.retourEnteteAchats.setBrfTotHt(var1);
      this.retourEnteteAchats.setBrfTotTtc(var5);
      this.retourEnteteAchats.setBrfTotTc(var7);
      this.retourEnteteAchats.setBrfTotTva(var3);
      this.retourEnteteAchats.setBrfTotRemise(var9);
   }
   ...
   public void selectionLigneDetail() throws HibernateException, NamingException {
      ...
      if (this.datamodelLigne.isRowAvailable()) {
         this.retourLigneAchats = (RetourLigneAchats)this.datamodelLigne.getRowData();
         this.var_memo_qte = this.retourLigneAchats.getBrfligQteUtil();
         Session var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourLigne");
         int var2;
         if (this.retourLigneAchats.getBrfligCode() != null && this.retourLigneAchats.getBrfligCode().length() >= 2) {
            this.produits = this.produitsDao.chargeProduit(this.retourLigneAchats.getBrfligCode(), var1);
            if (this.produits != null) {
               this.retourLigneAchats.setBrfligCode(this.produits.getProCode());
               this.retourLigneAchats.setBrfligFamille(this.produits.getProAchCode());
               this.retourLigneAchats.setBrfligStock(this.produits.getProStock());
               this.retourLigneAchats.setBrfligLong(this.produits.getProLongueur());
               this.retourLigneAchats.setBrfligLarg(this.produits.getProLargeur());
               this.retourLigneAchats.setBrfligHaut(this.produits.getProEpaisseur());
               this.retourLigneAchats.setBrfligDiam(this.produits.getProDiamExt());
               this.retourLigneAchats.setBrfligPoidsBrut(this.produits.getProPoidsBrut());
               this.retourLigneAchats.setBrfligPoidsNet(this.produits.getProPoidsNet());
               this.retourLigneAchats.setBrfligVolume(this.produits.getProVolume());
               this.retourLigneAchats.setBrfligNb(this.produits.getProNbUnite());
               ...
               this.mesProduitsDepotsItems.clear();
               if (this.var_sansstock && this.produits.getProStock() != 0 && this.retourLigneAchats.getBrfligDepot() != null && !this.retourLigneAchats.getBrfligDepot().isEmpty()) {
                  new ProduitsDepot();
                  ProduitsDepot var4 = this.produitsDepotDao.produitDepByprod(this.retourLigneAchats.getBrfligCode(), this.retourLigneAchats.getBrfligDepot(), var1);
                  if (var4 != null) {
               ...
               if (this.produits.getProStock() == 2 || this.produits.getProStock() == 3 || this.produits.getProStock() == 4) {
                  this.receptionLotAchats = this.receptionLotAchatsDao.selectRetourlotByRecLig(this.retourLigneAchats, var1);
               }

               if (this.produits.getProStock() == 5) {
                  this.listeSerie = this.receptionSerieAchatsDao.selectRetourSerieByRecLig(this.retourLigneAchats, var1);
                  if ((float)this.listeSerie.size() != this.retourLigneAchats.getBrfligQte()) {
                     var2 = (int)this.retourLigneAchats.getBrfligQte() - this.listeSerie.size();
            ...
            if (this.mesTaxesAchatsItems.size() != 0) {
               for(var2 = 0; var2 < this.mesTaxesAchatsItems.size(); ++var2) {
   ...
   public void saveOneLigne() throws IOException, HibernateException, NamingException, Exception {
      ...
      try {
         var2 = var1.beginTransaction();
         if (this.retourLigneAchats.getBrfligQteUtil() == 0.0F) {
            this.retourLigneAchats.setBrfligQteUtil(this.retourLigneAchats.getBrfligQte());
         }

         this.calculPrix(this.retourLigneAchats.getBrfligTaxe(), this.retourLigneAchats.getBrfligTauxTaxe(), var1);
         if (this.var_depotProd != null && this.var_depotProd.contains("=")) {
            String[] var3;
            if (this.var_depotProd.contains(":")) {
               var3 = this.var_depotProd.split(":");
               this.retourLigneAchats.setBrfligDepot(var3[0]);
            } else {
               var3 = this.var_depotProd.split("=");
               this.retourLigneAchats.setBrfligDepot(var3[0]);
            }
         } else {
            this.retourLigneAchats.setBrfligDepot("");
         }

         if (this.retourLigneAchats.getBrfligCondition() != null && !this.retourLigneAchats.getBrfligCondition().isEmpty() && this.retourLigneAchats.getBrfligCondition().contains(":")) {
            ConditionnementDao var11 = new ConditionnementDao(this.baseLog, this.utilInitHibernate);
            String[] var4 = this.retourLigneAchats.getBrfligCondition().split(":");
            String var5 = var11.rechercheConditionnement(var4[0], var1).getCdtDescription();
            if (var5 != null && !var5.isEmpty()) {
               this.retourLigneAchats.setBrfligDescription(var5);
            } else {
               this.retourLigneAchats.setBrfligDescription("");
            }
         } else {
            this.retourLigneAchats.setBrfligDescription("");
         }

         if (this.retourLigneAchats.getBrfligId() == 0L) {
            this.retourLigneAchats.setRetourEnteteAchats(this.retourEnteteAchats);
            this.retourLigneAchats.setBrfligDevise(this.retourEnteteAchats.getBrfDevise());
            this.retourLigneAchats = this.retourLigneAchatsDao.insertLigne(this.retourLigneAchats, var1);
            this.lesLignesList.add(this.retourLigneAchats);
            this.datamodelLigne.setWrappedData(this.lesLignesList);
         } else {
            this.retourLigneAchats = this.retourLigneAchatsDao.modifLigne(this.retourLigneAchats, var1);
         }
         ...
         if (this.produits != null && this.produits.getProId() != 0L && this.tiers != null) {
            ...
            this.produitsFournisseur.setProfouDevise(this.retourEnteteAchats.getBrfDevise());
            this.produitsFournisseur.setProfouFormat(this.retourEnteteAchats.getVar_format_devise());
            if ((this.produitsFournisseur.getProfouLib() == null || this.produitsFournisseur.getProfouLib().isEmpty()) && this.retourLigneAchats.getBrfligLibelleFournisseur() != null && !this.retourLigneAchats.getBrfligLibelleFournisseur().isEmpty()) {
               this.produitsFournisseur.setProfouLib(this.retourLigneAchats.getBrfligLibelleFournisseur());
            }

            if ((this.produitsFournisseur.getProfouRef() == null || this.produitsFournisseur.getProfouRef().isEmpty()) && this.retourLigneAchats.getBrfligReference() != null && !this.retourLigneAchats.getBrfligReference().isEmpty()) {
               this.produitsFournisseur.setProfouRef(this.retourLigneAchats.getBrfligReference());
            }

            this.produitsFournisseur.setProfouDate(this.retourEnteteAchats.getBrfDate());
            this.produitsFournisseur.setProfouPa(this.retourLigneAchats.getBrfligPu());
            if (this.structureLog.getStrdevise().equalsIgnoreCase(this.retourEnteteAchats.getBrfDevise())) {
   ...
   public void deleteLigneSelect() throws HibernateException, NamingException {
      if (this.retourLigneAchats.getBrfligId() != 0L) {
         ...
         try {
            var2 = var1.beginTransaction();
            String var3 = this.retourLigneAchats.getBrfligCode();
            this.retourLigneAchatsDao.deleteOneLigne(this.retourLigneAchats, var1);
            new ArrayList();
            List var4 = (List)this.datamodelLigne.getWrappedData();
            var4.remove(this.retourLigneAchats);
            ...
            var5.setEspaction("Suppression ligne produit " + var3 + " de la retour achat N° " + this.retourEnteteAchats.getBrfNum() + " du " + this.retourEnteteAchats.getBrfDate());
   ...
   public void rechercheTiers() throws JDOMException, IOException, HibernateException, NamingException, ParseException {
      this.tiers = this.formRecherche.rechercheTiers(0, this.retourEnteteAchats.getBrfNomTiers(), this.nature);
      if (this.tiers != null) {
   ...
   public void calculeTiers() throws JDOMException, IOException, HibernateException, NamingException, ParseException {
      if (this.tiers != null) {
         ...
         this.retourEnteteAchats.setBrfNomTiers(this.nomTier);
         this.retourEnteteAchats.setBrfTypeReg(this.tiers.getTietypereg());
         this.retourEnteteAchats.setBrfModeReg(this.tiers.getTiemodereg());
         this.calculMessageLitige();
         String var2 = "";
         ...
         if (!var2.equals("") && !var2.equals("100")) {
            this.retourEnteteAchats.setBrfNbJourReg(this.tiers.getTienbecheance());
            this.retourEnteteAchats.setBrfArrondiReg(this.tiers.getTienbarrondi());
         } else {
            for(int var7 = 0; var7 < this.lesModeReglementFournisseurListe.size(); ++var7) {
               ...
               if (var4.getDefaut().equals("true")) {
                  ...
                  this.retourEnteteAchats.setBrfTypeReg(Integer.parseInt(var4.getEcheances()));
                  this.retourEnteteAchats.setBrfModeReg(var4.getCategories() + ":" + var4.getLibelles());
                  int var5 = 0;
                  if (var4.getNbjours() != null && !var4.getNbjours().isEmpty()) {
                     var5 = Integer.parseInt(var4.getNbjours());
                  }

                  this.retourEnteteAchats.setBrfNbJourReg(var5);
                  int var6 = 0;
                  if (var4.getArrondis() != null && !var4.getArrondis().isEmpty()) {
                     var6 = Integer.parseInt(var4.getArrondis());
                  }

                  this.retourEnteteAchats.setBrfArrondiReg(var6);
                  break;
               }
            }
         }
         ...
         this.chargerModeEcheanceAffichage();
         this.retourEnteteAchats.setBrfJournalReg(this.tiers.getTiejournalreg());
         if (this.tiers.getTienomfamille() != null && !this.tiers.getTienomfamille().isEmpty()) {
            this.retourEnteteAchats.setBrfCat(this.tiers.getTienomfamille());
            this.retourEnteteAchats.setBrfExoDouane(this.tiers.getTieexodouane());
            this.retourEnteteAchats.setBrfExoTva(this.tiers.getTieexotva());
         } else if (this.tiers.getTiecodepays().equalsIgnoreCase(this.structureLog.getStrcodepays())) {
            this.retourEnteteAchats.setBrfCat("Local");
         } else {
            this.retourEnteteAchats.setBrfCat("Import");
         }

         if (this.tiers.getTiecategorie().equalsIgnoreCase("Fournisseur Divers")) {
            this.retourEnteteAchats.setBrfDiversTiers(99);
         } else {
            this.retourEnteteAchats.setBrfDiversTiers(0);
            this.retourEnteteAchats.setBrfDiversNom("");
            this.retourEnteteAchats.setBrfDiversAdresse("");
            this.retourEnteteAchats.setBrfDiversVille("");
            this.retourEnteteAchats.setBrfDiversTel("");
            this.retourEnteteAchats.setBrfDiversMail("");
         }

         if (!"".equals(this.tiers.getTiedevise()) && this.tiers.getTiedevise() != null) {
            this.retourEnteteAchats.setBrfDevise(this.tiers.getTiedevise());
         } else {
            this.retourEnteteAchats.setBrfDevise(this.structureLog.getStrdevise());
         }
   ...
   public void annuleTiers() throws ParseException {
      ...
      this.informationsTiers = null;
      this.retourEnteteAchats.setTiers(this.tiers);
      this.retourEnteteAchats.setBrfNomTiers("");
      this.retourEnteteAchats.setBrfCivilTiers("");
      this.mesContactItem.clear();
      this.mesContactItem.add(new SelectItem(0, ""));
      this.lesUsers.clear();
   ...
   public void controleSaisie() throws ParseException {
      if (!this.retourEnteteAchats.getBrfNomTiers().equals("") && this.tiers.getTieid() != 0L) {
         this.var_valide_doc = true;
         this.var_aff_detail_tiers = true;
         this.CalculDateEcheance();
         if (this.retourEnteteAchats.getBrfCat() != null && !this.retourEnteteAchats.getBrfCat().isEmpty()) {
            if (this.retourEnteteAchats.getBrfCat().equalsIgnoreCase("Local")) {
               this.var_valide_doc = true;
            } else if (this.optionAchats.getAxeDossier().equals("2")) {
               this.var_valide_doc = true;
            } else if (this.retourEnteteAchats.getBrfAnal4() != null && !this.retourEnteteAchats.getBrfAnal4().isEmpty()) {
               this.var_valide_doc = true;
            } else {
               this.var_valide_doc = false;
            }
   ...
   public void recupererEltCat() throws HibernateException, NamingException, ParseException {
      ...
      if (this.lesFamilleFournisseursListe.size() != 0) {
         for(int var3 = 0; var3 < this.lesFamilleFournisseursListe.size(); ++var3) {
            if (this.retourEnteteAchats.getBrfCat() != null && !this.retourEnteteAchats.getBrfCat().isEmpty() && this.retourEnteteAchats.getBrfCat().equalsIgnoreCase(((ObjetFamilleTiers)this.lesFamilleFournisseursListe.get(var3)).getLibelle())) {
      ...
      if (!var1.equalsIgnoreCase("true") && !var1.equalsIgnoreCase("1")) {
         if (var1.equalsIgnoreCase("2")) {
            if (this.tiers != null && this.tiers.getTiecodepays() != null && !this.tiers.getTiecodepays().equals(this.structureLog.getStrcodepays())) {
               this.retourEnteteAchats.setBrfExoTva(3);
            } else {
               this.retourEnteteAchats.setBrfExoTva(2);
            }
         } else {
            this.retourEnteteAchats.setBrfExoTva(0);
         }
      } else {
         this.retourEnteteAchats.setBrfExoTva(1);
      }

      if (!var2.equalsIgnoreCase("true") && !var2.equalsIgnoreCase("1")) {
         this.retourEnteteAchats.setBrfExoDouane(0);
      } else {
         this.retourEnteteAchats.setBrfExoDouane(1);
      }
      ...
      if (this.lesLignesList.size() != 0) {
         ...
         try {
            ...
            for(int var5 = 0; var5 < this.lesLignesList.size(); ++var5) {
               this.retourLigneAchats = new RetourLigneAchats();
               this.retourLigneAchats = (RetourLigneAchats)this.lesLignesList.get(var5);
               if (this.retourEnteteAchats.getBrfExoTva() == 1) {
                  this.retourLigneAchats.setBrfligTaxe("");
                  this.retourLigneAchats.setBrfligTauxTaxe(0.0F);
                  this.retourLigneAchats.setBrfligTva(0.0D);
               } else if (this.retourLigneAchats.getBrfligCode() != null && !this.retourLigneAchats.getBrfligCode().isEmpty()) {
                  new Produits();
                  Produits var6 = this.produitsDao.chargeProduit(this.retourLigneAchats.getBrfligCode(), var13);
                  TaxesAchats var7;
                  if (var6 == null) {
                     if (this.optionAchats.getTvaDefaut() != null && !this.optionAchats.getTvaDefaut().isEmpty()) {
                        ...
                        if (var7 != null) {
                           this.retourLigneAchats.setBrfligTaxe(this.optionAchats.getTvaDefaut());
                           this.retourLigneAchats.setBrfligTauxTaxe(var7.getTaxachTaux());
                        } else {
                           this.retourLigneAchats.setBrfligTaxe("");
                           this.retourLigneAchats.setBrfligTauxTaxe(0.0F);
                        }
                     ...
                     if (var6.getProVteTva() != null && !var6.getProVteTva().isEmpty()) {
                        this.retourLigneAchats.setBrfligTaxe(var6.getProVteTva());
                     } else {
                        ...
                        if (this.famillesProduitsAchats != null) {
                           this.retourLigneAchats.setBrfligTaxe(this.famillesProduitsAchats.getFamachTaxe());
                        }
                     }

                     new TaxesAchats();
                     var7 = this.taxesAchatsDao.selectTva(this.exercicesAchats.getExeachId(), this.retourLigneAchats.getBrfligTaxe(), var13);
                     if (var7 != null) {
                        this.retourLigneAchats.setBrfligTauxTaxe(var7.getTaxachTaux());
                     } else {
                        this.retourLigneAchats.setBrfligTauxTaxe(0.0F);
               ...
               this.calculPrix(this.retourLigneAchats.getBrfligTaxe(), this.retourLigneAchats.getBrfligTauxTaxe(), var13);
               this.retourLigneAchats = this.retourLigneAchatsDao.modifLigne(this.retourLigneAchats, var13);
            }

            if (this.retourEnteteAchats.getBrfId() != 0L) {
               this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var13);
               var4.commit();
            }
   ...
   public void rechercheProduits() throws JDOMException, IOException, HibernateException, NamingException {
      this.produits = this.formRecherche.rechercheProduitAchat(this.retourLigneAchats.getBrfligCode(), this.nature);
      if (this.produits != null) {
   ...
   public void calculeProduits() throws JDOMException, IOException, HibernateException, NamingException {
      if (this.produits != null) {
         ...
         if (this.optionAchats.getModLibelleProd().equals("1")) {
            this.retourLigneAchats.setBrfligLibelle(this.produits.getProLibTech());
         } else {
            this.retourLigneAchats.setBrfligLibelle(this.produits.getProLibClient());
         }
         ...
         this.retourLigneAchats.setBrfligVolume(this.produits.getProVolume());
         this.retourLigneAchats.setBrfligNb(this.produits.getProNbUnite());
         this.retourLigneAchats.setBrfligReference((String)null);
         this.retourLigneAchats.setBrfligLibelleFournisseur((String)null);
         if (this.produits.getProImpDesciption() == 1) {
            if (this.usersLog.getUsrAchLibelle() == 1) {
               this.verrou_libelle = true;
            } else {
         ...
         if (this.produits.getProAchTva() != null && !this.produits.getProAchTva().isEmpty() && !this.produits.getProAchTva().equals("0")) {
            ...
            this.retourLigneAchats.setBrfligTaxe(this.produits.getProAchTva());
            this.retourLigneAchats.setBrfligTauxTaxe(var5);
         } else {
            ...
            if (var2 != null && var2.getFamachTaxe() != null && !var2.getFamachTaxe().isEmpty() && !var2.getFamachTaxe().equals("0")) {
               ...
               this.retourLigneAchats.setBrfligTaxe(var2.getFamachTaxe());
               this.retourLigneAchats.setBrfligTauxTaxe(var3);
            } else {
               this.retourLigneAchats.setBrfligTaxe("");
               this.retourLigneAchats.setBrfligTauxTaxe(0.0F);
            }
         ...
         if (this.produitsDepot != null) {
            ...
            if (this.produitsDepot.getProdepUnite() != null && !this.produitsDepot.getProdepUnite().isEmpty()) {
               this.retourLigneAchats.setBrfligUnite(this.produitsDepot.getProdepUnite());
            } else {
               this.retourLigneAchats.setBrfligUnite("");
            }
         } else {
         ...
         this.mesConditionnementsProduits = this.chargerConditionnementProduit(var1);
         this.retourLigneAchats.setBrfligCondition("");
   ...
   public void selectionListeTva() {
      ...
      boolean var2;
      int var3;
      if (this.retourEnteteAchats.getBrfExoTva() == 0) {
         if (this.mesTaxesAchatsItems.size() != 0) {
      ...
      } else if ((this.retourEnteteAchats.getBrfExoTva() == 2 || this.retourEnteteAchats.getBrfExoTva() == 3) && this.mesTaxesAchatsItems.size() != 0) {
         for(var1 = 0; var1 < this.mesTaxesAchatsItems.size(); ++var1) {
            var2 = false;
            ...
            for(var3 = 0; var3 < this.lisTaxesAchats.size(); ++var3) {
               if (((TaxesAchats)this.lisTaxesAchats.get(var3)).getTaxachCode().equals(((SelectItem)this.mesTaxesAchatsItems.get(var1)).getValue().toString())) {
                  if (((TaxesAchats)this.lisTaxesAchats.get(var3)).getTaxachType() == 2 && this.retourEnteteAchats.getBrfExoTva() == 2) {
                     var2 = true;
                     break;
                  }

                  if (((TaxesAchats)this.lisTaxesAchats.get(var3)).getTaxachType() == 3 && this.retourEnteteAchats.getBrfExoTva() == 3) {
                     var2 = true;
                     break;
                  }
               }
   ...
   public void calculTva() {
      if (this.retourLigneAchats.getBrfligCode() == null || this.retourLigneAchats.getBrfligCode().isEmpty() || this.retourLigneAchats.getBrfligCode().length() < 2) {
         this.selectionListeTva();
   ...
   public void annuleProduits() {
      this.produits = null;
      this.produitsDepot = null;
      this.retourLigneAchats.setBrfligCode("");
      this.retourLigneAchats.setBrfligLibelle("");
      this.mesTaxesAchatsProduits.clear();
      this.mesProduitsDepotsItems.clear();
      this.mesConditionnementsProduits.clear();
      this.mesUnitesProduits.clear();
   ...
   public void prixUnitaireCorrespond(Session var1) throws HibernateException, NamingException {
      if (this.produits != null && this.tiers != null) {
         this.produitsFournisseur = this.produitsFournisseurDao.selectProdFourByprodFic(this.produits, this.tiers, var1);
         if (this.produitsFournisseur != null) {
            this.retourLigneAchats.setBrfligPu(this.produitsFournisseur.getProfouPa());
            this.retourLigneAchats.setBrfligReference(this.produitsFournisseur.getProfouRef());
            this.retourLigneAchats.setBrfligLibelleFournisseur(this.produitsFournisseur.getProfouLib());
         }
      }
   ...
   public void selectionDepot(Session var1) throws HibernateException, NamingException {
      ...
      if (this.produitsDepot != null) {
         ...
         float var4;
         if (this.retourLigneAchats.getBrfligCondition() != null && !this.retourLigneAchats.getBrfligCondition().isEmpty() && this.retourLigneAchats.getBrfligCondition().contains(":")) {
            var4 = this.calculStock.calculCoefConversion(this.produitsDepot.getProdepEchelle(), this.retourLigneAchats.getBrfligEchelle());
            float var5 = 1.0F;
            if (this.retourLigneAchats.getBrfligCondition().contains("/")) {
               String[] var6 = this.retourLigneAchats.getBrfligCondition().split("/");
               String var7 = var6[1];
         ...
         } else if (this.retourLigneAchats.getBrfligCondition() != null && !this.retourLigneAchats.getBrfligCondition().isEmpty() && !this.retourLigneAchats.getBrfligCondition().contains(":")) {
            var4 = this.calculStock.calculCoefConversion(this.produitsDepot.getProdepEchelle(), this.retourLigneAchats.getBrfligEchelle());
         ...
         this.retourLigneAchats.setBrfligPump(var10);
      } else {
         this.retourLigneAchats.setBrfligPump(0.0D);
      }
   ...
   public void mefConditionnementDepot(Session var1) throws HibernateException, NamingException {
      ...
      if (this.var_sansstock && this.produits.getProStock() != 0) {
         String var2 = this.retourLigneAchats.getBrfligCondition();
         if (var2 != null && !var2.isEmpty() && var2.contains(":")) {
            if (var2.contains("/")) {
               ...
               if (this.unite != null) {
                  this.retourLigneAchats.setBrfligEchelle(this.unite.getUniEchelle());
               } else {
                  this.retourLigneAchats.setBrfligEchelle(this.produitsDepot.getProdepEchelle());
               }
            } else {
               this.retourLigneAchats.setBrfligEchelle(this.produitsDepot.getProdepEchelle());
            }
         } else if (var2 != null && !var2.isEmpty() && !var2.contains(":")) {
            this.retourLigneAchats.setBrfligEchelle(Integer.parseInt(var2));
         } else {
            this.retourLigneAchats.setBrfligEchelle(0);
         }
         ...
         if (this.listeProduitDepot.size() != 0) {
            for(int var10 = 0; var10 < this.listeProduitDepot.size(); ++var10) {
               ...
               int var7;
               if (var2 != null && !var2.isEmpty() && var2.contains(":")) {
                  var12 = this.calculStock.calculQteUtilMultiple(this.produits, this.produitsDepot, var2, var12, this.retourLigneAchats.getBrfligLong(), this.retourLigneAchats.getBrfligLarg(), this.retourLigneAchats.getBrfligHaut(), this.retourLigneAchats.getBrfligDiam(), this.retourLigneAchats.getBrfligNb(), this.baseLog, var1);
                  var7 = (int)var12;
                  var6 = "" + var7;
               } else if (var2 != null && !var2.isEmpty() && !var2.contains(":")) {
                  var12 = this.calculStock.calculQteUtilMultiple(this.produits, this.produitsDepot, var2, var12, this.retourLigneAchats.getBrfligLong(), this.retourLigneAchats.getBrfligLarg(), this.retourLigneAchats.getBrfligHaut(), this.retourLigneAchats.getBrfligDiam(), this.retourLigneAchats.getBrfligNb(), this.baseLog, var1);
   ...
   public void rechercheDossier() throws JDOMException, IOException, HibernateException, NamingException, ParseException {
      ...
      if (this.optionAchats.getAxeDossier().equals("2")) {
         this.dossier = this.formRecherche.rechercheAffaire(this.retourEnteteAchats.getBrfAnal4(), var1, this.nature, this.var_date, this.exercicesAchats, this.retourEnteteAchats.getBrfSerie(), this.retourEnteteAchats.getBrfDevise());
      } else {
         this.dossier = this.formRecherche.rechercheDossier(this.retourEnteteAchats.getBrfAnal4(), var1, this.nature, this.var_date, this.exercicesAchats, this.retourEnteteAchats.getBrfSerie(), this.retourEnteteAchats.getBrfDevise());
      }
      ...
      if (this.dossier != null) {
         if (this.optionAchats.getAxeDossier().equals("2")) {
            ...
            if (this.dossier.getAnaTypeDossier() != null && !this.dossier.getAnaTypeDossier().isEmpty() && !this.dossier.getAnaTypeDossier().equals("0")) {
               this.retourEnteteAchats.setBrfAnal4(this.dossier.getAnaTypeDossier() + this.dossier.getAnaCode());
            } else {
               this.retourEnteteAchats.setBrfAnal4(this.dossier.getAnaCode());
            }
         } else {
            this.libelleDossierFiche = "N° Dossier";
            this.retourEnteteAchats.setBrfAnal4(this.dossier.getAnaCode());
         ...
         this.retourEnteteAchats.setBrfAnal4("");
      }
   ...
   public void serieSelectTrf() throws HibernateException, NamingException, ParseException {
      ...
      this.var_serie_trf = this.retourEnteteAchats.getBrfSerie();
   ...
   public void accesImputSerie() {
      ...
      this.var_imput_num = "";
      this.var_imput_serie = this.retourEnteteAchats.getBrfSerie();
      this.var_imput_cat = this.retourEnteteAchats.getBrfCat();
   ...
   public void controleNumero() throws HibernateException, NamingException {
      if (this.var_imput_num != null && !this.var_imput_num.isEmpty()) {
         new RetourEnteteAchats();
         RetourEnteteAchats var1 = this.retourEnteteAchatsDao.pourParapheur(this.var_imput_num, this.retourEnteteAchats.getBrfSerie(), (Session)null);
         if (var1 != null) {
            this.var_imput_num = "";
         }
      }
   ...
   public void miseajourImput() throws IOException, JDOMException, HibernateException, NamingException, ParseException {
      ...
      if (this.var_imput_choix == 0) {
         if (this.var_imput_num != null && !this.var_imput_num.isEmpty()) {
            ...
            try {
               var2 = var1.beginTransaction();
               var3 = this.retourEnteteAchats.getBrfNum();
               this.retourEnteteAchats.setBrfNum(this.var_imput_num);
               this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var1);
               new ArrayList();
               if (this.parapheurDao == null) {
                  this.parapheurDao = new ParapheurDao(this.baseLog, this.utilInitHibernate);
               }

               var4 = (ArrayList)this.parapheurDao.parapheurDocument(this.retourEnteteAchats.getBrfId(), this.nature, var1);
               if (var4 != null) {
                  for(var5 = 0; var5 < var4.size(); ++var5) {
                     new Parapheur();
                     var6 = (Parapheur)var4.get(var5);
                     var6.setPhrNum(this.retourEnteteAchats.getBrfNum());
               ...
               var21.setEspaction("Imputation Réception achat N° " + var3 + " en Réception achat N° " + this.retourEnteteAchats.getBrfNum());
         ...
         try {
            var2 = var1.beginTransaction();
            var3 = this.retourEnteteAchats.getBrfNum();
            this.retourEnteteAchats.setBrfSerie(this.var_imput_serie);
            this.retourEnteteAchats.setBrfCat(this.var_imput_cat);
            this.retourEnteteAchats.setBrfNum(this.calculChrono.numCompose(this.retourEnteteAchats.getBrfDate(), this.nature, this.retourEnteteAchats.getBrfSerie(), var1));
            this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var1);
            if (this.retourEnteteAchats.getBrfTotReglement() != 0.0D) {
               new ArrayList();
               ReglementsDao var22 = new ReglementsDao(this.baseLog, this.utilInitHibernate);
               var4 = (ArrayList)var22.reglementDocument(this.retourEnteteAchats.getBrfId(), this.nature, var1);
               if (var4 != null) {
                  for(int var23 = 0; var23 < var4.size(); ++var23) {
                     new Reglements();
                     Reglements var7 = (Reglements)var4.get(var23);
                     var7.setRglDocument(this.retourEnteteAchats.getBrfNum());
            ...
            var21.setEsptype(0);
            var21.setEspdtecreat(new Date());
            var21.setEspaction("Imputation Retour achat X N° " + var3 + " en Retour achat " + this.retourEnteteAchats.getBrfSerie() + " N° " + this.retourEnteteAchats.getBrfNum());
            this.espionDao.mAJEspion(var21, var1);
            var2.commit();
   ...
   public void qteTrfQteOrg(Session var1) throws HibernateException, NamingException {
      if (this.documentDetailTrf.size() != 0) {
         for(int var2 = 0; var2 < this.documentDetailTrf.size(); ++var2) {
            new RetourLigneAchats();
            RetourLigneAchats var3 = (RetourLigneAchats)this.documentDetailTrf.get(var2);
            long var4 = var3.getBrfligId();
            float var6 = var3.getBrfligQte();
            float var7 = 0.0F;
            if (this.var_type_trf == 16) {
               AvoirLigneAchatsDao var8 = new AvoirLigneAchatsDao(this.baseLog, this.utilInitHibernate);
               var7 = var8.chargerLesReliquatsFacturesAchs(var4, var1);
            }
            ...
            var3 = (RetourLigneAchats)this.documentDetailTrf.set(var2, var3);
         }
   ...
   public void razQteTrf() throws ParseException {
      if (this.documentDetailTrf.size() != 0) {
         for(int var1 = 0; var1 < this.documentDetailTrf.size(); ++var1) {
            new RetourLigneAchats();
            RetourLigneAchats var2 = (RetourLigneAchats)this.documentDetailTrf.get(var1);
            var2.setVar_qteReliquat(0.0F);
            var2 = (RetourLigneAchats)this.documentDetailTrf.set(var1, var2);
         }
   ...
   public void transformerMaj() throws HibernateException, NamingException, Exception {
      if (this.documentDetailTrf.size() != 0 && this.lesEntetesList.size() != 0) {
         ...
         for(int var5 = 0; var5 < this.documentDetailTrf.size(); ++var5) {
            var3 += ((RetourLigneAchats)this.documentDetailTrf.get(var5)).getBrfligQte();
            var2 += ((RetourLigneAchats)this.documentDetailTrf.get(var5)).getVar_qteDejaTrf();
            var4 += ((RetourLigneAchats)this.documentDetailTrf.get(var5)).getVar_qteReliquat();
         }
         ...
         if (var3 == var2) {
            ...
            for(var7 = 0; var7 < this.lesEntetesList.size(); ++var7) {
               RetourEnteteAchats var6 = (RetourEnteteAchats)this.lesEntetesList.get(var7);
               if (var6.isVar_select_ligne()) {
                  var6.setBrfEtat(5);
                  this.retourEnteteAchatsDao.modif(var6);
               }
            }
         } else {
            var10 = true;
         ...
         if (var10 && var4 != 0.0F) {
            boolean var8;
            int var9;
            RetourEnteteAchats var12;
            if (this.var_mode_trf.equals("0")) {
               for(var11 = 0; var11 < this.lesEntetesList.size(); ++var11) {
                  new RetourEnteteAchats();
                  var12 = (RetourEnteteAchats)this.lesEntetesList.get(var11);
                  if (var12.isVar_select_ligne()) {
                     var8 = false;

                     for(var9 = 0; var9 < var1.size(); ++var9) {
                        if (var12.getBrfNum().equalsIgnoreCase(((RetourEnteteAchats)var1.get(var9)).getBrfNum())) {
                           var8 = true;
                           break;
                        }
                     }
               ...
               for(var11 = 0; var11 < this.documentDetailTrf.size(); ++var11) {
                  ...
                  if (var12.isVar_select_ligne()) {
                     ...
                     for(var9 = 0; var9 < var1.size(); ++var9) {
                        if (var12.getTiers().getTieid() == ((RetourEnteteAchats)var1.get(var9)).getTiers().getTieid()) {
                           if (var12.getBrfSerie().equalsIgnoreCase(((RetourEnteteAchats)var1.get(var9)).getBrfSerie())) {
                              var8 = true;
                           }
                           break;
                        }
            ...
            if (var1.size() != 0) {
               for(var11 = 0; var11 < var1.size(); ++var11) {
                  this.retourEnteteAchats = (RetourEnteteAchats)var1.get(var11);
                  this.lesLignesList.clear();
                  if (this.var_mode_trf.equals("0")) {
                     for(var7 = 0; var7 < this.documentDetailTrf.size(); ++var7) {
                        if (((RetourEnteteAchats)var1.get(var11)).getBrfNum().equalsIgnoreCase(((RetourLigneAchats)this.documentDetailTrf.get(var7)).getRetourEnteteAchats().getBrfNum())) {
                           this.lesLignesList.add(this.documentDetailTrf.get(var7));
                        }
                     }
                  } else {
                     for(var7 = 0; var7 < this.documentDetailTrf.size(); ++var7) {
                        if (((RetourEnteteAchats)var1.get(var11)).getTiers().getTieid() == ((RetourLigneAchats)this.documentDetailTrf.get(var7)).getRetourEnteteAchats().getTiers().getTieid()) {
                           this.lesLignesList.add(this.documentDetailTrf.get(var7));
                        }
                     }
                  }
                  ...
                  if (this.lesLignesList.size() != 0) {
                     this.utilParapheur.supprimerParapheur(this.retourEnteteAchats.getBrfId(), this.nature, (Session)null);
                     if (this.var_type_trf == 16) {
                        this.trfAvoir();
                     }
                  }
         ...
         if (this.lesEntetesList.size() != 0) {
            for(var11 = 0; var11 < this.lesEntetesList.size(); ++var11) {
               this.retourEnteteAchats = (RetourEnteteAchats)this.lesEntetesList.get(var11);
               if (this.retourEnteteAchats.isVar_select_ligne()) {
                  this.lesEntetesList.remove(this.retourEnteteAchats);
               }
            }
         }
   ...
   public void trfAvoir() throws HibernateException, NamingException, Exception {
      ...
      try {
         ...
         if (this.var_serie_trf != null && !this.var_serie_trf.isEmpty()) {
            ...
            var3.setAvfSerie(this.retourEnteteAchats.getBrfSerie());
         }
         ...
         if (this.var_date_trf == null) {
            var3.setAvfDate(this.utilDate.dateToSQLLight(this.retourEnteteAchats.getBrfDate()));
         } else {
         ...
         if (this.optionAchats.getNbrJrRelanceAVOIR() != null && !this.optionAchats.getNbrJrRelanceAVOIR().isEmpty()) {
            var35 = Integer.parseInt(this.optionAchats.getNbrJrRelanceAVOIR());
         } else {
            var35 = 0;
         }
         ...
         if (this.optionAchats.getNbrJrValidAVOIR() != null && !this.optionAchats.getNbrJrValidAVOIR().isEmpty()) {
            var36 = Integer.parseInt(this.optionAchats.getNbrJrValidAVOIR());
         } else {
            var36 = 0;
         }

         var3.setAvfDateRelance(this.utilDate.datedevaleurTheo(this.var_date, var35));
         var3.setAvfDateValidite(this.utilDate.datedevaleurTheo(this.var_date, var36));
         var3.setAvfService(this.retourEnteteAchats.getBrfService());
         if (!var3.getAvfSerie().equalsIgnoreCase("X") && !var3.getAvfSerie().isEmpty()) {
            var3.setAvfNum(this.calculChrono.numCompose(this.retourEnteteAchats.getBrfDate(), this.var_type_trf, var3.getAvfSerie(), var1));
         } else {
         ...
         var3.setAvfNomResponsable(this.retourEnteteAchats.getBrfNomResponsable());
         var3.setAvfIdResponsable(this.retourEnteteAchats.getBrfIdResponsable());
         var3.setAvfNomTiers(this.retourEnteteAchats.getBrfNomTiers());
         var3.setAvfCivilTiers(this.retourEnteteAchats.getBrfCivilTiers());
         var3.setAvfIdContact(this.retourEnteteAchats.getBrfIdContact());
         var3.setAvfNomContact(this.retourEnteteAchats.getBrfNomContact());
         var3.setAvfCivilContact(this.retourEnteteAchats.getBrfCivilContact());
         var3.setAvfDiversAdresse(this.retourEnteteAchats.getBrfDiversAdresse());
         var3.setAvfDiversMail(this.retourEnteteAchats.getBrfDiversMail());
         var3.setAvfDiversNom(this.retourEnteteAchats.getBrfDiversNom());
         var3.setAvfDiversTel(this.retourEnteteAchats.getBrfDiversTel());
         var3.setAvfDiversTiers(this.retourEnteteAchats.getBrfDiversTiers());
         var3.setAvfDiversVille(this.retourEnteteAchats.getBrfDiversVille());
         var3.setAvfSerie(this.retourEnteteAchats.getBrfSerie());
         var3.setAvfSource(this.retourEnteteAchats.getBrfSource());
         var3.setAvfExoTva(this.retourEnteteAchats.getBrfExoTva());
         var3.setAvfExoDouane(this.retourEnteteAchats.getBrfExoDouane());
         var3.setAvfJournalReg(this.retourEnteteAchats.getBrfJournalReg());
         var3.setAvfCat(this.retourEnteteAchats.getBrfCat());
         var3.setAvfDevise(this.retourEnteteAchats.getBrfDevise());
         var3.setAvfObject(this.retourEnteteAchats.getBrfObject());
         var3.setAvfObservation(this.retourEnteteAchats.getBrfObservation());
         ...
         var3.setAvfSolde(0);
         var3.setAvfBanque(this.retourEnteteAchats.getBrfBanque());
         var3.setAvfTypeReg(this.retourEnteteAchats.getBrfTypeReg());
         var3.setAvfModeReg(this.retourEnteteAchats.getBrfModeReg());
         var3.setAvfNbJourReg(this.retourEnteteAchats.getBrfNbJourReg());
         var3.setAvfArrondiReg(this.retourEnteteAchats.getBrfArrondiReg());
         var3.setAvfConditionReg(this.retourEnteteAchats.getBrfConditionReg());
         var3.setAvfDateEcheReg(this.retourEnteteAchats.getBrfDateEcheReg());
         var3.setAvfActivite(this.retourEnteteAchats.getBrfActivite());
         var3.setAvfSite(this.retourEnteteAchats.getBrfSite());
         var3.setAvfDepartement(this.retourEnteteAchats.getBrfDepartement());
         var3.setAvfRegion(this.retourEnteteAchats.getBrfRegion());
         var3.setAvfSecteur(this.retourEnteteAchats.getBrfSecteur());
         var3.setAvfPdv(this.retourEnteteAchats.getBrfPdv());
         var3.setAvfAnal1(this.retourEnteteAchats.getBrfAnal1());
         var3.setAvfAnal2(this.retourEnteteAchats.getBrfAnal2());
         var3.setAvfAnal4(this.retourEnteteAchats.getBrfAnal4());
         var3.setAvfAffaire(this.retourEnteteAchats.getBrfAffaire());
         var3.setAvfInfo1(this.retourEnteteAchats.getBrfInfo1());
         var3.setAvfInfo2(this.retourEnteteAchats.getBrfInfo2());
         var3.setAvfInfo3(this.retourEnteteAchats.getBrfInfo3());
         var3.setAvfInfo4(this.retourEnteteAchats.getBrfInfo4());
         var3.setAvfInfo5(this.retourEnteteAchats.getBrfInfo5());
         var3.setAvfInfo6(this.retourEnteteAchats.getBrfInfo6());
         var3.setAvfInfo7(this.retourEnteteAchats.getBrfInfo7());
         var3.setAvfInfo8(this.retourEnteteAchats.getBrfInfo8());
         var3.setAvfInfo9(this.retourEnteteAchats.getBrfInfo9());
         var3.setAvfInfo10(this.retourEnteteAchats.getBrfInfo10());
         var3.setAvfFormule1(this.retourEnteteAchats.getBrfFormule1());
         var3.setAvfFormule2(this.retourEnteteAchats.getBrfFormule2());
         var3.setAvfAnnexe1(this.retourEnteteAchats.getBrfAnnexe1());
         var3.setAvfAnnexe2(this.retourEnteteAchats.getBrfAnnexe2());
         var3.setAvfContrat(this.retourEnteteAchats.getBrfContrat());
         ...
         var3.setExercicesAchats(this.retourEnteteAchats.getExercicesAchats());
         var3.setTiers(this.retourEnteteAchats.getTiers());
         var3.setUsers(this.usersLog);
         ...
         if (this.lesLignesList.size() != 0) {
            ...
            while(true) {
               ...
               this.retourLigneAchats = (RetourLigneAchats)this.lesLignesList.get(var26);
               if (this.optionAchats.getTransformation().equals("1") && (var24 == null || var24.isEmpty() || !var24.equals(this.retourLigneAchats.getRetourEnteteAchats().getBrfNum()))) {
                  var24 = this.retourLigneAchats.getRetourEnteteAchats().getBrfNum();
                  ++var25;
                  AvoirLigneAchats var27 = new AvoirLigneAchats();
                  var27.setAvfligCode("-");
                  var27.setAvfligLibelle("---> Suivant retour achat N° " + var24);
                  var27.setAvoirEnteteAchats(var3);
                  var6.add(var27);
               }

               if (this.retourLigneAchats.getBrfligLibelle() != null && !this.retourLigneAchats.getBrfligLibelle().isEmpty() && this.retourLigneAchats.getVar_qteReliquat() != 0.0F) {
                  if (this.retourLigneAchats.getBrfligCode() != null && !this.retourLigneAchats.getBrfligCode().isEmpty()) {
                     this.produits = this.produitsDao.chargeProduit(this.retourLigneAchats.getBrfligCode(), var1);
                     if (this.produits != null && this.retourLigneAchats.getBrfligDepot() != null && !this.retourLigneAchats.getBrfligDepot().isEmpty()) {
                        this.produitsDepot = this.produitsDepotDao.produitDepByprod(this.retourLigneAchats.getBrfligCode(), this.retourLigneAchats.getBrfligDepot(), var1);
                     }
                  }

                  float var38 = this.retourLigneAchats.getBrfligQte();
                  float var28 = this.retourLigneAchats.getBrfligQteUtil();
                  ++var25;
                  AvoirLigneAchats var29 = new AvoirLigneAchats();
                  var37 += ((RetourLigneAchats)this.lesLignesList.get(var26)).getBrfligQte();
                  var10 += ((RetourLigneAchats)this.lesLignesList.get(var26)).getVar_qteDejaTrf();
                  if (((RetourLigneAchats)this.lesLignesList.get(var26)).getVar_qteReliquat() != 0.0F) {
                     var29.setAvfligCode(this.retourLigneAchats.getBrfligCode());
                     var29.setAvfligDevise(this.retourLigneAchats.getBrfligDevise());
                     var29.setAvfligFamille(this.retourLigneAchats.getBrfligFamille());
                     var29.setAvfligIdFcf(this.retourLigneAchats.getBrfligId());
                     var29.setAvfligLibelle(this.retourLigneAchats.getBrfligLibelle());
                     var29.setAvfligComplement(this.retourLigneAchats.getBrfligComplement());
                     var29.setAvfligEchelle(this.retourLigneAchats.getBrfligEchelle());
                     var29.setAvfligUnite(this.retourLigneAchats.getBrfligUnite());
                     var29.setAvfligReference(this.retourLigneAchats.getBrfligReference());
                     var29.setAvfligPump(this.retourLigneAchats.getBrfligPump());
                     var29.setAvfligPu(this.retourLigneAchats.getBrfligPu());
                     var29.setAvfligTauxRemise(this.retourLigneAchats.getBrfligTauxRemise());
                     var29.setAvfligPuRem(this.retourLigneAchats.getBrfligPuRem());
                     this.retourLigneAchats.setBrfligQte(((RetourLigneAchats)this.lesLignesList.get(var26)).getVar_qteReliquat());
                     this.calculPrix(this.retourLigneAchats.getBrfligTaxe(), this.retourLigneAchats.getBrfligTauxTaxe(), var1);
                     var29.setAvfligQte(((RetourLigneAchats)this.lesLignesList.get(var26)).getVar_qteReliquat());
                     var29.setAvfligLong(this.retourLigneAchats.getBrfligLong());
                     var29.setAvfligLarg(this.retourLigneAchats.getBrfligLarg());
                     var29.setAvfligHaut(this.retourLigneAchats.getBrfligHaut());
                     var29.setAvfligDiam(this.retourLigneAchats.getBrfligDiam());
                     var29.setAvfligPoidsBrut(this.retourLigneAchats.getBrfligPoidsBrut());
                     var29.setAvfligPoidsNet(this.retourLigneAchats.getBrfligPoidsNet());
                     var29.setAvfligVolume(this.retourLigneAchats.getBrfligVolume());
                     var29.setAvfligNb(this.retourLigneAchats.getBrfligNb());
                     var29.setAvfligRabais(this.retourLigneAchats.getBrfligRabais());
                     var29.setAvfligTauxTaxe(this.retourLigneAchats.getBrfligTauxTaxe());
                     var29.setAvfligTaxe(this.retourLigneAchats.getBrfligTaxe());
                     var29.setAvfligPt(this.retourLigneAchats.getBrfligPt());
                     var29.setAvfligTva(this.retourLigneAchats.getBrfligTva());
                     var29.setAvfligTtc(this.retourLigneAchats.getBrfligTtc());
                     var29.setAvfligTc(this.retourLigneAchats.getBrfligTc());
                     var29.setAvoirEnteteAchats(var3);
                     var11 += ((RetourLigneAchats)this.lesLignesList.get(var26)).getVar_qteReliquat();
                     var6.add(var29);
                     var12 += var29.getAvfligPt();
                     var14 += (var29.getAvfligPu() - var29.getAvfligPuRem()) * (double)var29.getAvfligQte();
                     var16 += var29.getAvfligRabais();
                     var18 += var29.getAvfligTva();
                     var20 += var29.getAvfligTtc();
                     var22 += var29.getAvfligTc();
                     this.retourLigneAchats.setBrfligQte(var38);
                     this.retourLigneAchats.setBrfligQteUtil(var28);
                  }
               }
         ...
         this.documentTraceAchats.setExercicesAchats(this.retourEnteteAchats.getExercicesAchats());
         this.documentTraceAchats.setDoctrfOrgType(this.nature);
         this.documentTraceAchats.setDoctrfOrgSerie(this.retourEnteteAchats.getBrfSerie());
         this.documentTraceAchats.setDoctrfOrgId(this.retourEnteteAchats.getBrfId());
         this.documentTraceAchats.setDoctrfOrgNum(this.retourEnteteAchats.getBrfNum());
         this.documentTraceAchats.setDoctrfOrgDate(this.retourEnteteAchats.getBrfDate());
         this.documentTraceAchats.setDoctrfDstType(this.var_type_trf);
         this.documentTraceAchats.setDoctrfDstSerie(var3.getAvfSerie());
         ...
         var3.setAvfDateTransforme(new Date());
         var3.setAvfTypeTransforme(this.var_type_trf);
         var4.modif(var3, var1);
         if (var37 <= var10 + var11 && var37 != 0.0F && var10 + var11 != 0.0F) {
            this.retourEnteteAchats.setBrfEtat(5);
         } else {
            this.retourEnteteAchats.setBrfEtat(4);
         }

         this.retourEnteteAchats.setBrfNumAvoir(var3.getAvfNum());
         this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var1);
         var2.commit();
   ...
   public String formule1() throws HibernateException, NamingException {
      String var1 = null;
      if (this.retourEnteteAchats.getBrfFormule1() != null && !this.retourEnteteAchats.getBrfFormule1().isEmpty()) {
         FormulesAchatsDao var2 = new FormulesAchatsDao(this.baseLog, this.utilInitHibernate);
         var1 = var2.selectFormulesAchats(this.retourEnteteAchats.getBrfFormule1(), (Session)null);
      }
   ...
   public String conversionAnnexe1() throws HibernateException, NamingException {
      String var1 = null;
      if (this.retourEnteteAchats.getBrfAnnexe1() != null && !this.retourEnteteAchats.getBrfAnnexe1().isEmpty() && this.retourEnteteAchats.getBrfAnnexe1().contains(":")) {
         String[] var2 = this.retourEnteteAchats.getBrfAnnexe1().split(":");
         ...
         if (var3 != null) {
            if (var3.getModTexte().contains("[")) {
               var1 = this.utilTdt.analyseTexteCommercial(var3.getModTexte(), this.retourEnteteAchats.getUsers(), this.structureLog, this.retourEnteteAchats.getTiers());
            } else {
   ...
   public String conversionAnnexe2() throws HibernateException, NamingException {
      String var1 = null;
      if (this.retourEnteteAchats.getBrfAnnexe2() != null && !this.retourEnteteAchats.getBrfAnnexe2().isEmpty() && this.retourEnteteAchats.getBrfAnnexe2().contains(":")) {
         String[] var2 = this.retourEnteteAchats.getBrfAnnexe2().split(":");
         new ModelesCourriers();
         ModelesCourriersDao var4 = new ModelesCourriersDao(this.baseLog, this.utilInitHibernate);
         ModelesCourriers var3 = var4.rechercheModeles(var2[0], (Session)null);
         if (var3 != null) {
   ...
   public JRBeanCollectionDataSource calculeImpressionCommun(Session var1) throws IOException, HibernateException, NamingException {
      ...
      if (this.lesLignesList.size() != 0) {
         if (var1 == null) {
            var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourLigne");
            ...
            try {
               ...
               for(int var4 = 0; var4 < this.lesLignesList.size(); ++var4) {
                  this.retourLigneAchats = (RetourLigneAchats)this.lesLignesList.get(var4);
                  if (this.retourLigneAchats.getBrfligCode() != null && !this.retourLigneAchats.getBrfligCode().isEmpty()) {
                     this.produits = this.produitsDao.chargeProduit(this.retourLigneAchats.getBrfligCode(), var1);
                     if (this.produits != null) {
                        this.produitsFournisseur = this.produitsFournisseurDao.selectProdFourByprodFic(this.produits, this.tiers, var1);
                  ...
                  var2.add(this.retourLigneAchats);
               }
            ...
            for(int var10 = 0; var10 < this.lesLignesList.size(); ++var10) {
               this.retourLigneAchats = (RetourLigneAchats)this.lesLignesList.get(var10);
               if (this.retourLigneAchats.getBrfligCode() != null && !this.retourLigneAchats.getBrfligCode().isEmpty()) {
                  this.produits = this.produitsDao.chargeProduit(this.retourLigneAchats.getBrfligCode(), var1);
                  if (this.produits != null) {
                     this.produitsFournisseur = this.produitsFournisseurDao.selectProdFourByprodFic(this.produits, this.tiers, var1);
      ...
      this.montant_lettre = this.utilNombre.begin(this.retourEnteteAchats.getBrfTotTtc() + this.retourEnteteAchats.getBrfTotTc(), this.retourEnteteAchats.getBrfDevise());
   ...
   public String calculeParc(Session var1) throws HibernateException, NamingException {
      ...
      new Parc();
      Parc var3;
      if (this.retourEnteteAchats.getBrfAnal2() != null && !this.retourEnteteAchats.getBrfAnal2().isEmpty()) {
         String var4 = "";
         if (this.retourEnteteAchats.getBrfAnal2().contains(":")) {
            String[] var5 = this.retourEnteteAchats.getBrfAnal2().split(":");
            var4 = var5[0];
         } else {
            var4 = this.retourEnteteAchats.getBrfAnal2();
         }
   ...
   public boolean majDateImpression(String var1) throws HibernateException, NamingException {
      boolean var2 = false;
      Session var3 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourLigne");
      Transaction var4 = null;

      try {
         var4 = var3.beginTransaction();
         if (this.retourEnteteAchats.getBrfDateImp() != null) {
            var2 = true;
         }

         boolean var5 = false;
         this.retourEnteteAchats.setBrfDateImp(new Date());
         if (this.retourEnteteAchats.getBrfEtat() == 0 && this.retourEnteteAchats.getBrfEtatVal() == 0 && this.usersChrono.getUsrchrValidation() == 1) {
            this.retourEnteteAchats.setBrfEtat(1);
            var5 = true;
         }

         this.retourEnteteAchats.setBrfModeleImp(var1);
         this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var3);
         if (this.retourEnteteAchats.getBrfAnal4() != null && !this.retourEnteteAchats.getBrfAnal4().isEmpty()) {
            new ValorisationEnteteAchats();
            ValorisationEnteteAchatsDao var7 = new ValorisationEnteteAchatsDao(this.baseLog, this.utilInitHibernate);
            ValorisationEnteteAchats var6 = var7.rechercheByDossier(this.retourEnteteAchats.getBrfAnal4(), var3);
            if (var6 != null) {
               this.retourEnteteAchats.setBrfValo(var6.getValNum());
               this.retourEnteteAchats = this.retourEnteteAchatsDao.modif(this.retourEnteteAchats, var3);
            }
         }

         if (var5) {
            this.calculStock.majRetourAchatsVAL(this.lesLignesList, 1, this.baseLog, var3);
            if (this.tiers.getTieDteDocument4() == null || this.retourEnteteAchats.getBrfDate().after(this.tiers.getTieDteDocument4())) {
               this.tiers.setTieDteDocument4(this.retourEnteteAchats.getBrfDate());
         ...
         if (this.retourEnteteAchats.getBrfIdContact() != 0L) {
            this.contacts = this.contactDao.chargerLesContactsById(this.retourEnteteAchats.getBrfIdContact(), var3);
         }
   ...
   public void impression(UtilPrint var1, int var2, String var3, String var4, String var5, String var6, String var7, String var8, String var9, String var10) throws HibernateException, NamingException, SQLException, JRException, IOException, ClassNotFoundException, MalformedURLException, Exception {
      if (var2 == 0) {
         if (var3 != null && !var3.isEmpty()) {
            ...
            var1.setImageFondPage(this.calculeImageFond(this.baseLog, this.retourEnteteAchats.getBrfEtat()));
            ...
            var1.setIdResponsable(this.retourEnteteAchats.getBrfIdResponsable());
            var1.setTiersSelectionne(this.retourEnteteAchats.getTiers());
            if (this.contacts == null) {
               this.contacts = new Contacts();
            }

            var1.setContact(this.contacts);
            var1.setNumDoc(this.retourEnteteAchats.getBrfNum());
            var1.setNature(this.nature);
            var1.setId_doc(this.retourEnteteAchats.getBrfId());
            if (this.retourEnteteAchats.getBrfAnal2() != null && !this.retourEnteteAchats.getBrfAnal2().isEmpty()) {
               String var12 = "";
               if (this.retourEnteteAchats.getBrfAnal2().contains(":")) {
                  String[] var13 = this.retourEnteteAchats.getBrfAnal2().split(":");
                  var12 = var13[0];
               } else {
                  var12 = this.retourEnteteAchats.getBrfAnal2();
               }
         ...
         var1.setCheminRapport(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + this.baseLog + File.separator + "impression" + File.separator + "fr" + File.separator + "achats" + File.separator + "liste" + File.separator + "retour" + File.separator);
   ...
   public List grapher() throws HibernateException, NamingException, ParseException {
      ...
      if (this.lesEntetesList.size() != 0) {
         ...
         new RetourEnteteAchats();
         RetourLigneAchats var15 = new RetourLigneAchats();
         Session var5 = this.utilInitHibernate.getOpenSession(this.baseLog, "RetourLigne");
         String var6 = "";

         RetourEnteteAchats var14;
         for(int var7 = 0; var7 < this.lesEntetesList.size(); ++var7) {
            var14 = (RetourEnteteAchats)this.lesEntetesList.get(var7);
            if (var6.isEmpty()) {
               var6 = "'" + var14.getBrfNum() + "'";
            } else {
               var6 = var6 + ",'" + var14.getBrfNum() + "'";
            }
         }
         ...
         if (this.valQteGraph != 1 && this.modeGraph != 5 && this.modeGraph != 6) {
            if (this.lesEntetesList.size() != 0) {
               ...
               while(true) {
                  ...
                  var14 = (RetourEnteteAchats)this.lesEntetesList.get(var19);
                  var17 = "";
                  var20 = 0L;
                  int var18 = 0;
                  if (this.modeGraph == 0) {
                     var12 = var14.getBrfDate().getYear() + 1900;
                     var17 = "" + var12;
                  } else if (this.modeGraph == 1) {
                     if (var14.getBrfNomResponsable() != null && !var14.getBrfNomResponsable().isEmpty()) {
                        var17 = var14.getBrfNomResponsable();
                     } else {
                        var17 = "Sans Responsable";
                     }
                  } else if (this.modeGraph == 4) {
                     if (var14.getBrfNomTiers() != null && !var14.getBrfNomTiers().isEmpty()) {
                        var17 = var14.getBrfNomTiers();
                     } else {
                        var17 = "Sans Tiers";
                     }
                  }

                  if (var15.getBrfligDevise().equals(this.structureLog.getStrdevise())) {
                     var20 = (long)var14.getBrfTotHt();
                  } else {
                     float var21 = this.utilNombre.deviseTaux1(var15.getRetourEnteteAchats().getBrfDevise(), var15.getRetourEnteteAchats().getBrfDate());
                     var20 = (long)(var14.getBrfTotHt() * (double)var21);
                  }

                  if (this.timeDecoupage == 0) {
                     var18 = var14.getBrfDate().getDate();
                  } else if (this.timeDecoupage == 1) {
                     var18 = var14.getBrfDate().getMonth() + 1;
                  } else if (this.timeDecoupage == 2) {
                     if (var14.getBrfDate().getMonth() + 1 >= 1 && var14.getBrfDate().getMonth() + 1 <= 3) {
                        var18 = 1;
                     } else if (var14.getBrfDate().getMonth() + 1 >= 4 && var14.getBrfDate().getMonth() + 1 <= 6) {
                        var18 = 2;
                     } else if (var14.getBrfDate().getMonth() + 1 >= 7 && var14.getBrfDate().getMonth() + 1 <= 9) {
                        var18 = 3;
                     } else if (var14.getBrfDate().getMonth() + 1 >= 10 && var14.getBrfDate().getMonth() + 1 <= 12) {
                        var18 = 4;
                     }
                  } else if (this.timeDecoupage == 3) {
                     if (var14.getBrfDate().getMonth() + 1 >= 1 && var14.getBrfDate().getMonth() + 1 <= 6) {
                        var18 = 1;
                     } else if (var14.getBrfDate().getMonth() + 1 >= 7 && var14.getBrfDate().getMonth() + 1 <= 12) {
                        var18 = 2;
                     }
                  } else if (this.timeDecoupage == 4) {
                     var18 = 1;
                  } else if (this.timeDecoupage == 5) {
                     var18 = var14.getBrfDate().getHours();
                  }
            ...
            new ArrayList();
            List var16 = this.retourLigneAchatsDao.chargerLesLignesRetours(var6, var5);
            if (var16.size() != 0) {
               String var8 = "";
               long var9 = 0L;
               boolean var11 = false;
               ...
               while(true) {
                  ...
                  var15 = (RetourLigneAchats)var16.get(var12);
                  var8 = "";
                  var9 = 0L;
                  var19 = 0;
                  if (this.modeGraph == 0) {
                     int var13 = var15.getRetourEnteteAchats().getBrfDate().getYear() + 1900;
                     var8 = "" + var13;
                  } else if (this.modeGraph == 1) {
                     if (var15.getRetourEnteteAchats().getBrfNomResponsable() != null && !var15.getRetourEnteteAchats().getBrfNomResponsable().isEmpty()) {
                        var8 = var15.getRetourEnteteAchats().getBrfNomResponsable();
                     } else {
                        var8 = "Sans responsable";
                     }
                  } else if (this.modeGraph == 4) {
                     if (var15.getRetourEnteteAchats().getBrfNomTiers() != null && !var15.getRetourEnteteAchats().getBrfNomTiers().isEmpty()) {
                        var8 = var15.getRetourEnteteAchats().getBrfNomTiers();
                     } else {
                        var8 = "Sans Tiers";
                     }
                  } else if (this.modeGraph == 5) {
                     if (var15.getBrfligFamille() != null && !var15.getBrfligFamille().isEmpty()) {
                        var8 = var15.getBrfligFamille();
                     } else {
                        var8 = "Sans Famille produit";
                     }
                  } else if (this.modeGraph == 6) {
                     if (var15.getBrfligLibelle() != null && !var15.getBrfligLibelle().isEmpty()) {
                        var8 = var15.getBrfligLibelle();
                     } else {
                  ...
                  if (this.valQteGraph == 0) {
                     if (var15.getBrfligDevise().equals(this.structureLog.getStrdevise())) {
                        var9 = (long)var15.getBrfligPt();
                     } else {
                        float var22 = this.utilNombre.deviseTaux1(var15.getRetourEnteteAchats().getBrfDevise(), var15.getRetourEnteteAchats().getBrfDate());
                        var9 = (long)(var15.getBrfligPt() * (double)var22);
                     }
                  } else {
                     var9 = (long)this.utilNombre.myRound(var15.getBrfligQte(), 1);
                  }

                  if (this.timeDecoupage == 0) {
                     var19 = var15.getRetourEnteteAchats().getBrfDate().getDate();
                  } else if (this.timeDecoupage == 1) {
                     var19 = var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1;
                  } else if (this.timeDecoupage == 2) {
                     if (var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 >= 1 && var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 <= 3) {
                        var19 = 1;
                     } else if (var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 >= 4 && var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 <= 6) {
                        var19 = 2;
                     } else if (var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 >= 7 && var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 <= 9) {
                        var19 = 3;
                     } else if (var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 >= 10 && var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 <= 12) {
                        var19 = 4;
                     }
                  } else if (this.timeDecoupage == 3) {
                     if (var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 >= 1 && var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 <= 6) {
                        var19 = 1;
                     } else if (var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 >= 7 && var15.getRetourEnteteAchats().getBrfDate().getMonth() + 1 <= 12) {
                        var19 = 2;
                     }
                  } else if (this.timeDecoupage == 4) {
                     var19 = 1;
                  } else if (this.timeDecoupage == 5) {
                     var19 = var15.getRetourEnteteAchats().getBrfDate().getHours();
                  }
   ...
   public RetourLigneAchats getRetourLigneAchats() {
      return this.retourLigneAchats;
   }

   public void setRetourLigneAchats(RetourLigneAchats var1) {
      this.retourLigneAchats = var1;
   }
