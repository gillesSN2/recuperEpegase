...
public class FormChronoAch implements Serializable {
   ...
   public void lesChronos(Session var1) throws HibernateException, NamingException {
      ...
      this.chronoTmp = this.chronoDao.selectListAchat(this.usersLog.getUsrJrxReserve(), var1);
      ...
      this.exercicesAchats = this.exercicesAchatsDao.recupererLastExo(var1);
   }
   ...
   public void saveChrono() throws HibernateException, NamingException {
      ...
      if (this.chrono.getChrMode() == 2) {
         ...
         this.chrono.setChrPeriode("" + this.exercicesAchats.getExeachId());
      }
   ...
   public List listChrono() throws IOException {
      ...
      var1.add(new SelectItem(10, "D.A."));
      var1.add(new SelectItem(11, "Cotation"));
      var1.add(new SelectItem(12, "Bon commande"));
      var1.add(new SelectItem(13, "Bon réception"));
      var1.add(new SelectItem(14, "Bon retour"));
      var1.add(new SelectItem(15, "Facture"));
      var1.add(new SelectItem(16, "Avoir"));
      var1.add(new SelectItem(17, "Note débit"));
      var1.add(new SelectItem(18, "Frais"));
      var1.add(new SelectItem(19, "Décaissement"));
      var1.add(new SelectItem(30, "Inventaire"));
      var1.add(new SelectItem(31, "Bon entrée"));
      var1.add(new SelectItem(32, "Bon sortie"));
      var1.add(new SelectItem(33, "Cession"));
      if (this.structureLog.getStrtypeentreprise().equals("2")) {
         var1.add(new SelectItem(34, "Production"));
      }

      var1.add(new SelectItem(35, "Valorisation"));
      return var1;
   }
