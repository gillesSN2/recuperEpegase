...
public class FormChronoVte implements Serializable {
   ...
   public List listChrono() throws IOException {
      boolean var1 = this.rechercheModule(80600);
      boolean var2 = this.rechercheModule(80500);
      ArrayList var3 = new ArrayList();
      if (this.structureLog.getStrid() == 20L) {
         var3.add(new SelectItem(8, "Simulation contrat"));
      }

      if (!var1 && !var2) {
         var3.add(new SelectItem(141, "Campagnes"));
         var3.add(new SelectItem(20, "Besoin"));
      }

      var3.add(new SelectItem(21, "Devis"));
      if (!var2) {
         var3.add(new SelectItem(22, "Bon commande"));
         var3.add(new SelectItem(23, "Bon livraison"));
         var3.add(new SelectItem(24, "Bon retour"));
      }

      var3.add(new SelectItem(25, "Facture"));
      var3.add(new SelectItem(26, "Avoir"));
      var3.add(new SelectItem(27, "Note débit"));
      if (this.structureLog.getStrmaitrecabinet() == 2 || this.structureLog.getStrmaitrecabinet() == 12) {
         var3.add(new SelectItem(142, "Facture interne"));
      }

      if (!var2) {
         if (var1) {
            var3.add(new SelectItem(143, "Manifeste"));
         } else {
            var3.add(new SelectItem(28, "Chargement"));
         }
      }

      var3.add(new SelectItem(29, "Bon d'encaissement"));
      var3.add(new SelectItem(7, "Commissions"));
      if (!var2) {
         var3.add(new SelectItem(140, "Contrats"));
      } else {
         var3.add(new SelectItem(140, "Missions/Contrats"));
      }
