...
public class FormExercicesMicrofinance implements Serializable {
   ...
   public FormExercicesMicrofinance() throws IOException, JDOMException {
   ...
   public void cloturer() throws JDOMException, IOException, HibernateException, NamingException, ParseException {
      if (this.exercicesVentes != null) {
         this.genererNvlExo();
         Session var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "SuiviMedical");
