...
public class FormChronoForet implements Serializable {
   ...
   public void lesChronos(Session var1) throws HibernateException, NamingException {
      ...
      this.chronoTmp = this.chronoDao.selectListEducation(this.usersLog.getUsrJrxReserve(), var1);
   ...
   public List listChrono() throws IOException {
      ...
      var1.add(new SelectItem(250, "Inventaire"));
      var1.add(new SelectItem(251, "Carnet"));
      var1.add(new SelectItem(252, "B. Rupture"));
      var1.add(new SelectItem(253, "B. route"));
      var1.add(new SelectItem(254, "B. expédition"));
      var1.add(new SelectItem(255, "Note crédit"));
      var1.add(new SelectItem(256, "Spécification"));
      var1.add(new SelectItem(257, "Taxe martelage"));
      var1.add(new SelectItem(258, "Redevance attribution"));
      var1.add(new SelectItem(259, "Relevé SNBG"));
      var1.add(new SelectItem(260, "Fermage et précompte"));
      return var1;
   }
