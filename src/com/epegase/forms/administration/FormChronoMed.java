...
public class FormChronoMed implements Serializable {
   ...
   public void lesChronos(Session var1) throws HibernateException, NamingException {
      ...
      this.chronoTmp = this.chronoDao.selectListMedical(this.usersLog.getUsrJrxReserve(), var1);
   ...
   public List listChrono() throws IOException {
      ...
      var1.add(new SelectItem(70, "Patient"));
      if (this.rechercheModule(81500)) {
         var1.add(new SelectItem(71, "Consultation Générale"));
      } else if (this.rechercheModule(81510)) {
         var1.add(new SelectItem(71, "Consultation Générale"));
         var1.add(new SelectItem(72, "Consultation Spécialisée"));
         var1.add(new SelectItem(78, "Refacturation"));
      } else if (this.rechercheModule(81520)) {
         var1.add(new SelectItem(74, "Laboratoire"));
         var1.add(new SelectItem(78, "Refacturation"));
      } else if (this.rechercheModule(81530)) {
         var1.add(new SelectItem(73, "Pharmacie"));
         var1.add(new SelectItem(78, "Refacturation"));
      } else if (this.rechercheModule(81540)) {
         var1.add(new SelectItem(71, "Consultation Générale"));
         var1.add(new SelectItem(72, "Consultation Spécialisée"));
         var1.add(new SelectItem(74, "Laboratoire"));
         var1.add(new SelectItem(77, "Devis"));
         var1.add(new SelectItem(78, "Refacturation"));
         var1.add(new SelectItem(79, "Bon encaissement"));
      } else if (this.rechercheModule(81550)) {
         var1.add(new SelectItem(71, "Consultation Générale"));
         var1.add(new SelectItem(72, "Consultation Spécialisée"));
         var1.add(new SelectItem(74, "Laboratoire"));
         var1.add(new SelectItem(73, "Pharmacie"));
         var1.add(new SelectItem(77, "Devis"));
         var1.add(new SelectItem(76, "Hospitalisation"));
         var1.add(new SelectItem(78, "Refacturation"));
         var1.add(new SelectItem(75, "Lettre de garantie"));
         var1.add(new SelectItem(79, "Bon encaissement"));
      }
