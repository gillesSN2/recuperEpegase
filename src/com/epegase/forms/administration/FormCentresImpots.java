...
public class FormCentresImpots implements Serializable {
   ...
   public FormCentresImpots() throws IOException {
   }
   ...
   public void chargerLesCentresImpots() throws SAXException, IOException, HibernateException, NamingException {
      ...
      if (this.structureLog.getStrNumRetraiteMultiple() == 1) {
         ...
         this.listeCentreBd = this.centreImpotDao.chargerCentreImpot((Session)null);
      } else {
      ...
      this.listeCentresImpots = this.lectureCentresImpots.getMesCentresImpots();
   ...
   public void selectionLigne() throws HibernateException, NamingException {
      if (this.dataModel.isRowAvailable()) {
         ...
         this.centreImpot = this.centreImpotDao.rechercheEntreImpotByCode(this.objetCompte.getCode(), 0, (Session)null);
   ...
   public void validerCentre() throws HibernateException, NamingException {
      if (this.objetCompte != null) {
         ...
         try {
            ...
            this.centreImpot = this.centreImpotDao.rechercheEntreImpotByCode(this.objetCompte.getCode(), 0, var1);
            if (this.centreImpot == null) {
               ...
               this.centreImpot.setCenimpType(0);
