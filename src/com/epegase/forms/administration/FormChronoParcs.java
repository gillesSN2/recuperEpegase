...
public class FormChronoParcs implements Serializable {
   ...
   private ExercicesParc exercicesParc = new ExercicesParc();
   ...
   public void lesChronos(Session var1) throws HibernateException, NamingException {
      ...
      this.chronoTmp = this.chronoDao.selectListParc(this.usersLog.getUsrJrxReserve(), var1);
      ...
      this.exercicesParc = this.exercicesParcsDao.recupererLastExo(var1);
   }
   ...
   public void saveChrono() throws HibernateException, NamingException {
      ...
      if (this.chrono.getChrMode() == 2) {
         ...
         this.chrono.setChrPeriode("" + this.exercicesParc.getExeprcId());
      }
   ...
   public List listChrono() throws IOException {
      ...
      var1.add(new SelectItem(40, "Transports Personnels"));
      var1.add(new SelectItem(41, "Transports Matériel"));
      var1.add(new SelectItem(42, "Travaux publics"));
      var1.add(new SelectItem(43, "Locations"));
      var1.add(new SelectItem(44, "Localisations"));
      var1.add(new SelectItem(45, "Consommations"));
      var1.add(new SelectItem(46, "O.R."));
      var1.add(new SelectItem(47, "Manifest + LV"));
      return var1;
   }
