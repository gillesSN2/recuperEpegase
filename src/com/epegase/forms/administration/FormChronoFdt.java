...
public class FormChronoFdt implements Serializable {
   ...
   public void lesChronos(Session var1) throws HibernateException, NamingException {
      ...
      this.chronoTmp = this.chronoDao.selectListFondation(this.usersLog.getUsrJrxReserve(), var1);
   ...
   public List listChrono() throws IOException {
      ...
      var1.add(new SelectItem(220, "Demande"));
      return var1;
   }
