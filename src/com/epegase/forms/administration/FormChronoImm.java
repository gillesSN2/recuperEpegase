...
public class FormChronoImm implements Serializable {
   ...
   public void lesChronos(Session var1) throws HibernateException, NamingException {
      ...
      this.chronoTmp = this.chronoDao.selectListImmobilier(this.usersLog.getUsrJrxReserve(), var1);
   ...
   public List listChrono() throws IOException {
      ...
      var1.add(new SelectItem(160, "Commun : Biens"));
      var1.add(new SelectItem(163, "Commun: Travaux"));
      var1.add(new SelectItem(164, "Commun: Facture charges"));
      var1.add(new SelectItem(161, "Location: Contrat Gérance"));
      var1.add(new SelectItem(162, "Location: Bail Location"));
      var1.add(new SelectItem(165, "Location: Facturation location"));
      var1.add(new SelectItem(171, "Syndic: Contrat syndic"));
      var1.add(new SelectItem(172, "Syndic: Budget"));
      var1.add(new SelectItem(173, "Syndic: Appel de charges"));
      var1.add(new SelectItem(175, "Syndic: Préparation PV"));
      var1.add(new SelectItem(176, "Syndic: Décsion AG"));
      return var1;
   }
