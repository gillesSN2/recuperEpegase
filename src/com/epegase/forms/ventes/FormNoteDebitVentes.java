...
public class FormNoteDebitVentes implements Serializable {
   ...
   public FormNoteDebitVentes() throws IOException, SAXException, JDOMException {
   }
   ...
   public void chargeListeDetail(Session var1) throws HibernateException, NamingException, ParseException {
      ...
      if (this.inpEtat != 50) {
         ...
         new ArrayList();
         List var12 = this.noteDebitEnteteVentesDao.recherche(var1, this.exercicesVentes.getExevteId(), this.inpNum, this.inpNumBCC, this.inpNumAnal, this.inpIdTiersEnCours, this.inpClient, this.inpEtat, this.inpSerie, this.inpCat, this.periode, this.usersLog.getUsrid(), this.usersLog.getUsrVentes(), this.inpDestinataire, this.inpResponsable, this.inpCommercial, this.inpActivite, this.inpContener, var10, var11, this.inpRegion, this.inpSecteur, this.inpPdv, this.inpSite, this.inpDepartement, this.inpService);
         if (this.var_colonne1 != null && !this.var_colonne1.isEmpty() && this.var_colonne1.contains(":") || this.var_colonne2 != null && !this.var_colonne2.isEmpty() && this.var_colonne2.contains(":") || this.var_colonne3 != null && !this.var_colonne3.isEmpty() && this.var_colonne3.contains(":")) {
            ...
            for(int var17 = 0; var17 < var12.size(); ++var17) {
               NoteDebitEnteteVentes var16 = (NoteDebitEnteteVentes)var12.get(var17);
               if (var16.getNdbActivite() != null && !var16.getNdbActivite().isEmpty()) {
                  if (this.var_colonne1 != null && !this.var_colonne1.isEmpty() && this.var_colonne1.contains(":")) {
                     if (var16.getNdbActivite().contains(this.var_colonne1)) {
                        var19 = true;
                     } else {
                        var19 = false;
                     }
                  ...
                  if (this.var_colonne2 != null && !this.var_colonne2.isEmpty() && this.var_colonne2.contains(":")) {
                     if (var16.getNdbActivite().contains(this.var_colonne2)) {
                        var14 = true;
                     } else {
                        var14 = false;
                     }
                  ...
                  if (this.var_colonne3 != null && !this.var_colonne3.isEmpty() && this.var_colonne3.contains(":")) {
                     if (var16.getNdbActivite().contains(this.var_colonne3)) {
                        var15 = true;
                     } else {
                        var15 = false;
                     }
      ...
      if (this.lesEntetesList.size() > 0) {
         ...
         for(var13 = 0; var13 < this.lesEntetesList.size(); ++var13) {
            NoteDebitEnteteVentes var18 = (NoteDebitEnteteVentes)this.lesEntetesList.get(var13);
            var2 += var18.getNdbTotTtc();
            var4 += var18.getNdbTotReglement();
            var6 += var18.getNdbTotHt();
            var8 += var18.getNdbTotTva();
         }
         ...
         if (var1.size() != 0) {
            ...
            if (this.noteDebitEnteteVentes.getNdbTotReglement() != var4) {
               if (this.structureLog.getStrid() != 42L && this.structureLog.getStrid() != 43L && this.structureLog.getStrid() != 44L && this.structureLog.getStrid() != 45L) {
                  ...
                  if (Math.abs(var4) >= Math.abs(this.noteDebitEnteteVentes.getNdbTotTtc() + this.noteDebitEnteteVentes.getNdbTotTc())) {
   ...
   public void chargerAffaires(Session var1) throws HibernateException, NamingException {
      ...
      if (this.noteDebitEnteteVentes != null && this.noteDebitEnteteVentes.getNdbEtat() != 0) {
         this.mesAffairesItems.add(new SelectItem(this.noteDebitEnteteVentes.getNdbAnal4(), this.noteDebitEnteteVentes.getNdbAnal4()));
      } else {
   ...
   public void chargerDetailanalytique() {
      ...
      this.lesDecoupagesActivites.clear();
      if (this.decoupageActivite && this.noteDebitEnteteVentes.getNdbActivite() != null && !this.noteDebitEnteteVentes.getNdbActivite().isEmpty() && this.noteDebitEnteteVentes.getNdbActivite().contains(":")) {
         String[] var1 = null;
         if (!this.noteDebitEnteteVentes.getNdbActivite().contains("#")) {
            ...
            String[] var2 = this.noteDebitEnteteVentes.getNdbActivite().split("#");
   ...
   public void calculPourcentage() {
      if (this.ecrituresAnalytiqueCtrl != null && this.ecrituresAnalytiqueCtrl.getEcranaPourcentage() != 0.0F) {
         double var1 = this.utilNombre.myRoundDevise(this.noteDebitEnteteVentes.getNdbTotHt() * (double)this.ecrituresAnalytiqueCtrl.getEcranaPourcentage() / 100.0D, this.structureLog.getStrdevise());
   ...
   public void controleEcartAnalytique() {
      ...
      this.soldeImputation = this.noteDebitEnteteVentes.getNdbTotHt() - this.totalImputation;
   ...
   public void ajoutDocument() throws IOException, JDOMException, HibernateException, NamingException {
      ...
      if (this.optionsVentes.getResponsable().equals("0")) {
         ...
         this.mesCommercialItem.clear();
         this.noteDebitEnteteVentes.setNdbIdCommercial(this.usersLog.getUsrid());
         this.noteDebitEnteteVentes.setNdbNomCommercial(this.usersLog.getUsrPatronyme());
      ...
      if (this.noteDebitEnteteVentes.getNdbId() >= 0L) {
         ...
         try {
            ...
            if (!this.noteDebitEnteteVentes.getNdbSerie().equalsIgnoreCase("X") && !this.noteDebitEnteteVentes.getNdbSerie().isEmpty()) {
               ...
               long var3 = this.noteDebitEnteteVentesDao.selectLastNum(var1);
               this.noteDebitEnteteVentes.setNdbNum("" + var3);
            }
   ...
   public void save() throws IOException, HibernateException, NamingException, Exception {
      ...
      try {
            ...
            if (this.noteDebitEnteteVentes.getNdbDiversTiers() == 99) {
               ...
               if (var3 != null) {
                  ...
                  if (var3.getConpatronyme() != null && !var3.getConpatronyme().isEmpty()) {
                     ...
                     this.noteDebitEnteteVentes.setNdbNomContact(var3.getConservice());
                     this.noteDebitEnteteVentes.setNdbCivilContact("SERVICE/SITE:");
                  } else {
                     this.noteDebitEnteteVentes.setNdbIdContact(0L);
                     this.noteDebitEnteteVentes.setNdbNomContact("");
                     this.noteDebitEnteteVentes.setNdbCivilContact("");
         ...
         if (this.optionsVentes.getResponsable().equals("1") || this.optionsVentes.getResponsable().equals("2")) {
            ...
            if (var4 != null) {
               this.noteDebitEnteteVentes.setNdbIdCommercial(var4.getUsrid());
               this.noteDebitEnteteVentes.setNdbNomCommercial(var4.getUsrPatronyme());
            }
         }
         ...
         if (this.optionsVentes.getResponsable().equals("1")) {
            this.equipes = this.equipesDao.rechercheEquipes(this.noteDebitEnteteVentes.getNdbIdResponsable(), var1);
            if (this.equipes != null) {
               this.noteDebitEnteteVentes.setNdbIdEquipe(this.equipes.getEquId());
               this.noteDebitEnteteVentes.setNdbNomEquipe(this.equipes.getEquNomFr());
            }
         }
         ...
         if (this.var_timbre != 0) {
            ...
            double var5 = this.utilNombre.calculTimbre(this.structureLog, this.noteDebitEnteteVentes.getNdbTotTtc() + this.noteDebitEnteteVentes.getNdbTotTc(), var16, this.noteDebitEnteteVentes.getNdbDevise(), this.noteDebitEnteteVentes.getNdbDate());
            ...
            if (var7 != 0.0D) {
               ...
               this.noteDebitEnteteVentes.setNdbFormule2(this.utilNombre.texteTimbre(this.structureLog, var9, var16, this.noteDebitEnteteVentes.getNdbDevise(), this.noteDebitEnteteVentes.getNdbDate()));
            }
         }
         ...
         if (this.noteDebitEnteteVentes.getNdbId() != 0L) {
            if (this.noteDebitEnteteVentes.getNdbEtat() == 6) {
               if (this.noteDebitEnteteVentes.getNdbEtatVal() == 1) {
                  this.noteDebitEnteteVentes.setNdbEtat(0);
               } else {
                  this.noteDebitEnteteVentes.setNdbEtat(0);
               }
            ...
            for(var16 = 0; var16 < this.lesLignesList.size(); ++var16) {
               this.noteDebitLigneVentes = (NoteDebitLigneVentes)this.lesLignesList.get(var16);
               this.noteDebitLigneVentes.setNdbligOrdre(var16);
            ...
            if (this.noteDebitEnteteVentes.getNdbSerie() != null && !this.noteDebitEnteteVentes.getNdbSerie().equalsIgnoreCase("X") && !this.noteDebitEnteteVentes.getNdbSerie().isEmpty()) {
               ...
               while(true) {
                  while(true) {
                     ...
                     new NoteDebitEnteteVentes();
                     NoteDebitEnteteVentes var19 = this.noteDebitEnteteVentesDao.pourParapheurByNum(this.noteDebitEnteteVentes.getNdbNum(), this.noteDebitEnteteVentes.getNdbSerie(), var1);
                     if (var19 != null) {
               ...
               long var17 = this.noteDebitEnteteVentesDao.selectLastNum(var1);
               this.noteDebitEnteteVentes.setNdbNum("" + var17);
            }
   ...
   public void majAnalytique(Session var1) throws HibernateException, NamingException {
      ...
      if (!this.var_anal_activite) {
         ...
         if (this.optionsVentes.getActiviteEnteteLigne().equals("0")) {
            if (this.decoupageActivite) {
               ...
               this.noteDebitEnteteVentes.setNdbActivite(var2);
            }
         } else {
            var2 = "";
            var3 = true;
            ...
            if ((this.decoupageActivite || !this.decoupageActivite) && this.lesLignesList.size() != 0) {
               ...
               while(true) {
                  ...
                  NoteDebitLigneVentes var13 = (NoteDebitLigneVentes)this.lesLignesList.get(var8);
                  if (var13.getNdbligCode() != null && !var13.getNdbligCode().isEmpty()) {
                     Produits var5 = this.produitsDao.chargeProduit(var13.getNdbligCode(), var1);
                     if (var5 != null && var5.getProActivite() != null && !var5.getProActivite().isEmpty()) {
                        if (var6.size() == 0) {
                           var7 = new ObjetTarif();
                           var7.setNomLibelle(var5.getProActivite());
                           var7.setPrix(var13.getNdbligPt());
                           var6.add(var7);
                        } else {
                           boolean var9 = false;
                           double var10 = 0.0D;
                           ...
                           if (!var9) {
                              ...
                              var7.setPrix(var10 + var13.getNdbligPt());
                              var6.remove(var7);
                              var6.add(var7);
                           }
                        }
      ...
      } else if ((this.var_anal_dossier || this.accesAffaires) && this.noteDebitEnteteVentes.getNdbAnal4() != null && this.noteDebitEnteteVentes.getNdbAnal4().length() <= 2) {
         this.noteDebitEnteteVentes.setNdbAnal4("");
      }

      if (!this.var_anal_parc) {
         this.noteDebitEnteteVentes.setNdbAnal2("");
      } else if (this.noteDebitEnteteVentes.getNdbAnal2() != null && this.noteDebitEnteteVentes.getNdbAnal2().length() <= 2) {
         this.noteDebitEnteteVentes.setNdbAnal2("");
      }
   ...
   public void calculHt(String var1, float var2, Session var3) throws HibernateException, NamingException {
      ...
      double var35 = this.noteDebitLigneVentes.getNdbligPu();
      float var10;
      if (var7 == 3) {
         var10 = 100.0F - var5;
         var35 = this.utilNombre.myRoundDevise(var35 / (double)var10 * 100.0D, this.noteDebitEnteteVentes.getNdbDevise());
      }

      var10 = this.noteDebitLigneVentes.getNdbligQte();
      if (this.noteDebitLigneVentes.getNdbligQte() != 0.0F) {
         if (this.optionsVentes.getModeCalculDevis().equals("1")) {
            ...
            var10 = this.noteDebitLigneVentes.getNdbligQte() * this.noteDebitLigneVentes.getNdbligLong();
         } else {
      ...
      if (this.optionsVentes.getDecrmtRabais().equals("1")) {
         var15 = this.noteDebitLigneVentes.getNdbligRabais();
      } else if (this.optionsVentes.getDecrmtRabais().equals("2")) {
         var15 = this.noteDebitLigneVentes.getNdbligRabais() * (double)this.noteDebitLigneVentes.getNdbligQte();
      }

      if (this.noteDebitLigneVentes.getNdbligTauxRemise() != 0.0F) {
         var13 = var11 - var11 * (double)this.noteDebitLigneVentes.getNdbligTauxRemise() / 100.0D - var15;
      } else {
         var13 = var11 - var15;
      }

      double var17 = this.utilNombre.myRoundFormat(var13, this.var_format_devise);
      double var19 = var17 * (double)this.noteDebitLigneVentes.getNdbligTauxTaxe() / 100.0D;
      if (var7 == 2) {
         var19 *= -1.0D;
      } else if (var7 == 3) {
         var19 = var17 * (double)(this.noteDebitLigneVentes.getNdbligTauxTaxe() / 100.0F);
         var19 *= -1.0D;
      }
      ...
      if (this.noteDebitLigneVentes.getNdbligCondition() != null && !this.noteDebitLigneVentes.getNdbligCondition().isEmpty() && this.noteDebitLigneVentes.getNdbligCondition().contains(":")) {
         if (this.optionsVentes.getModeCalculDevis().equals("1")) {
            var25 = this.utilNombre.myRound(var17 / (double)this.noteDebitLigneVentes.getNdbligQteUtil(), 2);
         } else {
            var25 = this.utilNombre.myRound(var17 / (double)this.noteDebitLigneVentes.getNdbligQte(), 2);
         }
      ...
      this.noteDebitLigneVentes.setNdbligPuRem(var25);
      this.noteDebitLigneVentes.setNdbligPt(var17);
      this.noteDebitLigneVentes.setNdbligTva(var21);
      this.noteDebitLigneVentes.setNdbligTc(0.0D);
      this.noteDebitLigneVentes.setNdbligTtc(var23);
      double var27 = 0.0D;
      if (this.noteDebitLigneVentes.getNdbligCondition() != null && !this.noteDebitLigneVentes.getNdbligCondition().isEmpty() && this.noteDebitLigneVentes.getNdbligCondition().contains(":")) {
         if (this.optionsVentes.getModeCalculDevis().equals("1")) {
            var27 = this.utilNombre.myRound(var23 / (double)this.noteDebitLigneVentes.getNdbligQteUtil(), 2);
         } else {
            var27 = this.utilNombre.myRound(var23 / (double)this.noteDebitLigneVentes.getNdbligQte(), 2);
         }
      } else if (this.optionsVentes.getModeCalculDevis().equals("1")) {
         var27 = this.utilNombre.myRound(var23 / (double)this.noteDebitLigneVentes.getNdbligQteUtil(), 2);
      } else {
      ...
      this.noteDebitLigneVentes.setNdbligPuRemTtc(var27);
      double var29 = var35 + var35 * (double)this.noteDebitLigneVentes.getNdbligTauxTaxe() / 100.0D;
      this.noteDebitLigneVentes.setNdbligPuTtc(var29);
      if (this.var_tc_type != 0 && this.var_tc_taux != 0.0F && this.var_tc_calcul) {
         this.noteDebitEnteteVentes.setNdbTauxTc(this.var_tc_taux);
         double var31 = 0.0D;
         double var33 = 0.0D;
         if (this.var_tc_type == 6) {
            var31 = var23 * (double)this.noteDebitEnteteVentes.getNdbTauxTc() / 100.0D;
            var33 = this.utilNombre.myRoundFormat(var31, this.var_format_devise);
            this.noteDebitLigneVentes.setNdbligTc(var33);
         } else if (this.var_tc_type != 1 && this.var_tc_type != 2 && this.var_tc_type != 7) {
            if (this.var_tc_type == 10) {
               var31 = var17 * (double)this.noteDebitEnteteVentes.getNdbTauxTc() / 100.0D;
               if (this.noteDebitLigneVentes.getNdbligTauxTaxe() != 0.0F) {
                  var31 = var17 * (double)this.noteDebitEnteteVentes.getNdbTauxTc() / 100.0D;
                  var33 = this.utilNombre.myRoundFormat(var31, this.var_format_devise);
                  double var10000 = var31 + var31 * (double)this.noteDebitLigneVentes.getNdbligTauxTaxe() / 100.0D;
                  this.noteDebitLigneVentes.setNdbligTc(var33);
               }
            }
         } else {
            if (this.noteDebitLigneVentes.getNdbligTva() != 0.0D) {
               var31 = var17 * (double)this.noteDebitEnteteVentes.getNdbTauxTc() / 100.0D;
            } else {
               var31 = 0.0D;
            }
         ...
         this.noteDebitLigneVentes.setNdbligTc(0.0D);
         this.noteDebitEnteteVentes.setNdbTauxTc(0.0F);
      }
   ...
   public void calculTtc(String var1, float var2, Session var3) throws HibernateException, NamingException {
      ...
      double var10;
      double var12;
      if (this.noteDebitEnteteVentes.getNdbTauxTc() != 0.0F && this.noteDebitLigneVentes.getNdbligTva() != 0.0D) {
         var10 = this.noteDebitLigneVentes.getNdbligTtc();
         var12 = var10 * (double)this.noteDebitEnteteVentes.getNdbTauxTc() / 100.0D;
         var39 = this.utilNombre.myRound((var10 - var12) / (double)this.noteDebitLigneVentes.getNdbligQte(), Integer.parseInt(this.optionsVentes.getNbDecPu()));
      } else {
         var39 = this.noteDebitLigneVentes.getNdbligPuTtc();
      }

      var10 = var39 / (double)(1.0F + var5 / 100.0F);
      this.noteDebitLigneVentes.setNdbligPu(this.utilNombre.myRound(var10, Integer.parseInt(this.optionsVentes.getNbDecPu())));
      var12 = 0.0D;
      if (this.optionsVentes.getDecrmtRabais().equals("1")) {
         var12 = this.noteDebitLigneVentes.getNdbligRabais();
      } else if (this.optionsVentes.getDecrmtRabais().equals("2")) {
         var12 = this.noteDebitLigneVentes.getNdbligRabais() * (double)this.noteDebitLigneVentes.getNdbligQte();
      }
      ...
      double var16 = 0.0D;
      if (this.noteDebitLigneVentes.getNdbligTauxRemise() != 0.0F) {
         var16 = var39 - var39 * (double)this.noteDebitLigneVentes.getNdbligTauxRemise() / 100.0D - var12;
      } else {
         var16 = var39 - var12;
      }
         ...
         if (this.var_tc_type == 6) {
            ...
            if (this.var_tc_type == 10) {
               ...
               if (this.noteDebitLigneVentes.getNdbligTauxTaxe() != 0.0F) {
                  var34 = var24 * (double)this.noteDebitEnteteVentes.getNdbTauxTc() / 100.0D;
                  var36 = this.utilNombre.myRoundFormat(var34, this.var_format_devise);
                  double var10000 = var34 + var34 * (double)this.noteDebitLigneVentes.getNdbligTauxTaxe() / 100.0D;
                  this.noteDebitLigneVentes.setNdbligTc(var36);
               }
            }
         } else {
   ...
   public void calculPrix() throws HibernateException, NamingException {
      ...
      if (this.plafondEnCours != 0.0D) {
         ...
         for(int var3 = 0; var3 < this.lesLignesList.size(); ++var3) {
            var1 += ((NoteDebitLigneVentes)this.lesLignesList.get(var3)).getNdbligTtc();
         }
         ...
         if (this.soldeEnCours + var1 <= this.plafondEnCours) {
            ...
            if (this.noteDebitLigneVentes != null) {
               this.noteDebitLigneVentes.setNdbligQte(0.0F);
               this.calculPrix();
               this.cumulPrix();
            }
         }
      ...
      if (this.datamodelLigne.isRowAvailable()) {
         ...
         if (this.noteDebitLigneVentes.getNdbligCode() != null && this.noteDebitLigneVentes.getNdbligCode().length() >= 2) {
            ...
            if (this.produits != null) {
               ...
               this.noteDebitLigneVentes.setNdbligLong(this.produits.getProLongueur());
               this.noteDebitLigneVentes.setNdbligLarg(this.produits.getProLargeur());
               this.noteDebitLigneVentes.setNdbligHaut(this.produits.getProEpaisseur());
               this.noteDebitLigneVentes.setNdbligDiam(this.produits.getProDiamExt());
               ...
               this.noteDebitLigneVentes.setNdbligVolume(this.produits.getProVolume());
               this.noteDebitLigneVentes.setNdbligNb(this.produits.getProNbUnite());
      ...
      if (this.noteDebitLigneVentes != null) {
         ...
         try {
            ...
            for(int var3 = 0; var3 < this.lesLignesList.size(); ++var3) {
               ...
               this.noteDebitLigneVentes.setNdbligOrdre(var3);
               this.noteDebitLigneVentes = this.noteDebitLigneVentesDao.modifLigne(this.noteDebitLigneVentes, var1);
            }
   ...
   public void saveOneLigne() throws IOException, HibernateException, NamingException, Exception {
      if (this.noteDebitLigneVentes.getNdbligCode() != null && !this.noteDebitLigneVentes.getNdbligCode().isEmpty() || this.noteDebitLigneVentes.getNdbligLibelle() != null && !this.noteDebitLigneVentes.getNdbligLibelle().isEmpty() || this.noteDebitLigneVentes.getNdbligComplement() != null && !this.noteDebitLigneVentes.getNdbligComplement().isEmpty()) {
         if (this.noteDebitEnteteVentes.getNdbId() == 0L) {
            this.save();
         }
   ...
   public void calculeTiers() throws JDOMException, IOException, HibernateException, NamingException, ParseException {
      if (this.tiers != null) {
         ...
         if (!var2) {
            ...
            this.noteDebitEnteteVentes.setNdbExoTva(var9);
   ...
   public void calculMessageLitige(Session var1) throws HibernateException, NamingException {
      ...
      if (this.tiers != null) {
         ...
         if (this.tiers.getTieplafond() != 0.0D) {
            if (this.optionsVentes.getGestionPlafondNdb().equals("1")) {
               this.plafondEnCours = this.tiers.getTieplafond();
               new ArrayList();
               String var5 = " tiers.tieid=" + this.tiers.getTieid() + " and ndb_solde=0";
               double var6 = 0.0D;
   ...
   public void recupererEltCat() throws HibernateException, NamingException {
      ...
      if (this.lesFamilleClientsListe.size() != 0) {
         for(int var3 = 0; var3 < this.lesFamilleClientsListe.size(); ++var3) {
            if (this.noteDebitEnteteVentes.getNdbCat().equalsIgnoreCase(((ObjetFamilleTiers)this.lesFamilleClientsListe.get(var3)).getLibelle())) {
            ...
            for(int var3 = 0; var3 < this.lesLignesList.size(); ++var3) {
               ...
               if (this.noteDebitEnteteVentes.getNdbExoTva() == 1) {
                  ...
                  if (var4 != null) {
                     ...
                     if (var5 != null) {
                        this.noteDebitLigneVentes.setNdbligTaxe(this.optionsVentes.getTvaDefaut());
                        this.noteDebitLigneVentes.setNdbligTauxTaxe(var5.getTaxvteTaux());
                     } else {
                        this.noteDebitLigneVentes.setNdbligTaxe("");
                        this.noteDebitLigneVentes.setNdbligTauxTaxe(0.0F);
                  ...
                  if ((this.noteDebitLigneVentes.getNdbligTaxe() == null || this.noteDebitLigneVentes.getNdbligTaxe().isEmpty()) && this.optionsVentes.getTvaDefaut() != null && !this.optionsVentes.getTvaDefaut().isEmpty()) {
                     new TaxesVentes();
   ...
   public void rechercheProduits() throws JDOMException, IOException, HibernateException, NamingException {
      if (this.noteDebitLigneVentes.getNdbligCode() != null && !this.noteDebitLigneVentes.getNdbligCode().isEmpty() && !this.noteDebitLigneVentes.getNdbligCode().equals("-") && !this.noteDebitLigneVentes.getNdbligCode().equals("=")) {
         this.produits = this.formRecherche.rechercheProduitVenteHorsGenerique(this.noteDebitLigneVentes.getNdbligCode(), this.nature, this.optionsVentes);
         if (this.produits != null) {
      ...
      if (this.produits != null) {
         ...
         if (this.optionsVentes.getLibProduit().equals("2") && this.produits.getProLibTech() != null && !this.produits.getProLibTech().isEmpty()) {
            if (this.optionsVentes.getLibelleProduit().equals("0")) {
               this.noteDebitLigneVentes.setNdbligLibelle(this.produits.getProLibTech().toUpperCase());
               ...
               this.noteDebitLigneVentes.setNdbligLibelle(var2 + var3);
            } else if (this.optionsVentes.getLibelleProduit().equals("2")) {
               this.noteDebitLigneVentes.setNdbligLibelle(this.produits.getProLibTech().toLowerCase());
            }
            ...
            this.noteDebitLigneVentes.setNdbligLibelle(this.produits.getProLibClient().toLowerCase());
         }
         ...
         if (!this.produits.isProExoTva() && (this.tiers.getTiepProdExoTva() == null || this.tiers.getTiepProdExoTva().isEmpty() || !this.tiers.getTiepProdExoTva().contains(this.produits.getProCode()))) {
            ...
            if (this.produits.getProVteTva() != null && !this.produits.getProVteTva().isEmpty() && !this.produits.getProVteTva().equals("0")) {
               ...
               if (var9 != null) {
                  ...
                  this.noteDebitLigneVentes.setNdbligTauxTaxe(var9.getTaxvteTaux());
               } else {
                  this.noteDebitLigneVentes.setNdbligTaxe("");
                  this.noteDebitLigneVentes.setNdbligTauxTaxe(0.0F);
                  this.mesTaxesVentesProduits.add(new SelectItem(0, ""));
               ...
               if (var9 != null) {
                  ...
                  this.noteDebitLigneVentes.setNdbligTaxe(var8.getFamvteTaxe());
                  this.noteDebitLigneVentes.setNdbligTauxTaxe(var9.getTaxvteTaux());
               }
            } else {
               this.noteDebitLigneVentes.setNdbligTaxe("");
            ...
            if (this.noteDebitEnteteVentes.getNdbExoTva() == 0 && (this.noteDebitLigneVentes.getNdbligTaxe() == null || this.noteDebitLigneVentes.getNdbligTaxe().isEmpty()) && this.optionsVentes.getTvaDefaut() != null && !this.optionsVentes.getTvaDefaut().isEmpty()) {
               new TaxesVentes();
               ...
               if (var9 != null) {
                  ...
                  this.noteDebitLigneVentes.setNdbligTaxe(var9.getTaxvteCode());
                  this.noteDebitLigneVentes.setNdbligTauxTaxe(var9.getTaxvteTaux());
               }
            }
         } else {
   ...
   public void prixUnitaireCorrespond(Session var1) throws HibernateException, NamingException {
      if (this.produits != null) {
         double var2 = 0.0D;
         if (this.optionsVentes.getDecrmtPriVteStock().equals("2")) {
            var2 = this.noteDebitLigneVentes.getNdbligPuTtc();
         } else {
            var2 = this.noteDebitLigneVentes.getNdbligPu();
         }
         ...
         if (this.optionsVentes.getDecrmtPriVteStock().equals("2")) {
            ...
            this.noteDebitLigneVentes.setNdbligPuRemTtc(this.prixUnitaires);
         } else {
            this.noteDebitLigneVentes.setNdbligPu(this.prixUnitaires);
            this.noteDebitLigneVentes.setNdbligPuRem(this.prixUnitaires);
         }
            ...
            if (var8.size() != 0) {
               ...
               if (var7 != null && var7.getBarId() != 0L) {
                  ...
                  if (var6.getBarRemise() != 0.0F) {
                     this.noteDebitLigneVentes.setNdbligTauxRemise(var6.getBarRemise());
                     this.noteDebitLigneVentes.setNdbligRabais(var6.getBarRabais());
                     var11 = 0.0D;
                     var11 = this.prixUnitaires - this.utilNombre.myRoundDevise(this.prixUnitaires * (double)var6.getBarRemise() / 100.0D, this.noteDebitEnteteVentes.getNdbDevise());
                     if (this.optionsVentes.getDecrmtPriVteStock().equals("2")) {
                        this.noteDebitLigneVentes.setNdbligPuTtc(this.prixUnitaires);
                        this.noteDebitLigneVentes.setNdbligPuRemTtc(var11);
                     } else {
                        this.noteDebitLigneVentes.setNdbligPu(this.prixUnitaires);
                        this.noteDebitLigneVentes.setNdbligPuRem(var11);
                     }
                     ...
                     if (this.optionsVentes.getDecrmtRabais().equals("2")) {
                        var11 = this.prixUnitaires - var6.getBarRabais() * (double)this.noteDebitLigneVentes.getNdbligQte();
                     } else {
   ...
   public double prixCalculeAuto() {
      ...
      if (this.produits.getProFormule() != null && !this.produits.getProFormule().isEmpty() && this.produits.getProFormule().contains("=")) {
         ...
         if (var4 != null && !var4.isEmpty() && var4.equals("TAUX")) {
            ...
            for(int var9 = 0; var9 < this.lesLignesList.size() && (((NoteDebitLigneVentes)this.lesLignesList.get(var9)).getNdbligCode() == null || ((NoteDebitLigneVentes)this.lesLignesList.get(var9)).getNdbligCode().isEmpty() || !((NoteDebitLigneVentes)this.lesLignesList.get(var9)).getNdbligCode().equals(this.produits.getProCode())); ++var9) {
               var5 += ((NoteDebitLigneVentes)this.lesLignesList.get(var9)).getNdbligPt();
            }
            ...
            for(int var8 = 0; var8 < this.lesLignesList.size(); ++var8) {
               if (((NoteDebitLigneVentes)this.lesLignesList.get(var8)).getNdbligFamille() != null && !((NoteDebitLigneVentes)this.lesLignesList.get(var8)).getNdbligFamille().isEmpty() && ((NoteDebitLigneVentes)this.lesLignesList.get(var8)).getNdbligFamille().equals(var7)) {
                  var5 += ((NoteDebitLigneVentes)this.lesLignesList.get(var8)).getNdbligPt();
               }
            }
   ...
   public void prixUnitaireDegressif(Session var1) throws HibernateException, NamingException {
      if (this.produits != null) {
         double var2 = this.noteDebitLigneVentes.getNdbligPu();
         double var4 = this.noteDebitLigneVentes.getNdbligPuTtc();
   ...
   public void verifBonEncaissement() {
      if (Math.abs(this.montantElmTotBonEnc) <= Math.abs(this.noteDebitEnteteVentes.getNdbTotTtc() - this.var_tot_bon_encaissement)) {
   ...
   public void controleNumero() throws HibernateException, NamingException {
      if (this.var_imput_num != null && !this.var_imput_num.isEmpty()) {
         new NoteDebitEnteteVentes();
         NoteDebitEnteteVentes var1 = this.noteDebitEnteteVentesDao.pourParapheur(this.var_imput_num, (Session)null);
         if (var1 != null) {
            this.var_imput_num = "";
         }
      }
   ...
   public void miseajourImput() throws IOException, JDOMException, HibernateException, NamingException, ParseException {
      ...
      if (this.var_imput_choix == 0) {
         if (this.var_imput_num != null && !this.var_imput_num.isEmpty()) {
            ...
            try {
               var2 = var1.beginTransaction();
               var3 = this.noteDebitEnteteVentes.getNdbNum();
               this.noteDebitEnteteVentes.setNdbNum(this.var_imput_num);
               ...
               if (var4 != null) {
                  for(var22 = 0; var22 < var4.size(); ++var22) {
                     ...
                     var24.setPhrNum(this.noteDebitEnteteVentes.getNdbNum());
               ...
               var23.setEspaction("Imputation Note Débit N° " + var3 + " en Note Débit N° " + this.noteDebitEnteteVentes.getNdbNum());
         ...
         try {
            ...
            var23.setEsptype(0);
            var23.setEspdtecreat(new Date());
            var23.setEspaction("Imputation Note de débit X N° " + var3 + " en Note de débit " + this.noteDebitEnteteVentes.getNdbSerie() + " N° " + this.noteDebitEnteteVentes.getNdbNum());
            this.espionDao.mAJEspion(var23, var1);
            var2.commit();
   ...
   public void trfAvoir() throws HibernateException, NamingException, Exception {
      ...
      try {
         ...
         var3.setAvrAffaire(this.noteDebitEnteteVentes.getNdbAffaire());
         ...
         var3.setAvrNumClient(this.noteDebitEnteteVentes.getNdbNumClient());
         var3.setAvrDateClient(this.noteDebitEnteteVentes.getNdbDateClient());
         ...
         if (this.lesLignesList.size() != 0) {
            for(int var26 = 0; var26 < this.lesLignesList.size(); ++var26) {
               this.noteDebitLigneVentes = (NoteDebitLigneVentes)this.lesLignesList.get(var26);
               if (this.var_mode_trf != null && !this.var_mode_trf.isEmpty() && this.optionsVentes.getTransformation().equals("1")) {
                  if (this.var_mode_trf.equals("0")) {
                     if (var24 == null || var24.isEmpty() || !var24.equals(this.noteDebitLigneVentes.getNoteDebitEnteteVentes().getNdbNum())) {
                        var24 = this.noteDebitLigneVentes.getNoteDebitEnteteVentes().getNdbNum();
                        ++var25;
                        AvoirLigneVentes var39 = new AvoirLigneVentes();
                        var39.setAvrligCode("-");
                        var39.setAvrligLibelle("---> Suivant note de debit N° " + var24);
                     ...
                     while(true) {
                        if (var28 >= this.lesLignesList.size()) {
                           ...
                           var41.setAvrligCode("-");
                           var41.setAvrligLibelle("---> Suivant note de debit N° " + var27);
               ...
               if (this.noteDebitLigneVentes.getNdbligLibelle() != null && !this.noteDebitLigneVentes.getNdbligLibelle().isEmpty() && this.noteDebitLigneVentes.getVar_qteReliquat() != 0.0F) {
                  ...
                  float var40 = this.noteDebitLigneVentes.getNdbligQte();
                  float var42 = this.noteDebitLigneVentes.getNdbligQteUtil();
                  ++var25;
                  AvoirLigneVentes var29 = new AvoirLigneVentes();
                  var38 += ((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getNdbligQte();
                  var10 += ((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_qteDejaTrf();
                  if (((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_qteReliquat() != 0.0F) {
                     var29.setAvrligOrdre(var25);
                     var29.setAvrligCode(this.noteDebitLigneVentes.getNdbligCode());
                     var29.setAvrligGroupe(this.noteDebitLigneVentes.getNdbligGroupe());
                     var29.setAvrligModeGroupe(this.noteDebitLigneVentes.getNdbligModeGroupe());
                     var29.setAvrligDevise(this.noteDebitLigneVentes.getNdbligDevise());
                     var29.setAvrligFamille(this.noteDebitLigneVentes.getNdbligFamille());
                     var29.setAvrligIdNdb(this.noteDebitLigneVentes.getNdbligId());
                     var29.setAvrligLibelle(this.noteDebitLigneVentes.getNdbligLibelle());
                     var29.setAvrligComplement(this.noteDebitLigneVentes.getNdbligComplement());
                     if (((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_depotLigne() != null && !((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_depotLigne().isEmpty() && ((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_depotLigne().contains("=")) {
                        String[] var30 = ((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_depotLigne().split("=");
                        var29.setAvrligDepot(var30[0]);
                     } else {
                        var29.setAvrligDepot("");
                     }

                     var29.setAvrligEchelle(this.noteDebitLigneVentes.getNdbligEchelle());
                     var29.setAvrligUnite(this.noteDebitLigneVentes.getNdbligUnite());
                     var29.setAvrligReference(this.noteDebitLigneVentes.getNdbligReference());
                     var29.setAvrligPump(this.noteDebitLigneVentes.getNdbligPump());
                     var29.setAvrligPu(this.noteDebitLigneVentes.getNdbligPu());
                     var29.setAvrligPuTtc(this.noteDebitLigneVentes.getNdbligPuTtc());
                     var29.setAvrligTauxRemise(this.noteDebitLigneVentes.getNdbligTauxRemise());
                     var29.setAvrligPuRem(this.noteDebitLigneVentes.getNdbligPuRem());
                     var29.setAvrligPuRemTtc(this.noteDebitLigneVentes.getNdbligPuRemTtc());
                     this.noteDebitLigneVentes.setNdbligQte(((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_qteReliquat());
                     this.calculPrix(this.noteDebitLigneVentes.getNdbligTaxe(), this.noteDebitLigneVentes.getNdbligTauxTaxe(), var1);
                     var29.setAvrligQte(((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_qteReliquat());
                     var29.setAvrligLong(this.noteDebitLigneVentes.getNdbligLong());
                     var29.setAvrligLarg(this.noteDebitLigneVentes.getNdbligLarg());
                     var29.setAvrligHaut(this.noteDebitLigneVentes.getNdbligHaut());
                     var29.setAvrligDiam(this.noteDebitLigneVentes.getNdbligDiam());
                     var29.setAvrligPoidsBrut(this.noteDebitLigneVentes.getNdbligPoidsBrut());
                     var29.setAvrligPoidsNet(this.noteDebitLigneVentes.getNdbligPoidsNet());
                     var29.setAvrligVolume(this.noteDebitLigneVentes.getNdbligVolume());
                     var29.setAvrligNb(this.noteDebitLigneVentes.getNdbligNb());
                     var29.setAvrligQteStock(0.0F);
                     var29.setAvrligRabais(this.noteDebitLigneVentes.getNdbligRabais());
                     var29.setAvrligTauxTaxe(this.noteDebitLigneVentes.getNdbligTauxTaxe());
                     var29.setAvrligTaxe(this.noteDebitLigneVentes.getNdbligTaxe());
                     var29.setAvrligPt(this.noteDebitLigneVentes.getNdbligPt());
                     var29.setAvrligTva(this.noteDebitLigneVentes.getNdbligTva());
                     var29.setAvrligTtc(this.noteDebitLigneVentes.getNdbligTtc());
                     var29.setAvrligTc(this.noteDebitLigneVentes.getNdbligTc());
                     var29.setAvoirEnteteVentes(var3);
                     var11 += ((NoteDebitLigneVentes)this.lesLignesList.get(var26)).getVar_qteReliquat();
                     var6.add(var29);
                     ...
                     this.noteDebitLigneVentes.setNdbligQte(var40);
                     this.noteDebitLigneVentes.setNdbligQteUtil(var42);
                  }
               }
            }
         ...
         this.utilParapheur.majParapheur(this.var_type_trf, this.verifieExistenceHabilitationAvoir(var3, var1), var3.getAvrId(), var3.getAvrNum(), var3.getAvrNomTiers(), var3.getAvrDate(), this.noteDebitEnteteVentes.getNdbDevise(), var3.getAvrTotTtc() + var3.getAvrTotTc(), var3.getAvrModeleImp(), this.tiers, this.calculeCheminRapport(this.baseLog, 26), this.calculeCheminSousRapport(this.baseLog), this.calculeImpressionTRFAVR(var6, var3), this.calculeParc(var1), var3.getVar_format_devise(), 0, var1);
   ...
   public void miseajourPaye() throws HibernateException, NamingException {
      Session var1;
      if (Math.abs(this.var_tot_bon_encaissement) <= Math.abs(this.noteDebitEnteteVentes.getNdbTotTtc())) {
         var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "BnoteDebitEnteteLight");
         Transaction var2 = null;
         ...
         try {
            ...
            if (this.noteDebitEnteteVentes.getNdbTypeReg() == 5) {
               ...
               String var3 = this.calculChrono.numCompose(new Date(), 29, this.noteDebitEnteteVentes.getNdbSerie(), var1);
               if (var3 != null && !var3.isEmpty()) {
                  this.bonEncaissementVente = new BonEncaissementVente();
                  String[] var4;
                  if (this.var_inputCaisse != null && !this.var_inputCaisse.isEmpty() && this.var_inputCaisse.contains(":")) {
   ...
   public void calculValeurTimbre() {
      ...
      if (this.varTypeReg == 0) {
         ...
         for(var1 = 0; var1 < this.listFactureSelectionne.size(); ++var1) {
            new NoteDebitEnteteVentes();
            var9 = (NoteDebitEnteteVentes)this.listFactureSelectionne.get(var1);
      ...
      if (this.noteDebitEnteteVentes.getNdbTypeReg() == 4) {
         ...
         for(int var3 = 0; var3 < this.listFactureSelectionne.size(); ++var3) {
            new NoteDebitEnteteVentes();
            NoteDebitEnteteVentes var10 = (NoteDebitEnteteVentes)this.listFactureSelectionne.get(var3);
   ...
   public void generationReglement(String var1, double var2, double var4, NoteDebitEnteteVentes var6, ExercicesCaisse var7, Session var8) throws HibernateException, NamingException {
      this.reglements = new Reglements();
      if (Math.abs(var2) >= Math.abs(var6.getNdbTotTtc() + var6.getNdbTotTc() + var4)) {
      ...
      if (var6 != null) {
         ...
         if (Math.abs(var6.getNdbTotReglement()) >= Math.abs(var6.getNdbTotTtc() + var6.getNdbTotTc())) {
            var6.setNdbSolde(1);
         } else {
            var6.setNdbSolde(0);
         }
   ...
   public void supprimerReglement() throws HibernateException, NamingException {
      if (this.datamodelRecu.isRowAvailable()) {
         ...
         try {
            ...
            this.noteDebitEnteteVentes.setNdbTotReglement(var4);
            if (Math.abs(this.noteDebitEnteteVentes.getNdbTotReglement()) >= Math.abs(this.noteDebitEnteteVentes.getNdbTotTtc())) {
               this.noteDebitEnteteVentes.setNdbSolde(1);
            } else {
               this.noteDebitEnteteVentes.setNdbSolde(0);
            }
   ...
   public String formule1() throws HibernateException, NamingException {
      String var1 = null;
      if (this.noteDebitEnteteVentes.getNdbFormule1() != null && !this.noteDebitEnteteVentes.getNdbFormule1().isEmpty()) {
         FormulesVentesDao var2 = new FormulesVentesDao(this.baseLog, this.utilInitHibernate);
         var1 = var2.selectFormulesVentes(this.noteDebitEnteteVentes.getNdbFormule1(), (Session)null);
      }
   ...
   public String formule2() throws HibernateException, NamingException {
      String var1 = null;
      if (this.noteDebitEnteteVentes.getNdbFormule2() != null && !this.noteDebitEnteteVentes.getNdbFormule2().isEmpty()) {
         FormulesVentesDao var2 = new FormulesVentesDao(this.baseLog, this.utilInitHibernate);
         var1 = var2.selectFormulesVentes(this.noteDebitEnteteVentes.getNdbFormule2(), (Session)null);
      }
   ...
   public JRBeanCollectionDataSource calculeImpressionCommun() throws IOException, HibernateException, NamingException {
      ...
      if (this.lesLignesList.size() != 0) {
         ...
         for(int var10 = 0; var10 < this.lesLignesList.size(); ++var10) {
            ...
            if (this.noteDebitLigneVentes.getNdbligModeGroupe() != 2 || this.noteDebitLigneVentes.getNdbligGroupe() == null || this.noteDebitLigneVentes.getNdbligGroupe().isEmpty()) {
               ...
               if (this.noteDebitLigneVentes.getNdbligCode() != null && !this.noteDebitLigneVentes.getNdbligCode().isEmpty() && this.noteDebitLigneVentes.getNdbligCode().equals("=") && var2) {
                  ...
                  this.noteDebitLigneVentes.setNoteDebitEnteteVentes(this.noteDebitEnteteVentes);
                  this.noteDebitLigneVentes.setNdbligCode("=");
                  this.noteDebitLigneVentes.setNdbligOrdre(var10);
         ...
         if (this.structureLog.getStrid() == 245L) {
            this.noteDebitLigneVentes = new NoteDebitLigneVentes();
            this.noteDebitLigneVentes.setNoteDebitEnteteVentes(this.noteDebitEnteteVentes);
            this.noteDebitLigneVentes.setNdbligCode("FORMULE1");
            this.noteDebitLigneVentes.setNdbligOrdre(var1.size() + 2);
            this.noteDebitLigneVentes.setNdbligLibelle(this.formule1());
            this.noteDebitLigneVentes.setNdbligPt(0.0D);
            this.noteDebitLigneVentes.setNdbligTtc(0.0D);
            var1.add(this.noteDebitLigneVentes);
            this.noteDebitLigneVentes = new NoteDebitLigneVentes();
            this.noteDebitLigneVentes.setNoteDebitEnteteVentes(this.noteDebitEnteteVentes);
            this.noteDebitLigneVentes.setNdbligCode("FORMULE2");
            this.noteDebitLigneVentes.setNdbligOrdre(var1.size() + 2);
            this.noteDebitLigneVentes.setNdbligLibelle(this.formule2());
            this.noteDebitLigneVentes.setNdbligPt(0.0D);
            this.noteDebitLigneVentes.setNdbligTtc(0.0D);
            var1.add(this.noteDebitLigneVentes);
         }
      ...
      this.montant_lettre = this.utilNombre.begin(this.utilNombre.myRoundDevise(this.noteDebitEnteteVentes.getNdbTotTtc() + this.noteDebitEnteteVentes.getNdbTotTc(), this.noteDebitEnteteVentes.getNdbDevise()), this.noteDebitEnteteVentes.getNdbDevise());
   ...
   public void impression(UtilPrint var1, int var2, int var3, String var4, String var5, String var6, String var7, String var8, String var9, String var10, String var11) throws HibernateException, NamingException, SQLException, JRException, IOException, ClassNotFoundException, MalformedURLException, Exception {
      if (var2 == 0) {
         if (var4 != null && !var4.isEmpty()) {
            ...
            var1.setEntete("Impression note de débit");
            ...
            if (this.devisePrint.equals(this.structureLog.getStrdevise())) {
               ...
               double var13 = this.utilNombre.myRound((this.noteDebitEnteteVentes.getNdbTotTtc() + this.noteDebitEnteteVentes.getNdbTotTc()) / (double)this.tauxPrint, 2);
            ...
            if (this.noteDebitEnteteVentes.getNdbAnal2() != null && !this.noteDebitEnteteVentes.getNdbAnal2().isEmpty()) {
               String var17 = "";
               if (this.noteDebitEnteteVentes.getNdbAnal2().contains(":")) {
                  String[] var14 = this.noteDebitEnteteVentes.getNdbAnal2().split(":");
                  var17 = var14[0];
               } else {
                  var17 = this.noteDebitEnteteVentes.getNdbAnal2();
               }
         ...
         var1.setEntete("Impression de la liste des notes de débit");
         var1.setTotauxHt("" + this.totauxHt);
         var1.setTotauxTaxe("" + this.totauxTaxe);
         var1.setTotauxTtc("" + this.totauxTtc);
         var1.setCheminRapport(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "impression" + File.separator + "fr" + File.separator + "ventes" + File.separator + "liste" + File.separator + "note_de_debit" + File.separator);
      ...
      if (var1 != null) {
         ...
         if (this.lesLignesList.size() != 0) {
            for(int var3 = 0; var3 < this.lesLignesList.size(); ++var3) {
               ...
               this.produits = null;
               if (this.noteDebitLigneVentes.getNdbligCode() != null && !this.noteDebitLigneVentes.getNdbligCode().isEmpty()) {
                  this.produits = this.produitsDao.chargeProduit(this.noteDebitLigneVentes.getNdbligCode(), var2);
               }
   ...
   public void recalculCss(NoteDebitEnteteVentes var1, Session var2) throws HibernateException, NamingException {
      if (var1 != null) {
         this.noteDebitEnteteVentes = var1;
         this.tiers = this.noteDebitEnteteVentes.getTiers();
         this.lesLignesList = this.noteDebitLigneVentesDao.chargerLesLignes(this.noteDebitEnteteVentes, var2);
