...
public class MenudroitPartiPolitiqueCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitPartiPolitiqueXmlList = new ListDataModel();

   public void chargerMenuGauchePartiPolitiqueXml(String var1) {
      String var2 = "";
      ...
      try {
         ...
         File var4 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "81300" + var2 + "-" + var1 + ".xml");
         if (!var4.exists()) {
            var4 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "81300" + var2 + ".xml");
         }
         ...
         this.dataModelMenudroitPartiPolitiqueXmlList.setWrappedData(var9);
         var5.close();
   ...
   public DataModel getDataModelMenudroitPartiPolitiqueXmlList() {
      return this.dataModelMenudroitPartiPolitiqueXmlList;
   }

   public void setDataModelMenudroitPartiPolitiqueXmlList(DataModel var1) {
      this.dataModelMenudroitPartiPolitiqueXmlList = var1;
   }
