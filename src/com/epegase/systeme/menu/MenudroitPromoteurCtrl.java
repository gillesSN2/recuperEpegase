...
public class MenudroitPromoteurCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitPromoteurXmlList = new ListDataModel();

   public void chargerMenudroitPromoteurXml(String var1, long var2, Users var4) {
      String var5 = "";
      ...
      try {
         ...
         File var7 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "81630" + var5 + "-" + var1 + ".xml");
         if (!var7.exists()) {
            var7 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "81630" + var5 + ".xml");
         }
         ...
         this.dataModelMenudroitPromoteurXmlList.setWrappedData(var12);
         var8.close();
   ...
   public DataModel getDataModelMenudroitPromoteurXmlList() {
      return this.dataModelMenudroitPromoteurXmlList;
   }

   public void setDataModelMenudroitPromoteurXmlList(DataModel var1) {
      this.dataModelMenudroitPromoteurXmlList = var1;
   }
