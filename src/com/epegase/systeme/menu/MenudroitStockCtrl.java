...
public class MenudroitStockCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitStockXmlList = new ListDataModel();

   public void chargerMenudroitStockXml(String var1, Structure var2) {
      String var3 = "";
      ...
      if (var2.getStrtypeentreprise() == null || var2.getStrtypeentreprise().isEmpty()) {
         var2.setStrtypeentreprise("0");
      }

      try {
         SAXBuilder var4 = new SAXBuilder();
         File var5 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "60100" + var3 + "-" + var1 + ".xml");
         if (!var5.exists()) {
            var5 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "60100" + var3 + ".xml");
         }
         ...
         for(int var11 = 0; var11 < var9.size(); ++var11) {
            ...
            if (var12.isAcc()) {
               if (!var12.getCommande().equals("60100:14") && !var12.getCommande().equals("60100:15")) {
                  var10.add(var12);
               } else if (var2.getStrtypeentreprise().equals("2")) {
                  var10.add(var12);
               }
            }
         }

         this.dataModelMenudroitStockXmlList.setWrappedData(var10);
         var6.close();
   ...
   public DataModel getDataModelMenudroitStockXmlList() {
      return this.dataModelMenudroitStockXmlList;
   }

   public void setDataModelMenudroitStockXmlList(DataModel var1) {
      this.dataModelMenudroitStockXmlList = var1;
   }
