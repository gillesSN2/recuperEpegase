...
public class MenudroitSyndicCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitSyndicXmlList = new ListDataModel();

   public void chargerMenudroitSyndicXml(String var1, long var2, Users var4) {
      String var5 = "";
      ...
      try {
         ...
         File var7 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "81610" + var5 + "-" + var1 + ".xml");
         if (!var7.exists()) {
            var7 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "81610" + var5 + ".xml");
         }
         ...
         this.dataModelMenudroitSyndicXmlList.setWrappedData(var12);
         var8.close();
   ...
   public DataModel getDataModelMenudroitSyndicXmlList() {
      return this.dataModelMenudroitSyndicXmlList;
   }

   public void setDataModelMenudroitSyndicXmlList(DataModel var1) {
      this.dataModelMenudroitSyndicXmlList = var1;
   }
