...
public class MenudroitMicroFinanceCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitMicroFinanceXmlList = new ListDataModel();

   public void chargerMenudroitMicroFinanceXml(String var1) {
      String var2 = "";
      ...
      try {
         ...
         File var5 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "80700" + var2 + "-" + var1 + ".xml");
         if (!var5.exists()) {
            var5 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "80700" + var2 + ".xml");
         }
         ...
         this.dataModelMenudroitMicroFinanceXmlList.setWrappedData(var3);
         var6.close();
   ...
   public DataModel getDataModelMenudroitMicroFinanceXmlList() {
      return this.dataModelMenudroitMicroFinanceXmlList;
   }

   public void setDataModelMenudroitMicroFinanceXmlList(DataModel var1) {
      this.dataModelMenudroitMicroFinanceXmlList = var1;
   }
