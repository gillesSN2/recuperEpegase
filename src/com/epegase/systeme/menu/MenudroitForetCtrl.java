...
public class MenudroitForetCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitForetXmlList = new ListDataModel();

   public void chargerMenudroitForetXml(String var1) {
      String var2 = "";
      ...
      try {
         ...
         File var5 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "81400" + var2 + "-" + var1 + ".xml");
         if (!var5.exists()) {
            var5 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "81400" + var2 + ".xml");
         }
         ...
         this.dataModelMenudroitForetXmlList.setWrappedData(var3);
         var6.close();
   ...
   public void chargerMenudroitUsineDerouageXml(String var1) {
      String var2 = "";
      if (this.strEnteteGroupe == 2) {
         var2 = "_ENT";
      } else {
   ...
   public void chargerMenudroitUsineSciageXml(String var1) {
      String var2 = "";
      if (this.strEnteteGroupe == 2) {
         var2 = "_ENT";
      } else {
   ...
   public void chargerMenudroitUsinePlaquageXml(String var1) {
      String var2 = "";
      if (this.strEnteteGroupe == 2) {
         var2 = "_ENT";
      } else {
   ...
   public DataModel getDataModelMenudroitForetXmlList() {
      return this.dataModelMenudroitForetXmlList;
   }

   public void setDataModelMenudroitForetXmlList(DataModel var1) {
      this.dataModelMenudroitForetXmlList = var1;
   }
