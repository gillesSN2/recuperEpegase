...
public class MenudroitTempleCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitTempleXmlList = new ListDataModel();
   ...
   public void chargerMenuGaucheParcsXml(String var1) {
      ...
      try {
         ...
         File var4 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "83200" + var2 + "-" + var1 + ".xml");
         if (!var4.exists()) {
            var4 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "83200" + var2 + ".xml");
         }
         ...
         this.dataModelMenudroitTempleXmlList.setWrappedData(var9);
         var5.close();
   ...
   public DataModel getDataModelMenudroitTempleXmlList() {
      return this.dataModelMenudroitTempleXmlList;
   }

   public void setDataModelMenudroitTempleXmlList(DataModel var1) {
      this.dataModelMenudroitTempleXmlList = var1;
   }
