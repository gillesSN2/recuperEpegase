...
public class MenudroitLocationCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitLocationXmlList = new ListDataModel();

   public void chargerMenudroitLocationXml(String var1, long var2) {
      String var4 = "";
      ...
      try {
         ...
         File var6 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "81600" + var4 + "-" + var1 + ".xml");
         if (!var6.exists()) {
            var6 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "81600" + var4 + ".xml");
         }
         ...
         this.dataModelMenudroitLocationXmlList.setWrappedData(var11);
         var7.close();
   ...
   public DataModel getDataModelMenudroitLocationXmlList() {
      return this.dataModelMenudroitLocationXmlList;
   }

   public void setDataModelMenudroitLocationXmlList(DataModel var1) {
      this.dataModelMenudroitLocationXmlList = var1;
   }
