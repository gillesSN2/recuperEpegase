...
public class MenudroitCaisseCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitCaisseXmlList = new ListDataModel();

   public void chargerMenudroitCaisseXml(String var1) {
      String var2 = "";
      ...
      try {
         ...
         File var4 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "90000" + var2 + "-" + var1 + ".xml");
         if (!var4.exists()) {
            var4 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "90000" + var2 + ".xml");
         }
         ...
         this.dataModelMenudroitCaisseXmlList.setWrappedData(var9);
         var5.close();
   ...
   public void chargerMenuGaucheCaisseGuestXml(Structure var1) {
      String var2 = "";
      if (this.strEnteteGroupe == 2) {
         var2 = "_ENT";
      } else {
      ...
      try {
         SAXBuilder var3 = new SAXBuilder();
         File var4 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "90100" + var2 + ".xml");
         FileReader var5 = new FileReader(var4);
         Document var6 = var3.build(var5);
         Element var7 = var6.getRootElement();
         List var8 = var7.getChildren();
   ...
   public DataModel getDataModelMenudroitCaisseXmlList() {
      return this.dataModelMenudroitCaisseXmlList;
   }

   public void setDataModelMenudroitCaisseXmlList(DataModel var1) {
      this.dataModelMenudroitCaisseXmlList = var1;
   }
