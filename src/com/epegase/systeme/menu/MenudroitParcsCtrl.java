...
public class MenudroitParcsCtrl implements Serializable {
   private long strId;
   private int strEnteteGroupe = 0;
   private transient DataModel dataModelMenudroitParcsXmlList = new ListDataModel();
   private OptionParcs optionParcs;

   public MenudroitParcsCtrl(OptionParcs var1) {
      this.optionParcs = var1;
   }

   public void chargerMenuGaucheParcsXml(String var1) {
      String var2 = "";
      ...
      try {
         ...
         File var4 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.strId + File.separator + "menu_defaut" + File.separator + "70000" + var2 + "-" + var1 + ".xml");
         if (!var4.exists()) {
            var4 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "menu_defaut" + File.separator + "70000" + var2 + ".xml");
         }
         ...
         for(int var10 = 0; var10 < var8.size(); ++var10) {
            ...
            if (var11.isAcc()) {
               if (var11.getCommande().equals("70000:15")) {
                  var11.setLibelle_FR(this.optionParcs.getLibelleMANIFEST() + "s");
               }
         ...
         this.dataModelMenudroitParcsXmlList.setWrappedData(var9);
         var5.close();
   ...
   public DataModel getDataModelMenudroitParcsXmlList() {
      return this.dataModelMenudroitParcsXmlList;
   }

   public void setDataModelMenudroitParcsXmlList(DataModel var1) {
      this.dataModelMenudroitParcsXmlList = var1;
   }
