...
public class LectureCentresSecuriteSociale implements Serializable {
   ...
   public void recuperePaye() {
      try {
         ...
         File var2 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "paye" + File.separator + "configuration" + File.separator + "ccss_" + this.structureLog.getStrcodepays() + ".xml");
         if (!var2.exists()) {
            var2 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "paye" + File.separator + "centresSecuriteSociale" + File.separator + "ccss_" + this.structureLog.getStrcodepays() + ".xml");
         }
