...
public class LectureInfirmerieVma implements Serializable {
   ...
   public void recupereVaccin() {
      try {
         ...
         File var2 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "commercial" + File.separator + "medicalVma.xml");
