...
public class LectureNatureInterim implements Serializable {
   ...
   public void recupereNatureVentes() {
      try {
         ...
         File var2 = new File(StaticModePegase.getCheminContext() + File.separator + "configuration" + File.separator + "commercial" + File.separator + "NaturesFamillesInterim.xml");
