...
public class BsoTabElementDao implements Serializable {
   private BsoTabElement bsoTabElement;
   private String maBase;
   private UtilInitHibernate utilInitHibernate;

   public BsoTabElementDao(String var1, UtilInitHibernate var2) {
      this.maBase = var1;
      this.utilInitHibernate = var2;
   }

   public void deleteCpttabElement(String var1, Session var2) {
      String var3 = "delete from BsoTabElement where tabele_id in " + var1;
   ...
   public BsoTabElement insertElement(BsoTabElement var1, BsoTabNom var2) throws HibernateException, NamingException {
      Session var3 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
      Transaction var4 = null;

      try {
         var4 = var3.beginTransaction();
         var1.setBsoTabNom(var2);
         var3.save(var1);
         var4.commit();
   ...
   public BsoTabElement modifElement(BsoTabElement var1) throws HibernateException, NamingException {
   ...
   public void deleteElement(BsoTabElement var1) throws HibernateException, NamingException {
      Session var2 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
      Transaction var3 = null;
   ...
   public List chargerMesTabElement(String var1, Session var2) throws HibernateException, NamingException {
      ...
      Query var4 = var2.createQuery("from BsoTabElement where bsoTabNom in " + var1);
      List var5 = var4.list();
      if (var3) {
         this.utilInitHibernate.closeSession();
      }
   ...
   public BsoTabElement chargerMesTabElementByRef(String var1, String var2, Session var3) throws HibernateException, NamingException {
      boolean var4 = false;
      if (var3 == null) {
         var3 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
         var4 = true;
      ...
      Query var5 = var3.createQuery("from BsoTabElement where tabeleLibFR='" + var1 + "' and tabeleReference='" + var2 + "'");
      List var6 = var5.list();
      if (var6.size() != 0) {
         this.bsoTabElement = (BsoTabElement)var6.get(0);
      } else {
         this.bsoTabElement = null;
      }
   ...
   public List chargerMesTabElement() throws HibernateException, NamingException {
      ...
      Query var2 = var1.createQuery("from BsoTabElement order by tabeleNum");
      List var3 = var2.list();
      this.utilInitHibernate.closeSession();
      return var3;
   }
   ...
   public List chargerMesTabElement(long var1, Session var3) throws HibernateException, NamingException {
      ...
      Query var5 = var3.createQuery("from BsoTabElement where tabeleInactif=0 and bsoTabNom=:tabNomid order by tabeleNum").setLong("tabNomid", var1);
      List var6 = var5.list();
      if (var4) {
         this.utilInitHibernate.closeSession();
      }
   ...
   public void ordonnnerAscendant(int var1, int var2, long var3, long var5) throws HibernateException, NamingException {
      Session var7 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
      Transaction var8 = var7.beginTransaction();
      String var9 = "update BsoTabElement pb set pb.tabeleNum=:ordPrec where pb.tabele_id=:idTab";
      var7.createQuery(var9).setInteger("ordPrec", var2).setLong("idTab", var3).executeUpdate();
      String var11 = "update BsoTabElement pb set pb.tabeleNum=:ord1 where pb.tabele_id=:idTab";
   ...
   public void ordonnnerDescendant(int var1, int var2, long var3, long var5) throws HibernateException, NamingException {
      Session var7 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
      Transaction var8 = var7.beginTransaction();
      String var9 = "update BsoTabElement pb set pb.tabeleNum=:ordSuiv where pb.tabele_id=:idTab";
