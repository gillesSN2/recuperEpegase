...
public class BsoTabNomDao implements Serializable {
   private BsoTabNom bsoTabNom;
   private String maBase;
   private UtilInitHibernate utilInitHibernate;

   public BsoTabNomDao(String var1, UtilInitHibernate var2) {
      this.maBase = var1;
      this.utilInitHibernate = var2;
   }

   public BsoTabNom insertTableau(BsoTabNom var1, String var2) throws HibernateException, NamingException {
      Session var3 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
      Transaction var4 = null;

      try {
         var4 = var3.beginTransaction();
         var1.setTablisZone(var2);
         var1.setTablisModif(1);
         var3.save(var1);
         var4.commit();
   ...
   public BsoTabNom modifTableau(BsoTabNom var1) throws HibernateException, NamingException {
   ...
   public EtatFinancier updateCpttabNomCol(int var1, EtatFinancier var2, BsoTabNom var3) throws HibernateException, NamingException {
   ...
   public void deletePegtabNom(String var1, Session var2) {
      String var3 = "delete from  BsoTabNom where tablis_id in " + var1;
      int var4 = var2.createQuery(var3).executeUpdate();
   }

   public void deletePegtabNom(BsoTabNom var1) throws HibernateException, NamingException {
      Session var2 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
   ...
   public void deletePegtabNom() throws HibernateException, NamingException {
      Session var1 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
      Transaction var2 = var1.beginTransaction();
      String var3 = "delete from  BsoTabNom where tablisType=:type";
   ...
   public List chargerMesTabNomConf(int var1, String var2, Session var3) throws HibernateException, NamingException {
      ...
      Query var5 = null;
      if (var1 == 0) {
         var5 = var3.createQuery("from BsoTabNom where (tablisType=0 or tablisType=2 or tablisType=3 or tablisType=4 or tablisType=4 or tablisType=5) and tablisZone='" + var2 + "' order by tablisNum");
      } else if (var1 == 1) {
         var5 = var3.createQuery("from BsoTabNom where tablisType=1 and tablisZone='" + var2 + "' order by tablisNum");
      } else if (var1 == 10) {
         var5 = var3.createQuery("from BsoTabNom where (tablisType=10 or tablisType=15) and tablisZone='" + var2 + "' order by tablisNum");
      }
   ...
   public List chargerMesTabNomExp(int var1, String var2, Session var3) throws HibernateException, NamingException {
      boolean var4 = false;
      if (var3 == null) {
         var3 = this.utilInitHibernate.getOpenSession(this.maBase, "BsoTabNom");
         var4 = true;
      ...
      Query var5 = null;
      if (var1 == 0) {
         var5 = var3.createQuery("from BsoTabNom where tablisInactif=0 and (tablisType=0 or tablisType=2 or tablisType=3 or tablisType=4 or tablisType=5) and tablisZone='" + var2 + "' order by tablisNum");
      } else if (var1 == 1) {
         var5 = var3.createQuery("from BsoTabNom where tablisInactif=0 and tablisType=1 and tablisZone='" + var2 + "' order by tablisNum");
      } else if (var1 == 10) {
         var5 = var3.createQuery("from BsoTabNom where tablisInactif=0 and (tablisType=10 or tablisType=15) and tablisZone='" + var2 + "' order by tablisNum");
      }
