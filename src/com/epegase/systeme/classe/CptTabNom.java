...
public class CptTabNom implements Serializable {
   ...
   public int getTablisAnneeAnte() {
      return this.tablisAnneeAnte;
   }

   public void setTablisAnneeAnte(int var1) {
      this.tablisAnneeAnte = var1;
   }

   public int getTablisCategorie() {
      return this.tablisCategorie;
   }

   public void setTablisCategorie(int var1) {
      this.tablisCategorie = var1;
   }
}
