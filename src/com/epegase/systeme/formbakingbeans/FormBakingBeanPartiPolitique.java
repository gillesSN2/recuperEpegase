...
import com.epegase.systeme.menu.MenudroitPartiPolitiqueCtrl;
...
public class FormBakingBeanPartiPolitique implements Serializable {
   ...
   private MenudroitPartiPolitiqueCtrl menudroitPartiPolitiqueCtrl;
   private ObjetLigneMenu menupartiPolitique;
   private ObjetLigneMenu menupartiPolitiqueMemo = new ObjetLigneMenu();
   ...
   public FormBakingBeanPartiPolitique() throws IOException, JDOMException {
   }
   ...
   public void menuGauchePartiPolitique() throws JDOMException, IOException {
      if (this.menudroitPartiPolitiqueCtrl == null) {
         this.menudroitPartiPolitiqueCtrl = new MenudroitPartiPolitiqueCtrl();
         this.menudroitPartiPolitiqueCtrl.setStrId(this.structureLog.getStrid());
         if (this.usersLog.getUsrCollaboration() == null || this.usersLog.getUsrCollaboration().isEmpty()) {
            this.usersLog.setUsrCollaboration("ADM");
         }

         this.menudroitPartiPolitiqueCtrl.chargerMenuGauchePartiPolitiqueXml(this.usersLog.getUsrCollaboration());
      }
      ...
      this.lesOnglets.chargerMesOnglets("81300", this.usersLog.getUsrCollaboration());
   }

   public void gestionPartiPolitique() throws JDOMException, IOException, NamingException, HibernateException, ParseException {
      this.menupartiPolitique = new ObjetLigneMenu();
      if (this.menudroitPartiPolitiqueCtrl.getDataModelMenudroitPartiPolitiqueXmlList().isRowAvailable()) {
         this.menupartiPolitique = (ObjetLigneMenu)this.menudroitPartiPolitiqueCtrl.getDataModelMenudroitPartiPolitiqueXmlList().getRowData();
         if (this.menupartiPolitique.getLibelle_FR() != null && !this.menupartiPolitique.getLibelle_FR().isEmpty()) {
            this.menupartiPolitiqueMemo = this.menupartiPolitique;
            this.aiguillagePartiPolitique();
         }
      }
   ...
   public void gestionPartiPolitiqueFree(ObjetLigneMenu var1) throws JDOMException, IOException, HibernateException, NamingException, SAXException, ParseException {
      this.menupartiPolitique = var1;
      this.menupartiPolitiqueMemo = this.menupartiPolitique;
      if (this.lesOnglets.getMesOnglets().size() == 0) {
         this.menuGauchePartiPolitique();
      }

      this.aiguillagePartiPolitique();
   }

   public void aiguillagePartiPolitique() throws JDOMException, IOException, NamingException, HibernateException, ParseException {
      if (this.lastExercice.getExevteId() != this.exoselectionne.getExevteId()) {
         this.menupartiPolitique.setAdd(false);
         this.menupartiPolitique.setMaj(false);
         this.menupartiPolitique.setSup(false);
         this.menupartiPolitique.setDup(false);
         this.menupartiPolitique.setClo(false);
         this.menupartiPolitique.setTrf(false);
         this.menupartiPolitique.setImp(true);
      } else {
         this.menupartiPolitique.setAdd(this.menupartiPolitiqueMemo.isAdd());
         this.menupartiPolitique.setMaj(this.menupartiPolitiqueMemo.isMaj());
         this.menupartiPolitique.setSup(this.menupartiPolitiqueMemo.isSup());
         this.menupartiPolitique.setDup(this.menupartiPolitiqueMemo.isDup());
         this.menupartiPolitique.setClo(this.menupartiPolitiqueMemo.isClo());
         this.menupartiPolitique.setTrf(this.menupartiPolitiqueMemo.isTrf());
         this.menupartiPolitique.setImp(this.menupartiPolitiqueMemo.isImp());
      }

      this.razMemoire();
      if (this.menupartiPolitique.getCommande().equalsIgnoreCase("81300:01")) {
         this.affichePage = "/parc/ParcListeInit.jsp";
      } else if (this.menupartiPolitique.getCommande().equalsIgnoreCase("81300:06")) {
         this.nature = 44;
      ...
      } else if (this.menupartiPolitique.getCommande().equalsIgnoreCase("81300:90")) {
         this.affichePage = "/parc/ImpressionParc.jsp";
         this.menuImpressionPartiPolitique();
      } else if (this.menupartiPolitique.getCommande().equalsIgnoreCase("81300:99")) {
         this.affichePage = "/parc/SelectionExercicesParc.jsp";
         this.menuSelectionExercicesPartiPolitique();
      }

   }

   public void menuListePartiPolitique() throws HibernateException, NamingException {
      Session var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "Parc");
      this.utilInitHibernate.closeSession();
   }

   public void menuImpressionPartiPolitique() throws JDOMException, IOException, HibernateException, NamingException, ParseException {
      Session var1 = this.utilInitHibernate.getOpenSession(this.baseLog, "Parc");
      this.utilInitHibernate.closeSession();
   ...
   public void menuSelectionExercicesPartiPolitique() throws IOException, JDOMException, NamingException {
      this.formExercicesVentes = new FormExercicesVentes();
   ...
   public void recupererModelesAutorises() {
      ...
      File var1 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "politburo" + File.separator);
      if (!var1.exists()) {
         var1.mkdir();
      }

      File var2 = new File(StaticModePegase.getCheminContext() + File.separator + "clients" + File.separator + "structure" + this.structureLog.getStrid() + File.separator + "politburo" + File.separator + "configuration" + File.separator + this.usersLog.getGroupe().getGrpCode() + "_modeleAutorise.xml");
      if (var2.exists()) {
   ...
   public MenudroitPartiPolitiqueCtrl getMenudroitPartiPolitiqueCtrl() {
      return this.menudroitPartiPolitiqueCtrl;
   }

   public void setMenudroitPartiPolitiqueCtrl(MenudroitPartiPolitiqueCtrl var1) {
      this.menudroitPartiPolitiqueCtrl = var1;
   }

   public ObjetLigneMenu getMenupartiPolitique() {
      return this.menupartiPolitique;
   }

   public void setMenupartiPolitique(ObjetLigneMenu var1) {
      this.menupartiPolitique = var1;
   }

   public ObjetLigneMenu getMenupartiPolitiqueMemo() {
      return this.menupartiPolitiqueMemo;
   }

   public void setMenupartiPolitiqueMemo(ObjetLigneMenu var1) {
      this.menupartiPolitiqueMemo = var1;
   }
