...
<f:subview id="chronotiers">

    <a4j:form>

        <center> <h2><h:outputText value="CHRONOS DES TIERS" style="color:green;"/></h2></center>
        ...
        <h:panelGrid  style="width:100%;" id="numerotation" border="0">
            <div style="text-align:justify;color:red">
                ATTENTION :<br>
                <b></b> <br>
                Si les chronos des tiers sont activés, ils seront stockés dans la zone sigle du tiers et cette dernière sera verrouillée en saisie<br>
                <br><br><br>
            </div>
        </h:panelGrid>
                ...
                <h:panelGrid  columns="2" style="width:100%;" columnClasses="clos30,clos70d">
                    ...
                    <h:column>
                        <h:selectOneMenu style="width:200px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formChronoOffice.chrono.chrNature}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formChronoOffice.chrono.chrId!=0}">
                            ...
                            <f:selectItem itemLabel="300:Fournisseurs" itemValue="300" />
                            <f:selectItem itemLabel="301:Suspect" itemValue="301" />
                            <f:selectItem itemLabel="302:Prospect" itemValue="302" />
                            <f:selectItem itemLabel="303:Client" itemValue="303" />
                            <f:selectItem itemLabel="304:Propriétaire" itemValue="304" />
                            <f:selectItem itemLabel="305:Copropriété" itemValue="305" />
                            <f:selectItem itemLabel="306:Locataire" itemValue="306" />
    ...
    <rich:modalPanel domElementAttachment="parent"  id="panelChronoAuto" width="500" height="450" headerClass="headerPanel" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formChronoOffice.showModalPanelAuto}">
        ...
        <a4j:form >
            ...
            <h:panelGroup id="pngValide">
                <center>
                    <br>
                    <h:commandButton image="/images/valider_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formChronoOffice.saveChronoAutoTiers}">
