...
<f:subview id="moralFiche">
                ...
                <h:panelGrid  width="100%" id="panGlobal">
                    ...
                    <h:panelGrid styleClass="fichefournisseur" rendered="#{!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_tiersDivers}">
                        <h:panelGrid columns="4" width="100%" columnClasses="clos15,clos35,clos15,clos35">
                            ...
                            <h:column>
                                <h:inputText style="width:85%;" maxlength="50" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiecel1}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action==3}"/>&nbsp;&nbsp;
                    ...
                    <c:when test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tietype=='0'&& bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiecategorie=='Banque'}" >
                        <h:panelGrid width="100%" styleClass="fichefournisseur1" id="idBanque">
                            <h:panelGrid  id="btnBanque" columns="5" width="250px" style="height:34px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw}">
                                ...
                                <a4j:commandButton image="/images/detail.png" title="Consulter compte"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.consulBanque}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.testContact}" reRender="panelBanque,btnBanque"/>
                            ...
                            <a4j:region renderRegionOnly="false">
                                <rich:extendedDataTable style="border:solid 0px green;" border="0" id="tableBanque" width="100%" height="300px" footerClass="bard" activeClass="active-row" noDataLabel=" " headerClass="headerTab" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.datamodelContact}" var="contact" >
                                    <a4j:support eventsQueue="maQueue" event="onRowClick"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.consulBanque}" reRender="btnBanque"/>
                ...
                <h:panelGrid id="selectCompte" style="border:1px solid green;" width="100%">
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.choixCompte==1||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.choixCompte==2}">
                        ...
                        <h:panelGroup id="pgNumCpt">
                            ...
                            <h:inputText style="margin-left:25px;width:400px;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tieprenom}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tieprenom!=null}" readonly="true"/>
                        </h:panelGroup>
                    </c:if>
        ...
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.showModalPanelContact}" var="ctc">
            ...
            <a4j:form >
                ...
                <h:panelGrid styleClass="fichefournisseur" columns="4" width="100%" columnClasses="clos15,clos35,clos15,clos35">
                    ...
                    <h:column><h:outputText value="Prénom:"/></h:column>
                    <h:column><h:inputText maxlength="50" style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.contacts.conprenom}"/></h:column>
                    <h:column><h:outputText value="Fonction:"/></h:column>
        ...
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.showModalPanelBanque}" var="bnq">
            ...
            <a4j:form >
                ...
                <h:panelGrid styleClass="fichefournisseur" width="100%" columns="2" columnClasses="clos20,clos80">
                    ...
                    <h:column><h:outputText value="Référence client:"/></h:column>
                    <h:column><h:inputText maxlength="10" size="10" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.contacts.conrefbanque}"/></h:column>
    ...
    <rich:modalPanel domElementAttachment="parent"   id="panelRemise" headerClass="headerPanel" width="650" height="350" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.showModalPanelRemise}">
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.showModalPanelRemise}" var="resp">
            <f:facet name="header"><h:outputText value="GESTION DES REMISES/RABAIS/RISTOURNES"></h:outputText></f:facet>
            <f:facet name="controls">
                <a4j:form >
    ...
    <rich:modalPanel domElementAttachment="parent"  id="pannelServiceInterim" headerClass="headerPanel" width="700" height="200" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.shomModalPanelServiceInterim}">
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.shomModalPanelServiceInterim}" var="srv">
            <f:facet name="header"><h:outputText value="SERVICES DU CLIENT"></h:outputText></f:facet>
            <f:facet name="controls">
                <a4j:form >
                    <a4j:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.annulerServiceInterim}" image="/images/close.gif" styleClass="hidelink" reRender="pannelServiceInterim"/>
                </a4j:form>
            </f:facet>
            <a4j:form >
                <rich:hotKey key="return" handler="return false;"/>
                <h:panelGrid  columns="2" width="100%">
                    ...
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.serviceInterim.sitCode}" size="10" maxlength="20"/></h:column>
                    <h:column><h:outputText value="Libellé:"/></h:column>
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.serviceInterim.sitNomFr}" style="width:100%" maxlength="100" onkeypress="return scanToucheLettre(event)" /></h:column>
                    <h:column><h:outputText value="Localisation:"/></h:column>
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.serviceInterim.sitNomResponsable}" style="width:100%" maxlength="100" onkeypress="return scanToucheLettre(event)" /></h:column>
                </h:panelGrid>
                <br/> <br/>
                <center>
                    <h:panelGroup>
                        <a4j:commandButton image="/images/valider_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.validerServiceInterim}" reRender="pannelServiceInterim,tableServiceInterim"/>
                    </h:panelGroup>
                </center>
            </a4j:form>
        </c:if>
                ...
                <a4j:region renderRegionOnly="false">
                    <rich:extendedDataTable height="400px" width="100%" enableContextMenu="false" headerClass="headerTab" id="histo" selectedClass="active-row" var="dep" style="border:solid 0px green;cursor:pointer;" activeClass="active-row" noDataLabel=" " rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.dataModelDepot}" rowKeyVar="rkv" >
                        ...
                        <rich:column  width="10%" style="text-align:right">
                            ...
                            <h:outputText value="#{dep.rglDepense}" rendered="#{dep.rglDepense!=0&&dep.rglDepotTiers==3}" style="text-align:right">
                                <jsp:include flush="true" page="/commun/formatNombreStructure.jsp"/>
                            </h:outputText>
                        </rich:column>
                    </rich:extendedDataTable>
