...
<f:subview id="groupeFiche">

    <a4j:form id="formGroupeFiche"  enctype="multipart/form-data">
        ...
        <rich:tabPanel switchType="client" immediate="true" id="tabPanelFrniss" style="border:0px;">
            ...
            <rich:tab label="Logo" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2}">
                ...
                <h:panelGrid width="100%" styleClass="fichefournisseur1" id="idProcuration">
                    ...
                    <a4j:region renderRegionOnly="false">
                        <rich:extendedDataTable style="border:solid 0px green;" border="0" id="tableProcuration" width="100%" height="300px" footerClass="bard" activeClass="active-row" noDataLabel="PAS DE PROCURATION..." headerClass="headerTab" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.datamodelProcuration}" var="contact" >
                            <a4j:support eventsQueue="maQueue" event="onRowClick"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.selectionProcuration}" reRender="btnProcuration"/>
            ...
            <rich:tab label="Dispositons testamentaires" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2}">
                ...
                <h:panelGrid width="100%" styleClass="fichefournisseur1" id="idTestament">
                     <h:panelGrid  id="btnTestament" columns="4" width="250px" style="height:34px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw}">
                        <a4j:commandButton image="/images/ajouter.png" title="Ajouter disposition testamentaire"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ajoutTestament}" reRender="panelTestament,btnTestament"/>
                        <a4j:commandButton image="/images/modifier.png" title="Modifier disposition testamentaire"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.modifTestament}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.testContact}" reRender="panelTestament,btnTestament"/>
                        <a4j:commandButton image="/images/detail.png" title="Consulter disposition testamentaire"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.consultTestament}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.testContact}" reRender="panelTestament,btnTestament"/>
                        <a4j:commandButton image="/images/supprimer.png" title="Supprimer disposition testamentaire" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.deleteTestament}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.testContact}" onclick="if (!confirm('Etes-vous sur de vouloir supprimer cet élément?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,tableTestament,btnTestament"/>
                    </h:panelGrid>
                    <a4j:region renderRegionOnly="false">
            ...
            <rich:tab id="tabElement" label="Constitution groupe" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2}">
                <jsp:include flush="true" page="/tiers/tiersCommun.jsp" />
                <h:panelGrid width="100%" id="idPanElement">
                    <h:panelGrid width="100%" headerClass="headerTab">
            ...
            <rich:tab id="tabCompte" label="Compte" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2}">
                ...
                <h:panelGrid width="100%" id="idPanCompte">
                    <h:panelGrid width="100%" columns="2" columnClasses="clos30,clos70" id="idEtatCompte">
                        <h:column><h:outputText value="Date demande (JJ/MM/AAAA):"/></h:column>
                        <h:column>
                            <rich:calendar style=" background-color:white;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiedateDemandeOuverture}" enableManualInput="true" datePattern="dd/MM/yyyy"  locale="fr" popup="true"/>
                        </h:column>
                        <h:column><h:outputText value="Date réponse (JJ/MM/AAAA):"/></h:column>
                        <h:column>
                            <rich:calendar style=" background-color:white;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiedateDemandeReponse}" enableManualInput="true" datePattern="dd/MM/yyyy"  locale="fr" popup="true"/>
                        </h:column>
                        <h:column><h:outputText value="Etat de la demande:"/></h:column>
                        <h:column>
                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiedateDemandeEtat}">
                                <f:selectItem itemLabel="En cours" itemValue="0"/>
                                <f:selectItem itemLabel="Acceptée" itemValue="1"/>
                                <f:selectItem itemLabel="Refusée" itemValue="2"/>
                                <f:selectItem itemLabel="Cloturée" itemValue="3"/>
                                <a4j:support eventsQueue="maQueue" event="onchange" reRender="idEtatCompte,idRefus1,idRefus2"/>
                            </h:selectOneMenu>
                        </h:column>
                        <h:column id="idRefus1" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiedateDemandeEtat==2}"><h:outputText value="Motif du refus:"/></h:column>
                        <h:column id="idRefus2" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiedateDemandeEtat==2}"><h:inputText maxlength="50" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tiedateDemandeRefus}" style="width:100%"/></h:column>
                    </h:panelGrid>
                </h:panelGrid>
            </rich:tab>
