...
<f:subview id="tiersPhys">
    ...
    <a4j:form id="formTiersPhys" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action==0}">
        ...
        <h:panelGrid  columns="1" width="100%" id="recherche" styleClass="recherche">
            <h:panelGrid  columns="15" width="100%">
                ...
                <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}"><h:outputText value="Prénom:"/></h:column>
                <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}"><h:inputText style="width:150px;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.prenomRec}" /></h:column>
                ...
                <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='2'}">
                ...
                <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}">
                    <h:selectOneMenu id="evenementItem" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.evenementRec}" style="width:130px;">
                        <f:selectItem itemLabel="Hors événement" itemValue="100"/>
                        <f:selectItem itemLabel="Sans événement" itemValue="101"/>
                        <f:selectItems value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.mesEvenementsItems}" />
                    </h:selectOneMenu>
                </h:column>
                <h:column>
            ...
            <h:panelGrid  columns="13" width="100%" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_more_search}">
                <h:column>
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='2'}" var="lit1">
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}" var="lit2">
                        <h:selectOneMenu id="origineItem" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.origineRec}"  style="width:130px;">
                ...
                <h:column>
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='2'}" var="cat1">
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}" var="cat2">
                        <h:selectOneMenu id="centreInteretItem" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.centreInteretRec}" style="width:130px;">
                            <f:selectItem itemLabel="Tous centres d`interet" itemValue="100"/>
                            <f:selectItems value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.mesCentresIntereItems}" />
                        </h:selectOneMenu>
                    </c:if>
                </h:column>
                <h:column>
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='2'}" var="fam1">
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}" var="fam2">
                        <h:selectOneMenu id="sitMatItem" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.sitMatRec}"  style="width:130px;">
                ...
                <h:column rendered="#{!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.abnExist}">
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='2'}" var="pdv1">
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}" var="pdv2">

                    </c:if>
                </h:column>
                <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.abnExist}">
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type!='2'}" var="reg1">
                        <h:selectOneMenu id="regItem" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.regRec}"  style="width:130px;">
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}" var="reg2">

                    </c:if>
                </h:column>
                <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}"><h:outputText value="Observation:"/></h:column>
                <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.ligneMenu.type=='2'}"><h:inputText style="width:150px;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.observationsDirectRec}" /></h:column>
                ...
                <h:column><h:inputText style="width:150px;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.telRec}" /></h:column>
            </h:panelGrid>
        </h:panelGrid>
        ...
        <h:panelGrid columns="15" width="550px" id="btnTiers" style="height:34">
            ...
            <a4j:commandButton image="/images/mouvementstock.png" title="Documents commerciaux" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.accesDocuments}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton image="/images/extrait.png" title="Extrait de compte" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.accesExtrait}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            ...
            <a4j:commandButton image="/images/campagne.png" title="Campagne" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.accesCampagne}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers=='3'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton image="/images/cadeaux.png" title="Cadeaux" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.accesCadeaux}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton image="/images/parametre.png" title="Transfert en Personne Morale" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.transfererPesPhPersMor}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'&&bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption}" onclick="if (!confirm('Etes-vous sur de vouloir transférer cette personne en société?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,btnTiers,scrollTable,tableTiers"/>
            <a4j:commandButton title="Génération QRCODE" image="/images/qrcode.png" style="height:26px;width:26px" oncomplete="javascript:Richfaces.showModalPanel('panelQrCode');" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption}"/>
        ...
        <center>
            <div style="overflow:scroll;max-height:100%;width:100%;border:solid 0px green;">
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable rows="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_nb_max}" style="max-height:100%;" styleClass="bg" id="tableTiers" border="0" width="160%" footerClass="bard" activeClass="active-row" noDataLabel=" " headerClass="headerTab" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.dataModelSociete}" var="societe" activeRowKey="true" rowKeyVar="rkv" selection="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.simpleSelectionEntete}" sortMode="multi" selectionMode="single" tableState="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.configListeEntete}" binding="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.extDTable}">
                        ...
                        <rich:column label="Structure" sortable="true" sortBy="#{societe.nomGroupe}" width="80px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.structureLog.strmaitrecabinet=='2'}">
                            <f:facet name="header" ><h:outputText value="STR."/></f:facet>
                            <h:outputText value="#{societe.nomGroupe}" style="#{societe.styleCouleur}" title="#{societe.nomGroupe}"/>
                        </rich:column>
                        <rich:column label="N° Compte" sortable="true" sortBy="#{societe.comptePrincipal}" width="100px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='2'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'}">
                        ...
                        <rich:column label="Date de création" sortable="true" sortBy="#{societe.tiedatecreat}" width="80px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers=='2'}">
                        ...
                        <rich:column label="Noms Conseillers" sortable="true" sortBy="#{societe.nomConseiller}" width="120px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers=='2'}">
                            <f:facet name="header" ><h:outputText value="Conseillers"/></f:facet>
                            <h:outputText value="#{societe.nomConseiller}" style="#{societe.styleCouleur}" title="#{societe.nomConseiller}"/>
                        </rich:column>
                        ...
                        <rich:column label="Sigle" sortable="true" sortBy="#{societe.tiesigle}" width="100px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.chronoActif}">
                            <f:facet name="header" ><h:outputText value="Sigle"/></f:facet>
                            <h:outputText value="#{societe.tiesigle}" style="#{societe.styleCouleur}" title="#{societe.tiesigle}"/>
                        </rich:column>
                        ...
                        <rich:column label="Centre dintéret" sortable="true" sortBy="#{societe.tieinteret}" width="150px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers=='2'}">
