...
<f:subview id="moralFiche">
    ...
    <a4j:form id="formMoralFiche"  enctype="multipart/form-data">
        ...
        <rich:tabPanel switchType="client" immediate="true" id="tabPanelFrniss" style="border:0px;">
            ...
            <rich:tab label="Immatriculation" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2}" >
            ...
            <rich:tab label="Facturation"  rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'&&(bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.venteExist&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2&&!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_tiersDivers)==true}"  >
                <jsp:include flush="true" page="/tiers/tiersFacturation.jsp" />
            </rich:tab>

            <rich:tab label="Règlement" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'&&(bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.venteExist&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2&&!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_tiersDivers)==true}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.griserModeCalcul}">
                <jsp:include flush="true" page="/tiers/tiersReglement.jsp" />
            </rich:tab>

            <rich:tab label="Tarifs Spéciaux" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='9'&&(bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.newtiers.tietype=='3'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.venteExist&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=2&&!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_tiersDivers)==true}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.griserModeCalcul}">
                <jsp:include flush="true" page="/tiers/tiersCommun.jsp" />
