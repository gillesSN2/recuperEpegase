...
<f:subview id="tiersMoral">
    ...
    <a4j:form id="formTiersMoral" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action==0}">
        ...
        <h:panelGrid columns="19" width="600px" id="btnTiers" style="height:34">
            ...
            <a4j:commandButton image="/images/convention.png" title="Conventions médicales" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.accesConventions}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.affiche_convention}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton image="/images/groupes.png" title="Paients pris en charge" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.accesPatientsPec}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.affiche_convention}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton image="/images/adherent.png" title="Sociétés adhérentes" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.accesAdhesion}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.afficheButtOption&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.affiche_adhesion}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
        ...
        <center>
            <div style="overflow:scroll;max-height:100%;width:100%;border:solid 0px green;">
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable rows="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_nb_max}" style="max-height:100%;" styleClass="bg" id="tableTiers" border="0" width="140%" footerClass="bard" activeClass="active-row" noDataLabel=" " headerClass="headerTab" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.dataModelSociete}" var="societe" activeRowKey="true" rowKeyVar="rkv" selection="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.simpleSelectionEntete}" sortMode="multi" selectionMode="single" tableState="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.configListeEntete}" binding="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.extDTable}">
                        ...
                        <rich:column label="N° Compte" sortable="true" sortBy="#{societe.comptePrincipal}" width="100px" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='1'&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.typeTiers!='2'}">
                        ...
                        <rich:column label="Sigle/appartenance" sortable="true" sortBy="#{societe.tiesigle}" width="100px">
                        ...
                        <rich:column label="Raison sociale" sortable="true" sortBy="#{societe.tieraisonsocialenom}" width="300px" sortOrder="ASCENDING">
                        ...
                        <rich:column label="Observations" sortable="true" sortBy="#{societe.tieobservations}" width="200px">
                        ...
                        <rich:column label="Famille" sortable="true" sortBy="#{societe.tienomfamille}" width="100px">
