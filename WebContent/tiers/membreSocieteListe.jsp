...
<f:subview id="membreSociete">

    <a4j:form id="formMembreSociete" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action==0}">
        ...
        <h:panelGrid width="100%">
            <h:panelGrid columns="11" width="500px" id="btnTiers" style="height:34">
