...
<c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers!=null&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers!=null}" var="prptie">
    ...
    <c:choose>
        ...
        <c:when test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action>=1&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action<=3}" >
            <jsp:include flush="true" page="/tiers/proprietairePhysiqueFiche.jsp" />
        </c:when>
        ...
        <c:otherwise>
            <jsp:include flush="true" page="/tiers/proprietairePhysiqueListe.jsp" />
        </c:otherwise>
