...
<f:subview id="tiertout">

    <a4j:form id="formTiersTout" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_action==0}">
        ...
        <h:panelGrid  columns="1" width="100%" id="recherche" styleClass="recherche">
            ...
            <h:panelGrid  columns="8" width="100%" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_more_search}">
                <h:column>
        ...
        <h:panelGrid columns="13" width="550px" id="btnTiers" style="height:34">
        ...
        <center>
            <div style="overflow:scroll;max-height:100%;width:100%;border:solid 0px green;">
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable rows="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.var_nb_max}" style="max-height:100%;" styleClass="bg" id="tableTiers" border="0" width="120%" footerClass="bard" activeClass="active-row" noDataLabel=" " headerClass="headerTab" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.dataModelSociete}" var="societe" activeRowKey="true" rowKeyVar="rkv" selection="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.simpleSelectionEntete}" sortMode="multi" selectionMode="single" tableState="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.configListeEntete}" binding="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanTiers.formTiers.extDTable}">
                        ...
                        <rich:column label="Sigle ou Civilité" sortable="true" sortBy="#{societe.tiecivilite}"width="100px">
                            <f:facet name="header" ><h:outputText value="Sig./Civ."/></f:facet>
                            <h:outputText value="#{societe.tiecivilite}" rendered="#{societe.tiegenre=='010'||societe.tiegenre=='020'||societe.tiegenre=='030'}" style="#{societe.styleCouleur}"/>
                            <h:outputText value="#{societe.tiesigle}" rendered="#{societe.tiegenre!='010'&&societe.tiegenre!='020'&&societe.tiegenre!='030'}" style="#{societe.styleCouleur}"/>
                        </rich:column>
                        <rich:column label="Raison sociale ou Nom" sortable="true" sortBy="#{societe.tieraisonsocialenom}" width="300px" sortOrder="ASCENDING">
                            <f:facet name="header" ><h:outputText value="Raison sociale / Nom"/></f:facet>
                            <h:outputText value="#{societe.tieraisonsocialenom}" style="#{societe.styleCouleur}"/>&nbsp;&nbsp;
                            <h:outputText value="#{societe.tieprenom}" rendered="#{societe.tieprenom!=null}" style="#{societe.styleCouleur}"/>
                        </rich:column>
