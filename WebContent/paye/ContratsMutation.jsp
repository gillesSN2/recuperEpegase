...
<f:subview id="fichesmutation">

    <a4j:form enctype="multipart/form-data">

        <center> <h2><h:outputText value="MUTATION D'UN CONTRAT : #{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanPaye.formFicheSalarie.var_lib_contrat}" style="color:green;"/></h2></center>
        ...
        <h:panelGrid id="idPanGlobal" width="100%">
            ...
            <h:panelGrid id="FichSalarie" width="100%">
                <jsp:include flush="true" page="/paye/FicheSalarieCommun.jsp"/>
                <jsp:include flush="true" page="/paye/FicheSalarieContratMutation.jsp" />
            </h:panelGrid>
            ...
            <h:panelGroup id="panelValide">
                <center>
                    ...
                    <h:commandButton image="/images/valider_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanPaye.formFicheSalarie.saveElementContratMuter}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanPaye.formFicheSalarie.salaries.salId!=0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanPaye.formFicheSalarie.var_action!=3}" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                </center>
            </h:panelGroup>
        </h:panelGrid>
