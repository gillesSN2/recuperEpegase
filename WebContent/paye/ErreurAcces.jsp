    ...
    <h:panelGrid width="100%" border="0">
        ...
        <h:panelGrid id="p1" width="100%" >
            ...
            <center>
                ...
                <br/><br/><br/>
                <h:outputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanPaye.messageAlerte}" style="width:100%;text-align:center;font-size:20px"/>
                <br/><br/><br/><br/>
            </center>
