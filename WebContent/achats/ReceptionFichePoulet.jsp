...
<f:subview id="receptionfichepoulet">
        ...
        <a4j:form enctype="multipart/form-data">
            ...
            <h:panelGroup id="panelPage" >
                <rich:tabPanel switchType="client" immediate="true"  id="panelGlobal" style="border:0px;background-color:white;">
                        ...
                        <h:panelGrid id="panDescription" width="100%" columns="2" columnClasses="clos80,clos20">
                            <h:panelGrid id="panelEnetete" width="100%" style="background-color:#DAEECB;height:110px">
                                ...
                                <h:panelGrid id="panelContact" width="100%" columns="6" columnClasses="clos12d,clos21g,clos12d,clos21g,clos12d,clos21g">
                                    ...
                                    <h:column><h:inputText id="idObjet" style="width:100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionEnteteAchats.recObject}" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.var_aff_action}" maxlength="100"/></h:column>
                                </h:panelGrid>
                            ...
                            <h:panelGroup>
                                <div style="overflow:scroll;max-height:100%;width:100%;border:solid 0px green;">
                                    <a4j:region renderRegionOnly="false">
                                        <rich:extendedDataTable id="tableLigne" height="300px" width="140%" enableContextMenu="false" border="0" headerClass="headerTab" activeClass="active-row" noDataLabel=" " styleClass="bg" style="margin-top:10px;border:solid 0px green;cursor:pointer;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.datamodelLigne}" var="doclig">
                    ...
                    <rich:tab label="Planning" id="tabPlanning" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.visibleOnglet&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.var_acc_special}" >
                        ...
                        <h:panelGrid id="panLivraison" columns="2" columnClasses="clos20,clos80" width="100%" >
                            ...
                            <h:column><h:outputText value="Modèle planning:"/></h:column>
                            <h:column>
                                <h:selectOneMenu style="width:300px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionEnteteAchats.recLivreurNom}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.var_aff_action}">
                                    <f:selectItem itemValue="" itemLabel="Sélection modèle"/>
                                    <f:selectItems value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.mesModelesPlanning}"/>
                                    <a4j:support eventsQueue="maQueue" event="onchange" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.calculerPlanning}" reRender="tableauDetail"/>
                                </h:selectOneMenu>
                            </h:column>
                            <h:column><h:outputText value="Commentaires:"/></h:column>
                            <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionEnteteAchats.recCommentaire}" maxlength="100" size="100" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.var_aff_action}"/></h:column>
                        </h:panelGrid>
                        <div style="overflow:scroll;max-height:100%;width:100%;border:solid 0px green;">
                            <a4j:region renderRegionOnly="false">
                                <rich:extendedDataTable id="tableauDetail" enableContextMenu="false" border="0" headerClass="headerTab" activeClass="active-row" noDataLabel=" "  rowClasses="rows1,rows2,rowsd" width="120%" height="400px" styleClass="bg" style="border:solid 0px green;cursor:pointer;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.lesPlaningsAviculture}" var="detail">
    ...
    <rich:modalPanel domElementAttachment="parent"  id="panelLot" headerClass="headerPanel" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" width="850" height="450" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.showModalPanelLot}">
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.showModalPanelLot}" var="lot">
            ...
            <a4j:form id="formModalLot">
                <rich:hotKey key="return" handler="return false;"/>
                <h:panelGrid  width="100%" columns="2" columnClasses="clos30,clos70d" id="panelDetailLot">
                    ...
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionLigneAchats.recligCode} #{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionLigneAchats.recligLibelle}" readonly="true" style="width:100%"/></h:column>
                    <h:column><h:outputText value="Unité de stockage:"/></h:column>
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionLigneAchats.recligUnite}" readonly="true" style="width:100%"/></h:column>
                    <h:column><h:outputText value="Unité de Conditionnement:"/></h:column>
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.var_lib_condit}" readonly="true" style="width:100%"/></h:column>
                    <h:column><h:outputText value="Quantité:"/></h:column>
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionLotAchats.reclotQte}" readonly="true" style="text-align:right;" size="8"/></h:column>
                    <h:column><h:outputText value="N° du lot:"/></h:column>
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionLotAchats.reclotNumero}" size="8" maxlength="30"/></h:column>
                    ...
                    <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionLigneAchats.recligStock==4}"><rich:calendar value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAchats.formReceptionAchats.receptionLotAchats.reclotDateValable}" /></h:column>
