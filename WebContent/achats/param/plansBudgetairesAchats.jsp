...
<f:subview id="jcach">
    <a4j:form>
        ...
        <center> <h2><h:outputText value="LISTE DES PLANS BUDGETAIRES ACHATS" style="color:green;font-size:16px;"/></h2></center>
        ...
        <h:panelGrid  id="pnRec" width="100%">
            <h:panelGrid id="png1" columns="4"  styleClass="recherche"  width="100%" >
                ...
                <h:panelGroup rendered="#{false&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.var_annee!='0'}">
            ...
            <h:panelGrid id="btnBudget" width="250px" columns="5" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.showButtonPanel}">
                <a4j:commandButton image="/images/ajouter.png" title="Ajouter un nouveau plan" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.ajouterPoste}" reRender="panelPlanBudget,formModalPlan,panellist"/>
        ...
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.showModalPanelPlan}" var="pla">
            ...
            <a4j:form >
                <rich:tabPanel switchType="client" style="width:100%;border:0px;" id="formModalPlan">
                    ...
                    <rich:tab label="Produits (Achats)" id="panelTabProdAch"  rendered="#{(bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.choixBudget==1||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.var_aff_nature==2)&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.showOngletCompte}">
                    ...
                    <rich:tab  label="Produits (Production)" id="panelTabProdPrd" rendered="#{(bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.choixBudget==1||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.var_aff_nature==3)&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formPlansBudgetaires.showOngletCompte}">
