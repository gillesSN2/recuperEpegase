...
<rich:column sortable="false" width="10%">
    ...
    <h:outputText value="#{recu.rglNum}" title="#{recu.rglNum}"/>
</rich:column>
<rich:column sortable="false" width="10%">
    <f:facet name="header"><h:outputText  value="Type règlement"/></f:facet>
    <h:outputText  value="#{recu.rglLibTypReg}" title="#{recu.rglLibTypReg}"/>
</rich:column>
...
<rich:column sortable="false" width="10%" style="text-align:right">
    <f:facet name="header"><h:outputText  value="Dont Timbre"/></f:facet>
    <h:outputText value="#{recu.rglTimbre}" rendered="#{recu.rglTimbre!=0}">
        <jsp:include flush="true" page="/commun/formatNombreStructure.jsp"/>
    </h:outputText>
</rich:column>
<rich:column sortable="false" width="10%">
    <f:facet name="header"><h:outputText  value="N° chèque"/></f:facet>
    <h:outputText  value="#{recu.rglNumChqBdx}" title="#{recu.rglNumChqBdx}"/>
</rich:column>
