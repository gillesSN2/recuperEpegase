            ...
            <a4j:region renderRegionOnly="false">
                ...
                <rich:extendedDataTable rows="200" id="tableBien" footerClass="bard" headerClass="headerTab" styleClass="bg" activeClass="active-row" noDataLabel=" " border="0" width="100%" height="330px" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formRecherche.datamodelBiens}" var="var" activeRowKey="true" rowKeyVar="rkv" selection="#{bakingbeanepegase.menuModuleHorizontalCtrl.formRecherche.simpleSelection}" sortMode="multi" selectionMode="single" binding="#{bakingbeanepegase.menuModuleHorizontalCtrl.formRecherche.extDTable}">
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formRecherche.nature==171}" var="ids171">
                        <a4j:support eventsQueue="maQueue" event="onRowDblClick" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formSyndicImmobilier.recuperationBiens}" reRender="idSubView,idBien"/>
                    </c:if>
            ...
            <h:panelGroup id="idVal">
                <center>
                    ...
                    <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formRecherche.nature==171}" var="id171">
                        <a4j:commandButton id="idCanTiers171" image="/images/annuler_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formSyndicImmobilier.annuleBiens}" reRender="idSubView,idBien"/>&nbsp;&nbsp;&nbsp;
                        <a4j:commandButton id="idValTiers171" image="/images/valider_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formSyndicImmobilier.recuperationBiens}" reRender="idSubView,idBien" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formRecherche.selectBien}"/>
                    </c:if>
                </center>
            </h:panelGroup>
        </h:panelGrid>
