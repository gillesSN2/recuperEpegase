...
<f:subview id="actionrdv">
    <center>
        <a4j:form>

            <center> <h2><h:outputText value="PROCHAINES ACTIONS DES RDV" style="color:green;"/></h2></center>

            <h:panelGrid id="panelBtnObjet" width="200px" columns="4">
                <a4j:commandButton image="/images/ajouter.png" title="Ajout action RDV"id="AdfmtC" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formElementRdv.lanceAjouter}" reRender="panelAjoutObjet"/>
                <a4j:commandButton rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formElementRdv.btnModClient}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formElementRdv.lanceModif}" title="Modification action RDV" image="/images/modifier.png" reRender="panelModifObjet"/>
