...
<f:subview id="officeRdvMulti">

    <a4j:form>

        <center> <h2><h:outputText id="idTitre" value="Le planning du service : #{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.serviceSelectionne}" style="color:green;"/></h2></center>

        <h:panelGrid columns="2" border="0" columnClasses="top,top">

            <h:panelGrid width="200px" style="max-height:100%;">
                <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.serviceSelectionne}" style="width:200px">
                    <f:selectItems value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.lesServicesItems}"/>
                    <a4j:support eventsQueue="maQueue" event="onchange" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.selectionService}" reRender="idTableUsers,p1,idTitre"/>
                </h:selectOneMenu>
                <rich:extendedDataTable styleClass="bg" height="600px" enableContextMenu="false" id="idTableUsers" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" activeClass="active-row" noDataLabel=" " border="0" width="200px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.datamodelUsersService}" var="useSrv">
                    <a4j:support eventsQueue="maQueue" event="onRowClick" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.selectionUser}" onsubmit="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,p1"/>
                    <rich:column label="Liste des utilisateurs" sortable="false" width="180px">
                        <f:facet name="header"><h:outputText  value="Liste des utilisateurs" /></f:facet>
                        <h:outputText value="#{useSrv.usrPatronyme}"/>
                    </rich:column>
                </rich:extendedDataTable>
            </h:panelGrid>

            <h:panelGrid width="1050px" style="max-height:100%;">
                ...
                <rich:tabPanel switchType="client" immediate="true"  id="p1"  tabClass="text" width="100%" style="height:400px;margin-top:0px;border:0;">
                    ...
                    <rich:tab name="mois" label="Par Mois">
                        ...
                        <rich:dataTable  styleClass="bg" id="tableRdv1" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" border="0" width="100%" style="height:500px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.datamodelLesRdvParMois}" var="rdv">
                    ...
                    <rich:tab name="semaine" label="Par Semaine">
                        ...
                        <rich:dataTable  styleClass="bg" id="tableRdv2" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" border="0" width="100%" style="height:500px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.datamodelLesRdvParSemaine}" var="rdv" >
                    ...
                    <rich:tab name="jour" label="Par Jour">
                        ...
                        <a4j:region renderRegionOnly="false">
                            <rich:extendedDataTable  enableContextMenu="false" styleClass="bg" id="tableRdv3" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" activeClass="active-row" noDataLabel=" " border="0" width="100%" height="500px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.datamodelLesRdvParJour}" var="rdv" >
                    ...
                    <rich:tab name="parliste" label="Par Liste">
                        ...
                        <br>
                        <a4j:region renderRegionOnly="false">
                            <rich:extendedDataTable  enableContextMenu="false" styleClass="bg" id="tableRdv4" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" activeClass="active-row" noDataLabel=" " border="0" width="100%" height="495px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.datamodelRdv}" var="rdv" >
                ...
                <h:panelGrid  width="100%" id="panelRdvGrid">
                    <rich:tabPanel switchType="client" immediate="true"  id="panelGlobal" style="border:0px;background-color:white;">
                            ...
                            <h:panelGrid  width="100%" id="panelRdvGrid1" headerClass="headerTab" styleClass="panneau_accueil" >
                                <h:panelGrid style="width:100%;">
                                        ...
                                        <h:panelGrid style="width:100%;" id="idTierTier" columnClasses="clos20,clos80" columns="2" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.typeRdv!=9}">
                                            ...
                                            <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.gestionPatient}">
                                                <h:inputText id="idPatient" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvNomPat}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}" onkeypress="return scanToucheLettre(event)" style="width:100%;text-transform:uppercase">
                                                    ...
                                                    <a4j:support eventsQueue="maQueue" event="onblur" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.recherchePatients}" onsubmit="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idPatient,panelListePatients,formModalListePatients,tableHistoriqu"/>
                                                </h:inputText>
                                            </h:column>
                                        </h:panelGrid>
                                    </h:panelGroup>
                                    <h:panelGrid width="100%" columnClasses="clos20,clos80"  columns="2" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvNature!=10}">
                                        ...
                                        <h:column>
                                            <rich:calendar style="background-color:green;color:white;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvDteDe}" locale="FR" inputSize="8" enableManualInput="true" datePattern="dd/MM/yyyy"  disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.dateVerrouillee}"/>&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <h:panelGrid style="width:100%;" columnClasses="clos20,clos80" columns="2">
                                        ...
                                        <h:column>
                                            ...
                                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvSujet}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.sujetRdv}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}">
                                                <f:selectItem itemValue="pas de sujet" itemLabel=""/>
                        ...
                        <rich:tab id="tabMail" label="Contacts" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.optionTiers.ongletContact=='0'&&(bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvNature=='1'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvNature=='8')}">
                            <rich:extendedDataTable  enableContextMenu="false" styleClass="bg" id="tableContact" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" activeClass="active-row" noDataLabel=" " border="0" width="100%" height="400px" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.dataModelContacts}" var="con" >
                                ...
                                <rich:column width="20%" style="text-align:center;">
                                    <f:facet name="header" ><h:outputText value="Sélectionné" style="text-align:center;"/></f:facet>
                                    ...
                                    <h:panelGrid style="width:100%;" columnClasses="clos20,clos80" columns="2">
                                        ...
                                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.lieuxRdv}">
                                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvLieu}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}">
                                                <f:selectItem itemValue="pas de produit" itemLabel=""/>
                                        ...
                                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.budgetRdv}">
                                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvBudget}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}">
                                                <f:selectItem itemValue="pas de budget" itemLabel=""/>
                                        ...
                                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.apportRdv}">
                                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvApport}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}">
                                                <f:selectItem itemValue="pas d`apport" itemLabel=""/>
                                        ...
                                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.modeFinRdv}">
                                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvModeFin}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}">
                                                <f:selectItem itemValue="pas de mode de financement" itemLabel=""/>
                                        ...
                                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.delaisRdv}">
                                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvDelais}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}">
                                                <f:selectItem itemValue="pas de délais d`exécution" itemLabel=""/>
                                        ...
                                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.actionRdv}">
                                            ...
                                            <rich:calendar style="background-color:green;color:white;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvDateProchaine}" locale="FR" inputSize="8" datePattern="dd/MM/yyyy" enableManualInput="false" immediate="true"isDayEnabled="dayEnabledStart" dayStyleClass="disabledStyle" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}"/>
                                        </h:column>
                                    </h:panelGrid>
                                    <br>
                                    <h:panelGrid style="width:100%;" columnClasses="clos20,clos80" columns="2">
                                        ...
                                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.conclusionRdv}">
                                            <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvCr}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}">
                                                <f:selectItem itemValue="pas de conclusion" itemLabel=""/>
                                                <f:selectItems value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.lesConclusionItems}"/>
                                            </h:selectOneMenu>
                                        </h:column>
                                        <h:column rendered="#{!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.conclusionRdv}"><h:outputText value="Compte rendu:" /></h:column>
                                        <h:column rendered="#{!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.conclusionRdv}"><h:inputTextarea rows="15" cols="80" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvCr}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdvdetails}"/></h:column>
                                    </h:panelGrid>
                                </h:panelGrid>
                            </h:panelGrid>
                        </rich:tab>
                        ...
                        <rich:tab id="tabLieu" label="LOCALISATION MAPBOX" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.rdv.rdvX!=0}">
                            <a4j:support eventsQueue="maQueue" event="onlabelclick" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formPlanning.caluleMapRdv}" reRender="idLieuGps"/>
                            <h:panelGroup id="idLieuGps">
                                <h:panelGroup>
