...
<f:subview id="reunioninterneliste">

    <a4j:form>

        <center> <h2><h:outputText value="GESTION DES REUNIONS INTERNES" style="color:green;"/></h2></center>
            ...
            <div style="overflow:scroll;max-height:100%;width:100%;border:solid 0px green;">
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable style="max-height:100%" styleClass="bg" id="table" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" activeClass="active-row" noDataLabel=" " border="0" width="180%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formReunion.dataModelReunion}" var="var" activeRowKey="true" rowKeyVar="rkv" selection="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formReunion.simpleSelectionEntete}" sortMode="multi" selectionMode="single" tableState="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.configListeEntete}" binding="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formReunion.extDTable}">
                        <a4j:support eventsQueue="maQueue" event="onselectionchange" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formReunion.selectionLigne}" onsubmit="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,panelBouton"/>
                        <a4j:support eventsQueue="maQueue" event="onRowDblClick" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanOffice.formReunion.visualisationLigne}" reRender="idSubView,panelBouton"/>
                        ...
                        <rich:column label="Etat" sortable="true" sortBy="#{var.reuEtat}" width="100px" style="text-align:center;">
                        ...
                        <rich:column label="Président" sortable="true" sortBy="#{var.reuNomPresident}" width="200px">
                            <f:facet name="header"><h:outputText  value="Président"  /></f:facet>
                            <h:outputText  value="#{var.reuNomPresident}"/>
                        </rich:column>
                        <rich:column label="Secrétaire" sortable="true" sortBy="#{var.reuNomSecretaire}" width="200px">
                            <f:facet name="header"><h:outputText  value="Secrétaire"  /></f:facet>
                            <h:outputText  value="#{var.reuNomSecretaire}"/>
                        </rich:column>
