...
<f:subview id="traitedepot">

    <a4j:form>

        <center> <h2><h:outputText value="DEPOT MENSUEL : #{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.var_intitule} Période du #{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.dte1Affichage} au #{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.dte2Affichage}" style="color:green;"/></h2></center>
        <br>
        <center>
            <h:outputText value="DEPOT DEPOT : "/>
            <rich:calendar inputSize="8" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.dateDepot}"  datePattern="dd-MM-yyyy" locale="fr" style=" background-color:white;" />&nbsp;&nbsp;&nbsp;
            <h:outputText value="N° BORDEREAU: "/>
            <h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.var_bordereau}"/>
        </center>
        <br>
        <center>
        ...
        <h:panelGroup id="prgtpAjt">
            <br><br>
            <center>
                <h:commandButton image="/images/annuler_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.retourDepotMensuel}"  />&nbsp;&nbsp;
                <h:commandButton image="/images/valider_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.validerDepotMensuel}" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
            </center>
        </h:panelGroup>
