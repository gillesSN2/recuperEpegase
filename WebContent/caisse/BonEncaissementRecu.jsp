...
<f:subview id="subdevajout">
    ...
    <center>
        <a4j:form>
            ...
            <center> <h2><h:outputText value="RECU BON D'ENCAISSEMENT" style="color:green;"/></h2></center>
            ...
            <h:panelGrid id="idEncais" style="background-color:white;" width="100%">
                <h:panelGrid id="idEncais1" width="100%" columns="4" columnClasses="clos15,clos35,clos15,clos35">
                    ...
                    <h:column></h:column>
                    <h:column></h:column>
                    <h:column><h:outputText value="Déposit d'argent ?:" style="color:red" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.bonEncaissementVente.bonNatRef!=28}"/></h:column>
                    <h:column><h:selectBooleanCheckbox value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.bonEncaissementVente.bonGarde}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.bonEncaissementVente.bonNatRef!=28}"/></h:column>
                </h:panelGrid>
