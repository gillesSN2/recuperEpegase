    ...
    <a4j:form>
        ...
        <h:panelGrid id="idPanGlobal" width="100%">
            <h:panelGrid id="firstGrid" styleClass="fichefournisseur" width="100%" columns="4" columnClasses="clos15,clos35,clos15,clos35">
                ...
                <h:column><h:outputText value="Date contrat:"/></h:column>
                <h:column><rich:calendar value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtDateContrat}"  enableManualInput="true" datePattern="dd/MM/yyyy"  locale="fr" style=" background-color:white;"  inputSize="8"  disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.var_action==3}"/></h:column>
                ...
                <h:column><h:outputText value="Durée location:"/></h:column>
                <h:column>
                ...
                <h:column><h:outputText value="Référence bateau:"/></h:column>
                <h:column><h:inputText style="width:95%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtBateau}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.var_action==3}"/></h:column>
            </h:panelGrid>
            <br>
                ...
                <rich:tab label="Montant">
                    <h:panelGrid id="panelDevise" width="100%">
                        ...
                        <h:panelGrid id="idDeviseDevise" columns="6" rendered="#{!bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.deviseLocale}" styleClass="fichefournisseur">
                            ...
                            <h:column><h:outputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtNbMoisEcheanceGene} traites de (#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtDevise}):"/></h:column>
                            <h:column>
                                <h:inputText style="width:95%;text-align:right;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtMontantGene}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.var_action==3}">
                                    <f:convertNumber groupingUsed="true" locale="FR" minFractionDigits="2" maxFractionDigits="2"/>
                                    <a4j:support event="onblur" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.calculMontant}" reRender="panelDevise,tableEcheance"/>
                                </h:inputText>
                            </h:column>
                            <h:column><h:outputText value="1 traite de (#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtDevise}):"/></h:column>
                            <h:column>
                                <h:inputText style="width:95%;text-align:right;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtMontantFinal}" disabled="true">
                                    <f:convertNumber groupingUsed="true" locale="FR" minFractionDigits="2" maxFractionDigits="2"/>
                                </h:inputText>
                            </h:column>
                        ...
                        <h:panelGrid id="idDeviselocale" columns="6" styleClass="fichefournisseur1">
                            ...
                            <h:column><h:outputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtNbMoisEcheanceGene} traites de (#{bakingbeanepegase.menuModuleHorizontalCtrl.structureLog.strdevise}):"/></h:column>
                            <h:column>
                                <h:inputText style="width:95%;text-align:right;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtMontantGeneLocal}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.var_action==3}">
                                    <jsp:include flush="true" page="/commun/formatNombreStructure.jsp"/>
                                    <a4j:support event="onblur" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.calculMontant}" reRender="panelDevise,tableEcheance"/>
                                </h:inputText>
                            </h:column>
                            <h:column><h:outputText value="1 traite de (#{bakingbeanepegase.menuModuleHorizontalCtrl.structureLog.strdevise}):"/></h:column>
                            <h:column>
                                <h:inputText style="width:95%;text-align:right;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.traiteEntete.trtMontantFinalLocal}" disabled="true">
                                    <jsp:include flush="true" page="/commun/formatNombreStructure.jsp"/>
                                </h:inputText>
                            </h:column>
                    ...
                    <a4j:region renderRegionOnly="false">
                        <rich:extendedDataTable enableContextMenu="false" id="tableEcheance" headerClass="headerTab"  activeClass="active-row" noDataLabel=" " rowClasses="rows1,rows2,rowsd" footerClass="bard" width="100%" height="300px" styleClass="bg" style="border:solid 0px green;text-align:left;" border="0" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formTraite.dataModelEcheance}" var="det">
                            ...
                            <rich:column label="Montant" sortable="false" style="text-align:right;">
                                ...
                                <h:outputText  value="#{det.trtligMontantLocal}" rendered="#{det.trtligMontantLocal!=0}">
                                    <jsp:include flush="true" page="/commun/formatNombreStructure.jsp"/>
                                </h:outputText>
                            </rich:column>
