...
<rich:column label="Jour" width="70px" sortable="true" sortBy="#{table.rglDateReg} #{table.rglNum}" sortOrder="DESCENDING">
    <f:facet name="header"><h:outputText  value="Date"/></f:facet>
    <h:outputText value="#{table.rglDateReg}" style="color:#{table.couleur};" title="#{table.rglDateReg}">
        <f:convertDateTime pattern="dd/MM/yy"/>
    </h:outputText>
</rich:column>
<rich:column label="N° de pièce"  width="120px"  sortable="true" sortBy="#{table.rglNum}">
...
<rich:column label="Selection"  width="50px"  sortable="true" sortBy="#{table.sel_ecriture}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.usersLog.usrid==1}">
    <f:facet name="header"><h:outputText value="Sel." /></f:facet>
    <h:selectBooleanCheckbox value="#{table.sel_ecriture}" style="color:#{table.couleur}">
        <a4j:support event="onclick" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formJournauxCaisse.soldeCorrection}" reRender="idSoldeCorrection"/>
...
<rich:column label="Numéro d'origine" sortable="true" sortBy="#{table.rglDocument}" >
    ...
    <h:outputText value="#{table.rglDocument}" style="color:#{table.couleur}" rendered="#{table.rglDocument!='NULL'}" title="#{table.rglDocument}"/>
</rich:column>
