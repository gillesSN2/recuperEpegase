...
<f:subview id="subdevajout">
    ...
    <center>
        <a4j:form>
            ...
            <center> <h2><h:outputText value="RECU BON D'ENCAISSEMENT ELEVES" style="color:green;"/></h2></center>
            ...
            <h:panelGrid id="idEncais" style="background-color:white;" width="100%">
                ...
                <h:panelGrid id="idEncais3" width="100%" columns="4" columnClasses="clos15,clos35,clos15,clos35" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.var_affiche_lettreGarantie}">
                    ...
                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.bonEncaissementVente.bonLettreGarantie}" maxlength="50" style="width:100%;text-align:center;"/></h:column>
