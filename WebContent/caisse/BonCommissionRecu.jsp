...
<f:subview id="subdevajout">
    ...
    <center>
        <a4j:form>
            ...
            <center> <h2><h:outputText value="RECU BON DE PAIEMENT COMMISSION" style="color:green;"/></h2></center>
            ...
            <h:panelGrid styleClass="fichefournisseur" width="100%" columns="4" columnClasses="clos15,clos35,clos15,clos35">
                ...
                <h:column><h:inputText style="width:100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.bonEncaissementVente.var_lib_nat}" disabled="true"/></h:column>
                ...
                <h:column><h:outputText value="Nom responsable/commercial:"/></h:column>
                ...
                <h:panelGrid width="100%" columns="2" columnClasses="clos15,clos35" id="idCaisseSelect">
                    ...
                    <h:column>
                        <h:selectOneMenu style="width:100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.var_caisse}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.formRegCaisse.var_verrou_caisse}">
                            ...
                            <f:selectItems value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanCaisse.mesCaissesRecetteItems}"/>
