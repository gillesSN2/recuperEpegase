...
<f:subview id="selectperiode">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="Si BL TTC <> Facture TTC et Facture non lettrées, alors récuperer lignes BL" style="color:green;"/></h2></center>
        ...
        <h:panelGroup id="panelBoutonTrf">
            <center>
                ...
                <h:commandButton id="idValide" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.factureZeroRecupBlDocumentVente}" value="Reclacul BL TTC <> Facture TTC" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="if (!confirm('Etes-vous sur de vouloir exécuter cette opération ?')) return false;javascript:Richfaces.showModalPanel('panelBarProg');"/>
            </center>
        </h:panelGroup>
