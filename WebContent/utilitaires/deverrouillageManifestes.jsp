...
<f:subview id="deverrouManisfeste">

    <a4j:form>

        <center> <h2><h:outputText value="DEVERROUILLAGE DES MANISFESTES OU DOSSIERS" style="color:green;"/></h2></center>
        ...
        <h:panelGrid  columns="1" width="100%">
            <h:panelGrid id="panCtrl"  styleClass="recherche" width="100%">
                <h:panelGrid columns="7" width="100%">
                    ...
                    <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.rechercherDeverrouilleManifeste}" value="Rechercher" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                </h:panelGrid>
            </h:panelGrid>
            <br>
