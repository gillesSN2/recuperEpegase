...
<f:subview id="supbulsal">

    <a4j:form>

        <center> <h2><h:outputText value="SUPPRESSION BULLETINS DE SALAIRE" style="color:green;"/></h2></center>
