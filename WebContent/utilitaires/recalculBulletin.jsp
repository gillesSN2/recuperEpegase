...
<f:subview id="reclculbulsal">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="RECALCUL BULLETINS DE SALAIRE" style="color:green;"/></h2></center>
