...
<f:subview id="annultrfach">

    <a4j:form>

        <center> <h2><h:outputText value="ANNULATION TRANSFERT DES ACHATS" style="color:green;"/></h2></center>
        ...
        <h:panelGrid  columns="1" width="100%">
            <h:panelGrid id="panCtrl"  styleClass="recherche" width="100%">
                <h:panelGrid columns="7" width="100%">
                    ...
                    <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.toutSelectionAnnulTrfAchats}" value="Tout Sél." style="color:white;background-color:green;" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                    <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.rienSelectionAnnulTrfAchats}" value="Rien Sél." style="color:white;background-color:green;" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                    <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.rechercherAnnulTrfAchats}" value="Rechercher" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                </h:panelGrid>
            </h:panelGrid>
            <br>
        ...
        <h:panelGroup id="panelBoutonTrf">
            <center>
                ...
                <h:commandButton id="idValide" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.annulTrfAchats}" value="Annulation transfert des achats" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="if (!confirm('Etes-vous sur de vouloir exécuter cette opération ?')) return false;javascript:Richfaces.showModalPanel('modAttente');"/>
            </center>
        </h:panelGroup>
