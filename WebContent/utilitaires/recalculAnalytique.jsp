...
<f:subview id="selectperiode">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="RECALCUL ECRITURE ANALYTIQUE" style="color:green;"/></h2></center>
        ...
        <h:panelGrid  columns="1" width="100%">
            ...
            <h:panelGrid width="100%">
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable rows="300" border="0" width="100%" noDataLabel=" " styleClass="bg" headerClass="headerTab" style="max-height:100%;border:solid 0px green;" id="tableExtrait" selectedClass="active-row" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.dataModelEcrituresPB}" var="table" rowClasses="rows1,rows2,rowsd">
        ...
        <h:panelGroup id="panelBoutonTrf">
            <center>
                ...
                <h:commandButton id="idValide" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.recalculAnalytique}" value="Recalcul des écritures analytiques" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:200px;" onclick="if (!confirm('Etes-vous sur de vouloir exécuter cette opération ?')) return false;javascript:Richfaces.showModalPanel('panelBarProg');"/>
            </center>
        </h:panelGroup>
