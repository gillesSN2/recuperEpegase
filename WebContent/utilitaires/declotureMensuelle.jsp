...
<f:subview id="selectperiode">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="DE-CLOTURE MENSUELLE DES JOURNAUX COMPTABLES" style="color:green;"/></h2></center>
