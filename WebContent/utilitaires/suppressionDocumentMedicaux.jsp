...
<f:subview id="selectperiode">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="SUPPRESSION DOCUMENTS MEDICAUX" style="color:green;"/></h2></center>
            ...
            <h:panelGrid id="panCtrl"  styleClass="recherche" width="100%">
                ...
                <h:panelGrid width="100%">
                    <h:panelGrid columns="2" width="40%" style="margin-left:400px">
                        ...
                        <h:column><h:outputText value="Consultation"/></h:column>
                        ...
                        <h:column><h:outputText value="Pharmacie"/></h:column>
                        ...
                        <h:column><h:outputText value="ReFacturation Tiers"/></h:column>
                        ...
                        <h:column><h:outputText value="Facture externe"/></h:column>
        ...
        <h:panelGroup id="panelBoutonTrf">
            <center>
                ...
                <h:commandButton id="idValide" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.suppressionDocumentMedicaux}" value="Suppression doc. Médicaux" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="if (!confirm('Etes-vous sur de vouloir exécuter cette opération ?')) return false;javascript:Richfaces.showModalPanel('panelBarProg');"/>
            </center>
        </h:panelGroup>
