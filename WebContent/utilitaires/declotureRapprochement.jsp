...
<f:subview id="supecr">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="DECLOTURE DES RAPPROCHEMENTS BANCAIRES" style="color:green;"/></h2></center>
        ...
        <h:panelGroup id="panelBoutonTrf">
            <center>
                ...
                <h:commandButton id="idValide" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.declotureRapprochement}" value="Décloture des rapprochements bancaires" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:200px;" onclick="if (!confirm('Etes-vous sur de vouloir exécuter cette opération ?')) return false;javascript:Richfaces.showModalPanel('panelBarProg');"/>
            </center>
        </h:panelGroup>
