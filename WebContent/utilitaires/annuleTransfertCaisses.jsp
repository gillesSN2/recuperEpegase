...
<f:subview id="annultrfcai">

    <a4j:form>

        <center> <h2><h:outputText value="ANNULATION TRANSFERT DES CAISSES" style="color:green;"/></h2></center>
        ...
        <h:panelGroup id="panelBoutonTrf">
            <center>
                ...
                <h:commandButton id="idValide" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.annulTrfCaisses}" value="Annulation transfert des caisses" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="if (!confirm('Etes-vous sur de vouloir exécuter cette opération ?')) return false;javascript:Richfaces.showModalPanel('modAttente');"/>
            </center>
        </h:panelGroup>
