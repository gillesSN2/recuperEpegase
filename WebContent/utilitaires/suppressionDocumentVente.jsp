...
<f:subview id="selectperiode">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="SUPPRESSION DOCUMENTS VENTES" style="color:green;"/></h2></center>
            ...
            <h:panelGrid id="panCtrl"  styleClass="recherche" width="100%">
                ...
                <h:panelGrid width="100%">
                    <h:panelGrid columns="2" width="40%" style="margin-left:400px">
                        ...
                        <h:column><h:outputText value="Bon de commande"/></h:column>
                        ...
                        <h:column><h:outputText value="Facture interne"/></h:column>
                        ...
                        <h:column><h:selectBooleanCheckbox value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.sup_chargement}"/></h:column>
                        <h:column><h:outputText value="Chargement"/></h:column>
                        <h:column><h:selectBooleanCheckbox value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.sup_ticket}"/></h:column>
                        <h:column><h:outputText value="Ticket"/></h:column>
                    </h:panelGrid>
                </h:panelGrid>
            </h:panelGrid>
        </h:panelGrid>
        ...
        <h:panelGroup id="panelBoutonTrf">
            <center>
                ...
                <h:commandButton id="idValide" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.suppressionDocumentVente}" value="Suppression doc. Ventes" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="if (!confirm('Etes-vous sur de vouloir exécuter cette opération ?')) return false;javascript:Richfaces.showModalPanel('panelBarProg');"/>
            </center>
        </h:panelGroup>
