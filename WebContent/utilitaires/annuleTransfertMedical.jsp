...
<f:subview id="annultrfvte">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="ANNULATION TRANSFERT DU MEDICAL" style="color:green;"/></h2></center>
        ...
        <h:panelGrid  columns="1" width="100%">
            <h:panelGrid id="panCtrl"  styleClass="recherche" width="100%">
                <h:panelGrid columns="7" width="100%">
                    ...
                    <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.toutSelectionAnnulTrfMedical}" value="Tout Sél." style="color:white;background-color:green;" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                    <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.rienSelectionAnnulTrfMedical}" value="Rien Sél." style="color:white;background-color:green;" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                    <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.rechercherAnnulTrfMedical}" value="Rechercher" style="color:white;background-color:green;margin:3px 3px 3px 3px;width:250px;" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                </h:panelGrid>
            </h:panelGrid>
            <br>
            <h:panelGrid id="listRecherche" width="100%">
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable rows="100" style="max-height:100%" styleClass="bg" id="table" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" activeClass="active-row" noDataLabel=" " border="0" width="100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formUtilitaires.dataModelDocumentEntete}" var="doc">
                        ...
                        <rich:column label="Total HT ou part tiers" sortable="true" sortBy="#{doc.docTotHt}" width="10%" style="text-align:right;">
                            <f:facet name="header"><h:outputText  value="P1" /></f:facet>
                            <h:outputText value="#{doc.docTotHt}" rendered="#{doc.docTotHt!=0}">
                                <jsp:include flush="true" page="/commun/formatNombreStructure.jsp"/>
                            </h:outputText>
                        </rich:column>
                        <rich:column label="Total TVA ou part patient" sortable="true" sortBy="#{doc.docTotTva}" width="10%" style="text-align:right;">
                            <f:facet name="header"><h:outputText  value="P2" /></f:facet>
