...
<f:subview id="reclculbulsalInfo">

    <a4j:form>

        <center> <h2><h:outputText value="RECOPIE INFORMATONS SALARIES DANS BULLETINS DE SALAIRE" style="color:green;"/></h2></center>
