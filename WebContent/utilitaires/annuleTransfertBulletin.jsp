...
<f:subview id="annultrfpaye">

    <a4j:form>

        <center> <h2><h:outputText value="ANNULATION TRANSFERT DES BULLETINS DE SALAIRE" style="color:green;"/></h2></center>
