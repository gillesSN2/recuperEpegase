...
<f:subview id="taxvte">
    ...
    <a4j:form>
        ...
        <center> <h2><h:outputText value="LISTE DES TAXES VENTES" style="color:green;"/></h2></center>
    ...
    <rich:modalPanel domElementAttachment="parent"  id="panelAjt" width="500" height="450" headerClass="headerPanel" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formTaxesVentes.showModalPanel}">
                ...
                <h:panelGrid  columns="2" style="width:100%;" columnClasses="clos30,clos70d">
                    ...
                    <h:column>
                        <h:selectOneMenu  style="width:300px;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formTaxesVentes.taxesVentes.taxvteType}">
                            ...
                            <f:selectItem itemLabel="PRECOMPTE (BRS)" itemValue="2"/>
                            <f:selectItem itemLabel="PRECOMPTE (TPS)" itemValue="3"/>
                        </h:selectOneMenu>
                    </h:column>
                    ...
                    <h:column>
                        <h:selectOneMenu  style="width:300px;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formTaxesVentes.taxesVentes.taxvteTc}"  >
                            ...
                            <f:selectItem itemLabel="Centimes additionnels (sur le HT et assujetti à la TVA)" itemValue="1"/>
                            <f:selectItem itemLabel="Taxe d'égalisation (sur le HT et assujetti à la TVA)" itemValue="2"/>
                            <f:selectItem itemLabel="Taxe des ordures ménagères (sur le HT et assujetti à la TVA)" itemValue="3"/>
                            <f:selectItem itemLabel="Taxe d'enregistrement (sur le HT et assujetti à la TVA)" itemValue="4"/>
                            <f:selectItem itemLabel="I.R.P.P. (sur le HT assujetti à la TVA)" itemValue="5"/>
                            <f:selectItem itemLabel="AIRSI (sur le TTC)" itemValue="6"/>
                            <f:selectItem itemLabel="C.S.S. (sur le HT mais non assujetti à la TVA)" itemValue="7"/>
