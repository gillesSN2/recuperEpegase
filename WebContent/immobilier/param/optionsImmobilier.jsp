...
<f:subview id="configImmobilier">

    <a4j:form id="form1" >

        <center> <h2><h:outputText value="OPTIONS DE L'IMMOBILIER" style="color:green;"/></h2></center>

        <center>
            <rich:tabPanel switchType="client" immediate="true"  style="border:0px;" id="idPanelOption">

                <rich:tab label="Gérance/Syndic">
                ...
                <rich:tab label="Bail locatif">
                    <h:panelGrid  columns="2"  columnClasses="clos20,clos60g" width="100%" >
                        <h:column><h:outputText value ="Affichage dans la fiche tiers:" /></h:column>
                        <h:column>
                            <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.affichInTierFilBLC}" style="width:200px;">
                        ...
                        <h:column><h:outputText value="Affichage dans la vue globale:"   /></h:column>
                        <h:column>
                            <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.affichInGlobViewBLC}" style="width:200px;" >
                                <f:selectItem itemLabel="Toutes les années" itemValue="0"/>
                                <f:selectItem itemLabel="Année en cours" itemValue="1"/>
                            </h:selectOneMenu>
                        </h:column>
                ...
                <rich:tab label="Factures locations">
                    ...
                    <rich:tab label="Ordre de Travail">
                        <h:panelGrid  columns="2"  columnClasses="clos20,clos60g" width="100%" >
                            <h:column><h:outputText value ="Affichage dans la fiche tiers:" /></h:column>
                            <h:column>
                ...
                <rich:tab label="Factures charges">
                    <h:panelGrid  columns="4" columnClasses="clos25,clos25g,clos25,clos25g" width="100%">
                        <h:column><h:outputText value="Nombre jours de relance:"/></h:column>
                        <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.nbrJrRelanceBESOIN}" style="width:50px;"/></h:column>
                        <h:column><h:outputText value="Nombre jour de validité:"/></h:column>
                        <h:column><h:inputText  value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.nbrJrValidBESOIN}" style="width:50px;"/></h:column>
                    </h:panelGrid>
                    <h:panelGrid  columns="2"  columnClasses="clos20,clos60g" width="100%" >
                        <h:column><h:outputText value ="Affichage dans la fiche tiers:" /></h:column>
                        <h:column>
                ...
                <rich:tab label="Appel de charges">
                    <h:panelGrid  columns="4" columnClasses="clos25,clos25g,clos25,clos25g" width="100%">
                        <h:column><h:outputText value="Nombre jours de relance:"/></h:column>
                ...
                <rich:tab label="Divers">
                    ...
                    <h:panelGrid  width="100%" style="background-color:white;" columns="2"  columnClasses="clos20,clos60g">
                        ...
                        <h:outputText value = "Code TOM par défaut:"/>
                        <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.tomDefaut}" style="width:300px;">
                        ...
                        <h:outputText value = "Code TLV par défaut:"/>
                        <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.tlvDefaut}" style="width:300px;">
                            <f:selectItem itemLabel="Sans code" itemValue="" />
                            <f:selectItems value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.mesTvaItem}"/>
                        </h:selectOneMenu>
                    ...
                    <center>
                        <h:panelGrid columns="2">
                            ...
                            <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.zoneLibelle}" style="width:300px;">
                                ...
                                <f:selectItem itemLabel="Loyer + mois paye + Nom locataire (pour les factures locations)" itemValue="4"/>
                            </h:selectOneMenu>
