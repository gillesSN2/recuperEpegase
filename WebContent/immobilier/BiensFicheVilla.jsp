...
<f:subview id="ficheVilla">

    <a4j:form>
        <rich:hotKey key="return" handler="return false;"/>

        <center> <h2><h:outputText value="DESCRIPTION VILLA" style="color:green;"/></h2></center>
        ...
        <h:panelGroup id="panelPage" >
            ...
            <rich:tabPanel switchType="client" immediate="true" id="panelGlobal" style="border:0px;background-color:white;">
                    ...
                    <h:panelGrid width="100%" id="idFiche" styleClass="fichefournisseur" columns="4" columnClasses="clos15,clos35,clos15,clos35">
                        ...
                        <h:column>
                            <h:selectOneMenu style="border:0px;color:red;width:100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formBiensImmobilier.categorieReelle}" disabled="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formBiensImmobilier.var_action>=20}">
                                ...
                                <a4j:support eventsQueue="maQueue" event="onchange" reRender="idFiche"/>
                            </h:selectOneMenu>
                        </h:column>
                ...
                <rich:tab id="tabBaux" label="Baux" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formBiensImmobilier.categorieModule!=3}">
                    <jsp:include flush="true" page="/immobilier/BiensCommun.jsp" />
                    <jsp:include flush="true" page="/immobilier/BiensCommunBaux.jsp" />
                </rich:tab>

                <rich:tab id="tabGerance" label="Gérances" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formBiensImmobilier.categorieModule!=3}">
                    <jsp:include flush="true" page="/immobilier/BiensCommun.jsp" />
                    <jsp:include flush="true" page="/immobilier/BiensCommunGerances.jsp" />
                </rich:tab>

                <rich:tab id="tabTravaux" label="Travaux" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formBiensImmobilier.categorieModule!=3}">
                    <jsp:include flush="true" page="/immobilier/BiensCommun.jsp" />
                    <jsp:include flush="true" page="/immobilier/BiensCommunTravaux.jsp" />
                </rich:tab>

                <rich:tab id="tabContrat" label="Contrat" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formBiensImmobilier.categorieModule==3}">
                    <jsp:include flush="true" page="/immobilier/BiensCommun.jsp" />
                    <jsp:include flush="true" page="/immobilier/BiensCommunContrat.jsp" />
                </rich:tab>
