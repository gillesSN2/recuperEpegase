...
<c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier!=null&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formTravauxImmobilier!=null}" var="trvsyn">

    <c:choose>

        <c:when test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formTravauxImmobilier.var_action==1||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formTravauxImmobilier.var_action==21}" >
            <jsp:include flush="true" page="/immobilier/TravauxFiche.jsp" />
        </c:when>
        ...
        <c:when test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanImmobilier.formTravauxImmobilier.var_action==19}" >
            <jsp:include flush="true" page="/immobilier/TravauxPlanning.jsp" />
        </c:when>

        <c:otherwise><jsp:include flush="true" page="/immobilier/TravauxListe.jsp" /></c:otherwise>
