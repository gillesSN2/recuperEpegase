...
<f:subview id="helpDesk">
    ...
    <a4j:form id="formHelpDesk">
        ...
        <center>
            <h2>
                <h:outputText value="H E L P - D E S K  (UTILISATEURS)" style="color:green;font-size:16px;"/>&nbsp;&nbsp;&nbsp;
                <h:panelGroup>
                    <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.var_etatTicket}">
                        ...
                        <a4j:support eventsQueue="maQueue" event="onchange" reRender="formHelpDesk,table,scrollTable,modAttente" onsubmit="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.rechercheTicketsByStructure}"/>
                    </h:selectOneMenu>
                </h:panelGroup>
            </h2>
        </center>
        ...
        <center>
            <h:panelGrid id="butt" columns="4" width="200px">
                <a4j:commandButton title="Ajouter un nouveau ticket" image="/images/ajouter.png"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.ajouterTicket}" reRender="panelTicket,panelGestionTicket"/>
                <a4j:commandButton title="Modifier/Consulter le ticket sélectionné" image="/images/modifier.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.var_afficheBouton}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.modifierTicket}" reRender="panelTicket,panelGestionTicket"/>
                <a4j:commandButton title="Supprimer le ticket sélectionné" image="/images/supprimer.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.var_afficheBouton}" onclick="if (!confirm('Etes vous sur de vouloir supprimer cet élément?')) return false" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.supprimerTicket}" reRender="butt,table"/>
        ...
        <h:panelGrid id="pgrd2" style="width:100%;max-height:100%;">
            <a4j:region renderRegionOnly="false">
                ...
                <rich:extendedDataTable rows="200" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.dataModelPegTicket}" var="tic" id="table" border="0" styleClass="bg" style="max-height:100%;border:solid 1px green" width="100%" footerClass="bard" headerClass="headerTab" rowClasses="rows1,rows2,rowsd" noDataLabel=" " selectedClass="active-row">
                    ...
                    <rich:column width="30%" sortable="true" sortBy="#{tic.pegticObject}">
                        ...
                        <rich:tabPanel switchType="client" immediate="true" style="border:0px">
                            ...
                            <rich:tab label="Demande">
                                ...
                                <h:panelGrid id="panDemande" columns="4" columnClasses="clos15,clos35,clos15,clos35" style="width:100%;">
                                    ...
                                    <h:column>
                                        <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticType}" style="width:100%;" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}">
                                            ...
                                            <a4j:support eventsQueue="maQueue" event="onchange" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.verificationValidation}" reRender="buttonValid,panelGestionTicket"/>
                                        </h:selectOneMenu>
                                    </h:column>
                                    <h:column><h:outputText value="Mode:"/></h:column>
                                    <h:column>
                                        <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticMode}" style="width:100%;" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}">
                                    ...
                                    <h:column>
                                        <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticModule}" style="width:100%;" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}">
                                    ...
                                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticSousModule}" style="width:100%;" maxlength="100" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}"/></h:column>
                                    <h:column><h:outputText value="Référence écran:"/></h:column>
                                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEcran}" style="width:100%;" maxlength="100" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}"/></h:column>
                                    <h:column><h:outputText value="Référence état:"/></h:column>
                                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticModele}" style="width:100%;" maxlength="100" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}"/></h:column>
                                    <h:column><h:outputText value="Objet:"/></h:column>
                                    <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticObject}" style="width:100%;" maxlength="100" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}"/></h:column>
                                    <h:column><h:outputText value="Invervenant:"/></h:column>
                                    <h:column>
                                        <h:selectOneMenu id="idIntervenant" style="width:100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticIdIntervenant}" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}">
                            ...
                            <rich:tab label="Problème/Question">
                                ...
                                <h:panelGrid id="txt1" width="100%" style="height:300;border:0px solid green" >
                                    <h:inputTextarea id="elm1" rows="20" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticProbleme}" style="width:100%" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}"/>
                                </h:panelGrid>
                            </rich:tab>
                            ...
                            <rich:tab label="Suggestion">
                                ...
                                <h:panelGrid id="txt2" width="100%" style="height:300;border:0px solid green" >
                                    <h:inputTextarea id="elm2" rows="20" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticSuggestion}" style="width:100%" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}"/>
                                </h:panelGrid>
                            </rich:tab>
                            ...
                            <rich:tab label="Réponse" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat!=0}">
                                ...
                                <h:column><rich:calendar value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticDateReponse}" inputSize="8"  enableManualInput="true" datePattern="dd/MM/yyyy"  locale="fr" style=" background-color:white;"  readonly="true" disabled="true"/></h:column>
                                <h:column><h:outputText value="Etat ticket:"/></h:column>
                                <h:column>
                                    <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticEtat}" style="width:200px;" readonly="true" disabled="true">
                                ...
                                <h:panelGrid id="txt3" width="100%" style="height:300;border:0px solid green" >
                                    <h:inputTextarea id="elm3" rows="20" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formHelpDesk.pegTicket.pegticReponse}" style="width:100%" readonly="true" disabled="true"/>
                                </h:panelGrid>
                            </rich:tab>
