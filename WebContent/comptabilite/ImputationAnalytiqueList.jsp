...
<f:subview  id="ia">
    ...
    <center> <h2><h:outputText value="IMPUTATION ANALYTIQUE/BUDGETAIRE DES JOURNAUX COMPTABLES" styleClass="titre"/></h2></center>
