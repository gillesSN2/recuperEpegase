...
<c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite!=null&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois!=null}" var="brj">
    ...
    <c:choose>
        ...
        <c:when test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_action>=1&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_action<=3}">
            <jsp:include flush="true" page="/comptabilite/BrouillardsJourFiche.jsp" />
        </c:when>
        ...
        <c:otherwise><jsp:include flush="true" page="/comptabilite/BrouillardsJourList.jsp" /></c:otherwise>
