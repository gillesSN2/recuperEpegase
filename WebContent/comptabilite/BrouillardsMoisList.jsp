...
<f:subview id="SaisieBrouillardM">

    <a4j:form >

        <center> <h2><h:outputText value="SAISIE DES BROUILLARDS (MENSUEL)" styleClass="titre"/></h2></center>
        ...
        <h:panelGrid id="panelGlobal" width="100%" >
            <h:panelGrid id="panelRecherche" columns="5"  styleClass="recherche" width="100%" >
                <h:selectOneMenu value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.code}" style="width:180px;" >
                    ...
                    <a4j:support eventsQueue="maQueue" event="onchange" reRender="panelGlobal,idPeriode,panelRecherche,panelBouton,tableEcriture,panelSolde,scrollTable" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.chargerLesPeriodesJournal}"/>
                </h:selectOneMenu>
                <h:selectOneMenu id="idPeriode" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.periode}" style="width:150x;" >
                    ...
                    <a4j:support eventsQueue="maQueue" event="onchange" reRender="panelGlobal,panelRecherche,panelBouton,tableEcriture,panelSolde,scrollTable" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.razBrouillard}"/>
                </h:selectOneMenu>
                ...
                <a4j:commandButton id="idValRecherche" value="RECHERCHER" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.chargerLesBrouillardsMois}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,panelGlobal,panelBouton,scrollTable,tableEcriture"/>
        ...
        <a4j:region renderRegionOnly="false">
            ...
            <rich:extendedDataTable rows="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_nb_max}" id="tableEcriture" width="100%" styleClass="bg" border="0" headerClass="headerTab" activeClass="active-row" noDataLabel=" " style="max-height:100%;border:solid 0px green;cursor:pointer;" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.dataModelLesBrouillards}" var="brouillard" tableState="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.configListeEntete}">
                ...
                <rich:column  width="10%"  sortable="true" sortBy="#{brouillard.broNum}" sortOrder="ASCENDING">
                    ...
                    <h:outputText value="#{brouillard.broNum}" title="#{brouillard.broNum}"/>
                </rich:column>
    ...
    <rich:modalPanel domElementAttachment="parent"  id="panelValidation" width="400" height="400" headerClass="headerPanel" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.showModalPanelValidation}">
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.showModalPanelValidation}" var="val">
            ...
            <a4j:form id="formValidation">
                ...
                <center>
                    <h:panelGroup >
                        <a4j:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.saveValidationLignes}" image="/images/valider_big.png" styleClass="hidelink" reRender="panelValidation,tableEcriture,scrollTable"/>
                    </h:panelGroup>
                </center>
            </a4j:form>
        </c:if>
    ...
    <rich:modalPanel domElementAttachment="parent"  id="panelPiece" width="400" height="200" headerClass="headerPanel" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.showModalPanelPiece}">
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.showModalPanelPiece}" var="pic">
            ...
            <a4j:form id="formPiece">
                ...
                <center>
                    <h:panelGroup >
                        <a4j:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.valideNumPiece}" image="/images/valider_big.png" styleClass="hidelink" reRender="panelPiece,tableEcriture,scrollTable"/>
                    </h:panelGroup>
                </center>
            </a4j:form>
        </c:if>
