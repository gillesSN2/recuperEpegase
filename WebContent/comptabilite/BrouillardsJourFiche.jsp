...
<f:subview id="sbJour">
    ...
    <a4j:form id="formsb">
        ...
        <h:panelGrid width="100%" id="pnGlob">
            <h:panelGrid columns="2" width="100%" columnClasses="clos70d,clos30">
                <h:panelGrid id="png1"styleClass="fichefournisseur1" style="height:135px;" headerClass="headerTab" width="100%" >
                    ...
                    <h:panelGrid columns="6" width="100%" columnClasses="clos12d,clos21g,clos12d,clos21g,clos12d,clos21g">
                        ...
                        <h:column>
                            <h:selectOneMenu tabindex="1" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.brouillard.broJour}" style="width:50px;" disabled="true" >
                        ...
                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.optionComptabilite.testRef1Piece}"><h:inputText tabindex="2" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.brouillard.broReference1}" style="width:100%" maxlength="20" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_action==3}"/></h:column>
                        ...
                        <h:column rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.optionComptabilite.testRef2Piece}"><h:inputText tabindex="3" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.brouillard.broReference2}" style="width:100%" maxlength="20" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_action==3}"/></h:column>
                    ...
                    <h:panelGrid columns="2" width="100%" columnClasses="clos12d,clos88">
                        ...
                        <h:column><h:inputText tabindex="5" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.brouillard.broLibelle}" style="width:100%" maxlength="100" readonly="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_action==3}"/></h:column>
                    </h:panelGrid>
                </h:panelGrid>
                <h:panelGrid id="pnlTotaux" columns="2" columnClasses="clos50d,clos50d" styleClass="fichefournisseur1" headerClass="headerTab" style="height:135px;" width="100%">
                    ...
                    <h:panelGrid  id="pngpbotonvAlider" columns="3">
                        ...
                        <h:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.saveGlobalEtValideJour}" image="/images/valDoc.png" title="Valider la pièce" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.testValiderSaisie&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_action!=3}"/>
            ...
            <h:panelGrid id="pnSaisie" columns="9" width="100%" style="border:1px solid green;background-color:#FFF8D4;height:50px;" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.var_action!=3}">
                ...
                <h:panelGroup id="contrePartie" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.optionComptabilite.testContrePartie}">
                    ...
                    <h:inputText tabindex="7" id="cpId" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrContrePartie}" size="10">
                ...
                <h:panelGroup id="dateEcheance" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrNature==6||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrNature==7}">
                    ...
                    <rich:calendar tabindex="10" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrDateEcheance}"  enableManualInput="true" datePattern="dd/MM/yyyy"  locale="fr" style=" background-color:white;" />
                </h:panelGroup>
                <h:panelGroup id="origine" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrNature==11}">
                    ...
                    <h:column>
                        <h:selectOneMenu tabindex="11" style="width:100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrOrigineBanque}">
                ...
                <h:panelGroup id="dateValeur" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrNature==10||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrNature==11}">
                    ...
                    <rich:calendar tabindex="12" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.ecritures.ecrDateValeurTheo}"  enableManualInput="true" datePattern="dd/MM/yyyy"  locale="fr" style=" background-color:white;" />
                </h:panelGroup>
                ...
                <h:panelGroup id="pngMaj" >
                    <h:commandButton tabindex="15" id="idValLigne" image="/images/valider_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formBrouillardMois.saveLigneEcriture}"/>
