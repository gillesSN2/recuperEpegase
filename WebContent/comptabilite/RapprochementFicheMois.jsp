...
<f:subview id="Rppsm">
    ...
    <a4j:form id="form1">
        ...
        <center> <h2><h:outputText value="SAISIE DES RAPPROCHEMENTS BANCAIRES (MENSUEL)" styleClass="titre"/></h2></center>
        ...
        <h:panelGrid  columns="2"  width="100%" id="idGlobal" >
            <h:panelGrid  columns="2"  width="100%" id="pngGlob" >
                <h:panelGrid id="pnlgrdfrm" styleClass="fichefournisseur1" style="width:100%;height:95px;" >
                    ...
                    <h:panelGroup>
                        <h:outputText value="Période: " style="font-weight:bold;"/><h:outputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.journauxMois.joumenPeriode}" style = "margin-left:20;"/>
                    </h:panelGroup>
                    <h:panelGrid columns="7" id="pngButton" width="100%">
                        <h:commandButton value="FERMER"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.fermerLeJournalEncours}" tabindex="0" styleClass="fermer" id="hidelink9"/>
                        <a4j:commandButton title="Pointer tout le rapprochement" image="/images/allSelect.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.pointeRapprochement}" onclick="if (!confirm('Etes vous sur de vouloir pointer toutes les lignes non pointées du journal?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,pgrsld,richpanlisteECR,scrollTable" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.menucompta.sup&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_action==1}"/>
                        <a4j:commandButton title="Effacer tout le rapprochement" image="/images/supprimer.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.effaceRapprochement}" onclick="if (!confirm('Etes vous sur de vouloir supprimer tous les pointages du journal?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,pgrsld,richpanlisteECR,scrollTable" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.menucompta.sup&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_action==1}"/>
                        ...
                        <h:commandButton title="Clôturer le rapprochement" image="/images/lock.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.clotureRapprochement}" onclick="if (!confirm('Etes vous sur de vouloir clôturer le rapprochement bancaire?')) return false;javascript:Richfaces.showModalPanel('modAttente');" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.menucompta.clo&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.cloture&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_action==1}"/>
                    </h:panelGrid>
                </h:panelGrid>
                <h:panelGrid  id="pgrsld" styleClass="fichefournisseur1" columns="3" style="width:100%;height:95px;">
                    <h:column id="sAnt">
                    ...
                    <h:column id="sFinal">
                        <h:column><h:outputText value="Controle final:" style="font-weight:bold;"/></h:column><br>
                        <h:column>
                            <h:inputText size="12" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_final}" style = "color:red;text-align:right;" readonly="true">
                                <jsp:include flush="true" page="/commun/formatNombreStructure.jsp"/>
                            </h:inputText>&nbsp;&nbsp;
                            <a4j:commandButton title="Actualiser le contrôle final" image="/images/actualiser.png" style="width:20px;height:20px" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.actualiserCtrl}" onclick="if (!confirm('Etes vous sur de vouloir actualier le contrôle final?')) return false" reRender="pgrsld,sFinal,paneTotal" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.menucompta.sup&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_action==1}"/>
                        </h:column>
                    </h:column>
                </h:panelGrid>
            </h:panelGrid>
            ...
            <h:column>
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable rows="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_nb_max}" border="0" width="100%" noDataLabel=" " headerClass="headerTab" style="max-height:100%;border:solid 0px green;" id="richpanlisteECR" selectedClass="active-row" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.datamodelEcritures}" var="table" rowClasses="rows1,rows2,rowsd" sortMode="multi" selectionMode="Multi" selection="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.selection}" >
                        ...
                        <rich:column sortable="true" sortBy="#{table.ecrRapprochement}" width="120px" id="rapflag" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw}">
                            <f:facet name="header"> <h:outputText  value="Rap. bancaire"  /></f:facet>
                            <h:outputText id="rapbac" value="#{table.ecrRapprochement}" style="width:70px;color:#{table.couleur};"/>
                            <a4j:commandButton eventsQueue="maQueue" onclick="true" id="boutrapp" value="R" style="width:30px;" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.saveRapprochement}" reRender="rapflag,rapbac,pgrsld,pngButton,paneTotal" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.menucompta.maj&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_action==1&&table.ecrAnaActif!='9'}"/>
                            <h:outputText id="rapbacAnn" value="#{table.ecrDteRapprochement}" style="width:70px;color:red;" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.menucompta.maj&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_action==1&&table.ecrAnaActif=='9'}">
                                <f:convertDateTime pattern="dd/MM/yy" locale="fr"/>
                            </h:outputText>
                            <a4j:commandButton eventsQueue="maQueue" onclick="true" id="boutrappAnn" value="*" style="width:30px;" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.saveRapprochementANNULE}" reRender="rapflag,rapbac,pgrsld,pngButton,paneTotal,richpanlisteECR" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.menucompta.maj&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanComptabilite.formRapprochement.var_action==1&&table.ecrAnaActif=='9'}"/>
                        </rich:column>
        ...
        <h:column><h:outputText value="(Contrôle final = (Solde relevé en cours - (Solde du relevé antérieur +/- les mouvements pointés du mois)) = 0)" style="font-weight:bold;color:red;"/></h:column>
    </a4j:form>
