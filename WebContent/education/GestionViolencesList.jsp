...
<f:subview id="elevelisteappels">

    <a4j:form>

        <center> <h2><h:outputText value="GESTION DES APPELS (PRESENCES/ABSENCES)" style="color:green;"/></h2></center>
        ...
        <h:panelGrid id="panelBouton" columns="9" width="400px" style="height:34px">
            <a4j:commandButton title="Ajouter des appels (Présences/Absences/Retards)" image="/images/ajouter.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrUpdate==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.menueducation.add}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.ajouterAppels}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton title="Modifier des appels (Présences/Absences/Retards)" image="/images/modifier.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrUpdate==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.menueducation.maj&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.visibiliteBton}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.modifierAppels}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton title="Consulter des appels (Présences/Absences/Retards)" image="/images/detail.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.visibiliteBton}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.consulterAppels}" onclick="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,idSubView"/>
            <a4j:commandButton title="Supprimer le document sélectionné" image="/images/supprimer.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrUpdate==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.visibiliteBton&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.elevesAppels.eleappEtat==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.menueducation.sup}" onclick="if (!confirm('Etes-vous sur de vouloir supprimer ce document ?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.supprimerDocumentAppels}" reRender="table,panelBouton"/>
            <a4j:commandButton title="Annuler le document sélectionné" image="/images/annuler_big.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrUpdate==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.visibiliteBton&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.elevesAppels.eleappEtat==1&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.menueducation.sup}" onclick="if (!confirm('Etes-vous sur de vouloir annuler ce document ?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.annulerDocumentAppels}" reRender="panelAnnuler"/>
            ...
            <a4j:commandButton title="Valider le document sélectionné" image="/images/valDoc.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrValidation==2&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrUpdate==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.visibiliteBton&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.elevesAppels.eleappEtat==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.menueducation.maj}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.valideDocumentAppels}" onclick="if (!confirm('Etes-vous sur de vouloir valider ce document ?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="panelBouton,idEtat"/>
            <a4j:commandButton title="Dé-Valider le document sélectionné" image="/images/deValDoc.png" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.rw&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrDeValidation==1&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.usersChrono.usrchrUpdate==0&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.visibiliteBton&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.elevesAppels.eleappEtat==1&&bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.menueducation.maj}" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.deValideDocumentAppels}" onclick="if (!confirm('Etes-vous sur de vouloir dé-valider ce document ?')) return false;javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="panelBouton,idEtat"/>
        ...
        <center>
            <div style="overflow:scroll;max-height:100%;width:100%;border:solid 0px green;">
                <a4j:region renderRegionOnly="false">
                    ...
                    <rich:extendedDataTable groupingColumn="idDate" rows="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.var_nb_max}" style="max-height:100%" styleClass="bg" id="table" rowClasses="rows1,rows2,rowsd" footerClass="bard" headerClass="headerTab" activeClass="active-row" noDataLabel=" " border="0" width="100%" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.datamodelAppels}" var="app" activeRowKey="true" rowKeyVar="rkv" selection="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.simpleSelectionEntete}" sortMode="multi" selectionMode="single" tableState="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.configListeEntete}" binding="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.extDTable}">
                        <a4j:support eventsQueue="maQueue" event="onselectionchange" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.selectionLigneAppels}" onsubmit="javascript:Richfaces.showModalPanel('modAttente');" oncomplete="javascript:Richfaces.hideModalPanel('modAttente');" reRender="modAttente,panelBouton,panCtrl"/>
                        <a4j:support eventsQueue="maQueue" event="onRowDblClick" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.visualisationLigneAppels}" reRender="idSubView,panelBouton,panCtrl"/>
                        <rich:column id="idDate" label="Date" sortable="true" sortBy="#{app.eleappDate} #{app.eleappMatiere}" width="8%" sortOrder="ASCENDING">
                        ...
                        <rich:column label="Filière" sortable="true" sortBy="#{app.eleappFiliere}" width="7%">
                            <f:facet name="header" ><h:outputText value="Filière"/></f:facet>
                            <h:outputText value="#{app.filieresMatieres.filmatLibelle}"/>
                        </rich:column>
                        <rich:column label="Matière" sortable="true" sortBy="#{app.eleappMatiere}" width="7%">
                            <f:facet name="header" ><h:outputText value="Matière"/></f:facet>
                            <h:outputText value="#{eleappMatiere}"/>
                        </rich:column>
                        <rich:column label="N° appel" sortable="true" sortBy="#{app.eleappNum}" width="7%">
                        ...
                        <rich:column label="N° Dossier entrée" sortable="true" sortBy="#{app.eleves.eleDossier}" width="9%">
                            <f:facet name="header" ><h:outputText value="Dossier"/></f:facet>
                            <h:outputText value="#{app.eleves.eleDossier}"/>
                        </rich:column>
                        <rich:column label="Nom et prénom" sortable="true" sortBy="#{app.eleves.eleNom} #{app.eleves.elePrenom}" width="23%" sortOrder="ASCENDING">
                            <f:facet name="header" ><h:outputText value="Nom et Prénom"/></f:facet>
                            <h:outputText value="#{app.eleves.eleNom} #{app.eleves.elePrenom}"/>
                        </rich:column>
                        <rich:column label="Présent/Absence/Retard" sortable="true" sortBy="#{app.libelleType}" width="14%">
                            <f:facet name="header" ><h:outputText value="Présent/Absence/Retard"/></f:facet>
                            <h:outputText value="#{app.libelleType}"/>
                        </rich:column>
                        <rich:column label="Motif absences" sortable="true" sortBy="#{app.eleappObservation}" width="14%">
    ...
    <rich:modalPanel domElementAttachment="parent"  id="panelAnnuler" width="400" height="250" headerClass="headerPanel" style="border:solid 1px black;background-color:white;border-radius:10px;box-shadow: 10px 10px 2px 1px rgba(0,0,0,0.5);" showWhenRendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.showModalPanelAnnuler}">
        <c:if test="${bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.showModalPanelAnnuler}" var="ser">
            <f:facet name="header"><h:outputText value="Annulation Appel"></h:outputText></f:facet>
            <f:facet name="controls">
                <a4j:form >
                    <a4j:commandButton action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.annuleAnnulationAppels}" image="/images/close.gif" styleClass="hidelink" reRender="panelAnnuler"/>
                </a4j:form>
            </f:facet>
            <a4j:form >
                <rich:hotKey key="return" handler="return false;"/>
                ...
                <h:panelGroup id="ppgrp">
                    <center>
                        <h:commandButton image="/images/valider_big.png" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanEducation.formGestionEleves.miseajourAnnulerAppels}" onclick="javascript:Richfaces.showModalPanel('modAttente');"/>
                    </center>
                </h:panelGroup>
            </a4j:form>
        </c:if>
