...
<f:subview id="configeducation">
    <a4j:form id="form1" >

        <center> <h2><h:outputText value="OPTIONS DE L'EDUCATION" style="color:green;"/></h2></center>
        ...
        <center>
            <rich:tabPanel switchType="client" immediate="true"  style="border:0px;">
                ...
                <rich:tab label="Education">
                    ...
                    <h:column>
                        <h:selectOneMenu style="width:300px" id="idchrono" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formOptionsVentes.optionVentes.chronoMatricule}">
