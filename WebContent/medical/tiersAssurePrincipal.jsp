...
<h:panelGrid columns="4" width="100%" styleClass="fichefournisseur" headerClass="headerTab">
    ...
    <h:column><h:inputText  readonly="true" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientsAssure.patDossier}" style="width:200px;"/></h:column>
    <h:column><h:outputText value="Né(e) le:"/></h:column>
    <h:column><h:inputText  readonly="true" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientsAssure.patDateNaissance}" style="width:200px;"/></h:column>
    <h:column><h:outputText value="Civilité:"/></h:column>
    <h:column><h:inputText  readonly="true" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientsAssure.patCivilite}" style="width:200px;"/></h:column>
    <h:column><h:outputText value="Nom et Prénom:"/></h:column>
    <h:column><h:inputText style="width:100%" readonly="true" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientsAssure.patNom} #{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientsAssure.patPrenom}" /></h:column>
</h:panelGrid>
...
<h:panelGrid columns="4"  width="100%" styleClass="fichefournisseur" headerClass="headerTab">
    ...
    <h:panelGrid  columns="1" style="width:100%;" id="idPanelGlobal">
        <h:panelGrid columns="4" columnClasses="clos15,clos35,clos15,clos35"width="100%" styleClass="fichefournisseur" id="idPanelPec">
            ...
            <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecNumCnss}" style="width:100%;" readonly="true" disabled="true"/></h:column>
            ...
            <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecNumCnamgs}" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.structureLog.strcodepays=='0077'}" style="width:95%;" readonly="true" disabled="true"/></h:column>
            <h:column><h:outputText value="Utilisateur Payeur:"/></h:column>
            <h:column>
                <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientsAssure.patIdUserPaiement}" readonly="true" disabled="true">
            ...
            <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientsAssure.patSalariePaiement}" style="width:95%;" maxlength="20" readonly="true" disabled="true"/></h:column>
            <h:column><h:outputText value="Choix Tiers"/></h:column>
            <h:column>
                <h:selectOneMenu style="width:100%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecType}" readonly="true" disabled="true">
            ...
            <h:column><h:inputText style="width:95%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.var_tiers}" readonly="true" disabled="true"/></h:column>
            ...
            <h:column><h:inputText style="width:95%;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecNomEmployeur}" readonly="true" disabled="true" rendered="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecType=='Assurance'||bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecType=='IPM'}"/></h:column>
            <h:column><h:outputText value="N° contrat:"/></h:column>
            <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecNumContrat}" readonly="true" disabled="true"/></h:column>
            <h:column><h:outputText value="N° Immat. Assuré"/></h:column>
            <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecMatriculeCouvert}" disabled="true"/></h:column>
            <h:column><h:outputText value="Date début"/></h:column>
            <h:column><h:inputText  value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecDateDebut}" readonly="true" disabled="true"/></h:column>
            <h:column><h:outputText value="Date fin"/></h:column>
            <h:column><h:inputText value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formPatients.patientPec.patpecDateFin}" readonly="true" disabled="true"/></h:column>
        </h:panelGrid>
