...
<f:subview id="natfmprdvte">
    ...
    <a4j:form>
        ...
        <center><h2> <h:outputText value="LISTE DES DESTINATIONS MEDICAUX" style="color:green;"/></h2></center>
        ...
        <center>
            <a4j:region renderRegionOnly="false">
                <rich:extendedDataTable border="0" headerClass="headerTab" activeClass="active-row" noDataLabel=" " rowClasses="rows1,rows2,rowsd" width="100%" style="max-height:100%;border:solid 0px green;text-align:left;" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanAdministration.formDestinationMedical.datamodel}"  var="nfmp">
