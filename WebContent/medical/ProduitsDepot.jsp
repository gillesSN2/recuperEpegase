    ...
    <a4j:form id="produitformach" enctype="multipart/form-data">
        ...
        <h:panelGrid width="100%">
            ...
            <h:panelGrid columns="4"  width="100%" style="background-color:#DAEECB;">
                ...
                <h:column><h:inputText  readonly="true" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formProduitsMedical.produits.proCode}" style="width:200px;"/></h:column>
                <h:column><h:outputText value="Libellé client:"/></h:column>
                <h:column><h:inputText size="60" readonly="true" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formProduitsMedical.produits.proLibClient}" /></h:column>
            </h:panelGrid>
            <br>
            <h:panelGroup id="tabDepot">
                <a4j:region renderRegionOnly="false">
                    <rich:extendedDataTable width="100%" style="border:solid 0px green;" styleClass="bg" border="0"  height="250px" id="tableauDepot" footerClass="bard" activeClass="active-row" noDataLabel=" " headerClass="headerTab" rowClasses="rows1,rows2,rowsd" value="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formProduitsMedical.datamodelDepot}" var="depotProd">
                        <a4j:support eventsQueue="maQueue" event="onRowClick"  reRender="panelBoutonDep"  action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formProduitsMedical.selectProduitDepot}"    />
                        ...
                        <rich:column  width="10%" id="etatProdDep" sortable="false" style="text-align:center;" >
                            ...
                            <h:commandButton image="#{depotProd.etat}" rendered="#{depotProd.inactif}" onclick="if (!confirm('Voulez-vous réactiver ce élément ?')) return false" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formProduitsMedical.reactiverProdDep}" title="Supprimer" style="text-align:right;">
            ...
            <h:panelGroup>
                <center>
                    <a4j:commandButton value="RETOUR" styleClass="exp_lienmenu" action="#{bakingbeanepegase.menuModuleHorizontalCtrl.formBakingBeanMedical.formProduitsMedical.annuleSaisie}" reRender="idSubView"/>
                </center>
            </h:panelGroup>
