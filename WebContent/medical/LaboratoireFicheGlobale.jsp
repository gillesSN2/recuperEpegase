...
<f:subview id="fichelaboratoire">
    ...
    <center>
        <a4j:form enctype="multipart/form-data">
            ...
            <center> <h2><h:outputText value="GESTION DES EXAMENS DE LABORATOIRE (Globale)" style="color:green;"/></h2></center>
